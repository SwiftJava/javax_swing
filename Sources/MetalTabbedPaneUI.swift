...
open class MetalTabbedPaneUI: BasicTabbedPaneUI {
    ...
    private static var paintTopTabBorder_MethodID_3: jmethodID?
    ...
    open func paintTopTabBorder( tabIndex: Int, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int, btm: Int, rght: Int, isSelected: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTopTabBorder", methodSig: "(ILjava/awt/Graphics;IIIIIIZ)V", methodCache: &MetalTabbedPaneUI.paintTopTabBorder_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var shouldFillGap_MethodID_4: jmethodID?
    ...
    open func shouldFillGap( currentRun: Int, tabIndex: Int, x: Int, y: Int ) -> Bool {
        ...
        __args[2] = JNIType.toJava( value: x, locals: &__locals )
        __args[3] = JNIType.toJava( value: y, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "shouldFillGap", methodSig: "(IIII)Z", methodCache: &MetalTabbedPaneUI.shouldFillGap_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var getColorForGap_MethodID_5: jmethodID?
    ...
    open func getColorForGap( currentRun: Int, x: Int, y: Int ) -> java_awt.Color! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorForGap", methodSig: "(III)Ljava/awt/Color;", methodCache: &MetalTabbedPaneUI.getColorForGap_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var paintLeftTabBorder_MethodID_6: jmethodID?
    ...
    open func paintLeftTabBorder( tabIndex: Int, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int, btm: Int, rght: Int, isSelected: Bool ) {
        ...
        __args[7] = JNIType.toJava( value: rght, locals: &__locals )
        __args[8] = JNIType.toJava( value: isSelected, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintLeftTabBorder", methodSig: "(ILjava/awt/Graphics;IIIIIIZ)V", methodCache: &MetalTabbedPaneUI.paintLeftTabBorder_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var paintBottomTabBorder_MethodID_7: jmethodID?
    ...
    open func paintBottomTabBorder( tabIndex: Int, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int, btm: Int, rght: Int, isSelected: Bool ) {
        ...
        __args[7] = JNIType.toJava( value: rght, locals: &__locals )
        __args[8] = JNIType.toJava( value: isSelected, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBottomTabBorder", methodSig: "(ILjava/awt/Graphics;IIIIIIZ)V", methodCache: &MetalTabbedPaneUI.paintBottomTabBorder_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var paintRightTabBorder_MethodID_8: jmethodID?
    ...
    open func paintRightTabBorder( tabIndex: Int, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int, btm: Int, rght: Int, isSelected: Bool ) {
        ...
        __args[7] = JNIType.toJava( value: rght, locals: &__locals )
        __args[8] = JNIType.toJava( value: isSelected, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintRightTabBorder", methodSig: "(ILjava/awt/Graphics;IIIIIIZ)V", methodCache: &MetalTabbedPaneUI.paintRightTabBorder_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    private static var paintHighlightBelowTab_MethodID_9: jmethodID?

    open func paintHighlightBelowTab() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintHighlightBelowTab", methodSig: "()V", methodCache: &MetalTabbedPaneUI.paintHighlightBelowTab_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func createLayoutManager() -> java_awt.LayoutManager! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createLayoutManager", methodSig: "()Ljava/awt/LayoutManager;", methodCache: &MetalTabbedPaneUI.createLayoutManager_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
