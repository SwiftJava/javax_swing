...
open class BasicRadioButtonUI: BasicToggleButtonUI {
    ...
    override open func installDefaults( b: AbstractButton? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b != nil ? b! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "(Ljavax/swing/AbstractButton;)V", methodCache: &BasicRadioButtonUI.installDefaults_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners( button: AbstractButton? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "(Ljavax/swing/AbstractButton;)V", methodCache: &BasicRadioButtonUI.installListeners_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallDefaults( b: AbstractButton? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b != nil ? b! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "(Ljavax/swing/AbstractButton;)V", methodCache: &BasicRadioButtonUI.uninstallDefaults_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallListeners( button: AbstractButton? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: button != nil ? button! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "(Ljavax/swing/AbstractButton;)V", methodCache: &BasicRadioButtonUI.uninstallListeners_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    override open func getPropertyPrefix() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPropertyPrefix", methodSig: "()Ljava/lang/String;", methodCache: &BasicRadioButtonUI.getPropertyPrefix_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func paintFocus( g: java_awt.Graphics?, textRect: java_awt.Rectangle?, size: java_awt.Dimension? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintFocus", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Dimension;)V", methodCache: &BasicRadioButtonUI.paintFocus_MethodID_9, args: &__args, locals: &__locals )
    }
