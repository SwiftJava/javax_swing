...
open class TreePath: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    public convenience init( parent: TreePath?, lastPathComponent: java_swift.JavaObject? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/tree/TreePath", classCache: &TreePath.TreePathJNIClass, methodSig: "(Ljavax/swing/tree/TreePath;Ljava/lang/Object;)V", methodCache: &TreePath.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( path: [JavaObject]? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/tree/TreePath", classCache: &TreePath.TreePathJNIClass, methodSig: "([Ljava/lang/Object;)V", methodCache: &TreePath.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    private static var getParentPath_MethodID_8: jmethodID?

    open func getParentPath() -> TreePath! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParentPath", methodSig: "()Ljavax/swing/tree/TreePath;", methodCache: &TreePath.getParentPath_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getPath_MethodID_9: jmethodID?

    open func getPath() -> [JavaObject]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPath", methodSig: "()[Ljava/lang/Object;", methodCache: &TreePath.getPath_MethodID_9, args: &__args, locals: &__locals )
    ...
    private static var getPathComponent_MethodID_10: jmethodID?

    open func getPathComponent( index: Int ) -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(index) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPathComponent", methodSig: "(I)Ljava/lang/Object;", methodCache: &TreePath.getPathComponent_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    private static var isDescendant_MethodID_12: jmethodID?

    open func isDescendant( aTreePath: TreePath? ) -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: aTreePath, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDescendant", methodSig: "(Ljavax/swing/tree/TreePath;)Z", methodCache: &TreePath.isDescendant_MethodID_12, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
