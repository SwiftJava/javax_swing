...
open class StyledEditorKit_BoldAction: StyledEditorKit_StyledTextAction {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &StyledEditorKit_BoldAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &StyledEditorKit_BoldAction.enabled_FieldID, object: javaObject )
