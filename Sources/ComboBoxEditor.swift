...
open class ComboBoxEditorForward: JNIObjectForward, ComboBoxEditor {
    ...
    private static var selectAll_MethodID_7: jmethodID?

    open func selectAll() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectAll", methodSig: "()V", methodCache: &ComboBoxEditorForward.selectAll_MethodID_7, args: &__args, locals: &__locals )
    }


    /// public abstract java.awt.Component javax.swing.ComboBoxEditor.getEditorComponent()

    private static var getEditorComponent_MethodID_8: jmethodID?

    open func getEditorComponent() -> java_awt.Component! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getEditorComponent", methodSig: "()Ljava/awt/Component;", methodCache: &ComboBoxEditorForward.getEditorComponent_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func addActionListener( l: java_awt.ActionListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addActionListener", methodSig: "(Ljava/awt/event/ActionListener;)V", methodCache: &ComboBoxEditorForward.addActionListener_MethodID_9, args: &__args, locals: &__locals )
    }
