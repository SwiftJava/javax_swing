...
open class MultiScrollPaneUI: ScrollPaneUI {
    ...
    open var uis: java_util.Vector! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "uis", fieldType: "Ljava/util/Vector;", fieldCache: &MultiScrollPaneUI.uis_FieldID, object: javaObject )
    ...
    open func getAccessibleChild( a: JComponent?, b: Int ) -> /* interface javax.accessibility.Accessible */ UnavailableProtocol! {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = jvalue( i: jint(b) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAccessibleChild", methodSig: "(Ljavax/swing/JComponent;I)Ljavax/accessibility/Accessible;", methodCache: &MultiScrollPaneUI.getAccessibleChild_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getAccessibleChildrenCount( a: JComponent? ) -> Int {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAccessibleChildrenCount", methodSig: "(Ljavax/swing/JComponent;)I", methodCache: &MultiScrollPaneUI.getAccessibleChildrenCount_MethodID_5, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getMinimumSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiScrollPaneUI.getMinimumSize_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    open func getUIs() -> [ComponentUI]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUIs", methodSig: "()[Ljavax/swing/plaf/ComponentUI;", methodCache: &MultiScrollPaneUI.getUIs_MethodID_9, args: &__args, locals: &__locals )
    ...
    open func paint( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiScrollPaneUI.paint_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallUI( a: JComponent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &MultiScrollPaneUI.uninstallUI_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func update( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiScrollPaneUI.update_MethodID_13, args: &__args, locals: &__locals )
    }
