...
open class BevelBorder: AbstractBorder {
    ...
    public convenience init( bevelType: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: bevelType, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/border/BevelBorder", classCache: &BevelBorder.BevelBorderJNIClass, methodSig: "(I)V", methodCache: &BevelBorder.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    private static var getShadowOuterColor_MethodID_8: jmethodID?

    open func getShadowOuterColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getShadowOuterColor", methodSig: "()Ljava/awt/Color;", methodCache: &BevelBorder.getShadowOuterColor_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Color( javaObject: __return ) : nil
    }
    ...
    private static var getShadowOuterColor_MethodID_9: jmethodID?
    ...
    private static var getShadowInnerColor_MethodID_11: jmethodID?

    open func getShadowInnerColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getShadowInnerColor", methodSig: "()Ljava/awt/Color;", methodCache: &BevelBorder.getShadowInnerColor_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Color( javaObject: __return ) : nil
    }
