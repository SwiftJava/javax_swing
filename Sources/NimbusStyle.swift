...
open class NimbusStyle: SynthStyle {
    ...
    private static var getBackgroundPainter_MethodID_2: jmethodID?

    open func getBackgroundPainter( ctx: SynthContext? ) -> Painter! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBackgroundPainter", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Ljavax/swing/Painter;", methodCache: &NimbusStyle.getBackgroundPainter_MethodID_2, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getBorderPainter_MethodID_3: jmethodID?

    open func getBorderPainter( ctx: SynthContext? ) -> Painter! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBorderPainter", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Ljavax/swing/Painter;", methodCache: &NimbusStyle.getBorderPainter_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? PainterForward( javaObject: __return ) : nil
    }
    ...
    private static var getColorForState_MethodID_4: jmethodID?
    ...
    open func getColorForState( ctx: SynthContext?, type: ColorType? ) -> java_awt.Color! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorForState", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljavax/swing/plaf/synth/ColorType;)Ljava/awt/Color;", methodCache: &NimbusStyle.getColorForState_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getFontForState_MethodID_5: jmethodID?

    open func getFontForState( ctx: SynthContext? ) -> java_awt.Font! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFontForState", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Ljava/awt/Font;", methodCache: &NimbusStyle.getFontForState_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getForegroundPainter_MethodID_6: jmethodID?

    open func getForegroundPainter( ctx: SynthContext? ) -> Painter! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getForegroundPainter", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Ljavax/swing/Painter;", methodCache: &NimbusStyle.getForegroundPainter_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? PainterForward( javaObject: __return ) : nil
    }
    ...
    open func getInsets( ctx: SynthContext?, _in: java_awt.Insets? ) -> java_awt.Insets! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInsets", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Insets;)Ljava/awt/Insets;", methodCache: &NimbusStyle.getInsets_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getPainter_MethodID_8: jmethodID?

    open func getPainter( ctx: SynthContext? ) -> SynthPainter! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPainter", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Ljavax/swing/plaf/synth/SynthPainter;", methodCache: &NimbusStyle.getPainter_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installDefaults( ctx: SynthContext? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)V", methodCache: &NimbusStyle.installDefaults_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var isOpaque_MethodID_10: jmethodID?

    open func isOpaque( ctx: SynthContext? ) -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: ctx, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isOpaque", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;)Z", methodCache: &NimbusStyle.isOpaque_MethodID_10, args: &__args, locals: &__locals )
