...
private typealias AncestorListener_ancestorMoved_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func AncestorListener_ancestorMoved_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ event: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias AncestorListener_ancestorAdded_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func AncestorListener_ancestorAdded_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ event: jobject? ) -> () {
    JNI.inNative = true;
...
fileprivate class AncestorListenerLocal_: JNILocalProxy<AncestorListener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        natives.append( JNINativeMethod( name: strdup("__ancestorMoved"), signature: strdup("(JLjavax/swing/event/AncestorEvent;)V"), fnPtr: unsafeBitCast( AncestorListener_ancestorMoved_0_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let AncestorListener_ancestorAdded_1_thunk: AncestorListener_ancestorAdded_1_type = AncestorListener_ancestorAdded_1
        natives.append( JNINativeMethod( name: strdup("__ancestorAdded"), signature: strdup("(JLjavax/swing/event/AncestorEvent;)V"), fnPtr: unsafeBitCast( AncestorListener_ancestorAdded_1_thunk, to: UnsafeMutableRawPointer.self ) ) )
