...
open class AncestorListenerForward: java_util.EventListenerForward, AncestorListener {
    ...
    open func ancestorRemoved( event: AncestorEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: event != nil ? event! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "ancestorRemoved", methodSig: "(Ljavax/swing/event/AncestorEvent;)V", methodCache: &AncestorListenerForward.ancestorRemoved_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var ancestorMoved_MethodID_6: jmethodID?

    open func ancestorMoved( event: AncestorEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: event != nil ? event! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "ancestorMoved", methodSig: "(Ljavax/swing/event/AncestorEvent;)V", methodCache: &AncestorListenerForward.ancestorMoved_MethodID_6, args: &__args, locals: &__locals )
    }
...
private typealias AncestorListener_ancestorRemoved_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func AncestorListener_ancestorRemoved_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ event: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias AncestorListener_ancestorMoved_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func AncestorListener_ancestorMoved_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ event: jobject? ) -> () {
    JNI.inNative = true;
...
fileprivate class AncestorListenerLocal_: JNILocalProxy<AncestorListener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        let AncestorListener_ancestorRemoved_1_thunk: AncestorListener_ancestorRemoved_1_type = AncestorListener_ancestorRemoved_1
        natives.append( JNINativeMethod( name: strdup("__ancestorRemoved"), signature: strdup("(JLjavax/swing/event/AncestorEvent;)V"), fnPtr: unsafeBitCast( AncestorListener_ancestorRemoved_1_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let AncestorListener_ancestorMoved_2_thunk: AncestorListener_ancestorMoved_2_type = AncestorListener_ancestorMoved_2
        natives.append( JNINativeMethod( name: strdup("__ancestorMoved"), signature: strdup("(JLjavax/swing/event/AncestorEvent;)V"), fnPtr: unsafeBitCast( AncestorListener_ancestorMoved_2_thunk, to: UnsafeMutableRawPointer.self ) ) )
