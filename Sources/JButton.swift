...
open class JButton: AbstractButton {
    ...
    public convenience init( text: String?, icon: Icon? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljava/lang/String;Ljavax/swing/Icon;)V", methodCache: &JButton.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( a: Action? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljavax/swing/Action;)V", methodCache: &JButton.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( icon: Icon? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljavax/swing/Icon;)V", methodCache: &JButton.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    open func setDefaultCapable( defaultCapable: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: defaultCapable, locals: &__locals )
