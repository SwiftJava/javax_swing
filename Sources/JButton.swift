...
open class JButton: AbstractButton {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.JButton", file, line ) {
            return nil
        }
    ...
    private static var JButtonJNIClass: jclass?
    ...
    override open var model: ButtonModel! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &JButton.model_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ButtonModelForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &JButton.model_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeListener: ChangeListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &JButton.changeListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ChangeListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &JButton.changeListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var actionListener: java_awt.ActionListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &JButton.actionListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ActionListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &JButton.actionListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var itemListener: java_awt.ItemListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &JButton.itemListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ItemListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &JButton.itemListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeEvent: ChangeEvent! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeEvent", fieldType: "Ljavax/swing/event/ChangeEvent;", fieldCache: &JButton.changeEvent_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var ui: ComponentUI! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JButton.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JButton.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JButton.accessibleContext_FieldID, object: javaObject, locals: &__locals )
    ...
    public convenience init( arg0: Action? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljavax/swing/Action;)V", methodCache: &JButton.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: Icon? ) {
        ...
        var __locals = [jobject]()
        __args[0] = jvalue( l: arg0?.localJavaObject( &__locals ) )
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljavax/swing/Icon;)V", methodCache: &JButton.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &JButton.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: Icon? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "(Ljava/lang/String;Ljavax/swing/Icon;)V", methodCache: &JButton.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/JButton", classCache: &JButton.JButtonJNIClass, methodSig: "()V", methodCache: &JButton.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// private void javax.swing.JButton.writeObject(java.io.ObjectOutputStream) throws java.io.IOException
    ...
    override open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JButton.paramString_MethodID_6, args: &__args, locals: &__locals )
    ...
    open func isDefaultButton() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDefaultButton", methodSig: "()Z", methodCache: &JButton.isDefaultButton_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var isDefaultCapable_MethodID_8: jmethodID?

    open func isDefaultCapable() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDefaultCapable", methodSig: "()Z", methodCache: &JButton.isDefaultCapable_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var setDefaultCapable_MethodID_9: jmethodID?

    open func setDefaultCapable( arg0: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDefaultCapable", methodSig: "(Z)V", methodCache: &JButton.setDefaultCapable_MethodID_9, args: &__args, locals: &__locals )
    }

    open func setDefaultCapable( _ _arg0: Bool ) {
        setDefaultCapable( arg0: _arg0 )
    }
