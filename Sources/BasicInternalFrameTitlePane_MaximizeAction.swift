...
open class BasicInternalFrameTitlePane_MaximizeAction: AbstractAction {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &BasicInternalFrameTitlePane_MaximizeAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &BasicInternalFrameTitlePane_MaximizeAction.enabled_FieldID, object: javaObject )
