...
open class DefaultStyledDocument: AbstractDocument, StyledDocument {
    ...
    open func createDefaultRoot() -> AbstractDocument_AbstractElement! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createDefaultRoot", methodSig: "()Ljavax/swing/text/AbstractDocument$AbstractElement;", methodCache: &DefaultStyledDocument.createDefaultRoot_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var addStyle_MethodID_9: jmethodID?
    ...
    open func addStyle( nm: String?, parent: Style? ) -> Style! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "addStyle", methodSig: "(Ljava/lang/String;Ljavax/swing/text/Style;)Ljavax/swing/text/Style;", methodCache: &DefaultStyledDocument.addStyle_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var removeStyle_MethodID_10: jmethodID?

    open func removeStyle( nm: String? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: nm, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeStyle", methodSig: "(Ljava/lang/String;)V", methodCache: &DefaultStyledDocument.removeStyle_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var setLogicalStyle_MethodID_11: jmethodID?
    ...
    open func setLogicalStyle( pos: Int, s: Style? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLogicalStyle", methodSig: "(ILjavax/swing/text/Style;)V", methodCache: &DefaultStyledDocument.setLogicalStyle_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var getLogicalStyle_MethodID_12: jmethodID?

    open func getLogicalStyle( p: Int ) -> Style! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: p, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLogicalStyle", methodSig: "(I)Ljavax/swing/text/Style;", methodCache: &DefaultStyledDocument.getLogicalStyle_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? StyleForward( javaObject: __return ) : nil
    }
    ...
    private static var setParagraphAttributes_MethodID_13: jmethodID?
    ...
    open func setParagraphAttributes( offset: Int, length: Int, s: AttributeSet?, replace: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setParagraphAttributes", methodSig: "(IILjavax/swing/text/AttributeSet;Z)V", methodCache: &DefaultStyledDocument.setParagraphAttributes_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var getCharacterElement_MethodID_14: jmethodID?

    open func getCharacterElement( pos: Int ) -> Element! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: pos, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getCharacterElement", methodSig: "(I)Ljavax/swing/text/Element;", methodCache: &DefaultStyledDocument.getCharacterElement_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getFont( attr: AttributeSet? ) -> java_awt.Font! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFont", methodSig: "(Ljavax/swing/text/AttributeSet;)Ljava/awt/Font;", methodCache: &DefaultStyledDocument.getFont_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getBackground( attr: AttributeSet? ) -> java_awt.Color! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: attr, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBackground", methodSig: "(Ljavax/swing/text/AttributeSet;)Ljava/awt/Color;", methodCache: &DefaultStyledDocument.getBackground_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getForeground_MethodID_17: jmethodID?

    open func getForeground( attr: AttributeSet? ) -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: attr, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getForeground", methodSig: "(Ljavax/swing/text/AttributeSet;)Ljava/awt/Color;", methodCache: &DefaultStyledDocument.getForeground_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Color( javaObject: __return ) : nil
    }
    ...
    private static var getStyleNames_MethodID_18: jmethodID?

    open func getStyleNames() -> java_util.Enumeration! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getStyleNames", methodSig: "()Ljava/util/Enumeration;", methodCache: &DefaultStyledDocument.getStyleNames_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getStyle_MethodID_19: jmethodID?

    open func getStyle( nm: String? ) -> Style! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: nm, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getStyle", methodSig: "(Ljava/lang/String;)Ljavax/swing/text/Style;", methodCache: &DefaultStyledDocument.getStyle_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? StyleForward( javaObject: __return ) : nil
    }
    ...
    override open func insertUpdate( chng: AbstractDocument_DefaultDocumentEvent?, attr: AttributeSet? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertUpdate", methodSig: "(Ljavax/swing/text/AbstractDocument$DefaultDocumentEvent;Ljavax/swing/text/AttributeSet;)V", methodCache: &DefaultStyledDocument.insertUpdate_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    override open func removeUpdate( chng: AbstractDocument_DefaultDocumentEvent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: chng, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeUpdate", methodSig: "(Ljavax/swing/text/AbstractDocument$DefaultDocumentEvent;)V", methodCache: &DefaultStyledDocument.removeUpdate_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var setCharacterAttributes_MethodID_22: jmethodID?
    ...
    open func setCharacterAttributes( offset: Int, length: Int, s: AttributeSet?, replace: Bool ) {
        ...
        __args[2] = JNIType.toJava( value: s, locals: &__locals )
        __args[3] = JNIType.toJava( value: replace, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCharacterAttributes", methodSig: "(IILjavax/swing/text/AttributeSet;Z)V", methodCache: &DefaultStyledDocument.setCharacterAttributes_MethodID_22, args: &__args, locals: &__locals )
    }
