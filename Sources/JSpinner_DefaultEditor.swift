...
open class JSpinner_DefaultEditor: JPanel, ChangeListener, java_awt.LayoutManager {
    ...
    private static var commitEdit_MethodID_2: jmethodID?

    open func commitEdit() throws /* java.text.ParseException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "commitEdit", methodSig: "()V", methodCache: &JSpinner_DefaultEditor.commitEdit_MethodID_2, args: &__args, locals: &__locals )
