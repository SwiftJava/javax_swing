...
open class MetalIconFactory_FolderIcon16: java_swift.JavaObject, Icon, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    private static var getAdditionalHeight_MethodID_2: jmethodID?

    open func getAdditionalHeight() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAdditionalHeight", methodSig: "()I", methodCache: &MetalIconFactory_FolderIcon16.getAdditionalHeight_MethodID_2, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getIconHeight() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getIconHeight", methodSig: "()I", methodCache: &MetalIconFactory_FolderIcon16.getIconHeight_MethodID_3, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getIconWidth() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getIconWidth", methodSig: "()I", methodCache: &MetalIconFactory_FolderIcon16.getIconWidth_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func paintIcon( c: java_awt.Component?, g: java_awt.Graphics?, x: Int, y: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintIcon", methodSig: "(Ljava/awt/Component;Ljava/awt/Graphics;II)V", methodCache: &MetalIconFactory_FolderIcon16.paintIcon_MethodID_6, args: &__args, locals: &__locals )
    }
