...
open class DefaultEditorKit_InsertBreakAction: TextAction {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.text.DefaultEditorKit$InsertBreakAction", file, line ) {
            return nil
        }
    ...
    private static var DefaultEditorKit_InsertBreakActionJNIClass: jclass?
    ...
    override open var enabled: Bool {
        get {
            ...
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &DefaultEditorKit_InsertBreakAction.enabled_FieldID, object: javaObject, locals: &__locals )
            return JNIType.decode( type: Bool(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &DefaultEditorKit_InsertBreakAction.enabled_FieldID, object: javaObject, value: __value.z, locals: &__locals )
        }
    }
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &DefaultEditorKit_InsertBreakAction.changeSupport_FieldID, object: javaObject, locals: &__locals )
    ...
    /// public javax.swing.text.DefaultEditorKit$InsertBreakAction()
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/text/DefaultEditorKit$InsertBreakAction", classCache: &DefaultEditorKit_InsertBreakAction.DefaultEditorKit_InsertBreakActionJNIClass, methodSig: "()V", methodCache: &DefaultEditorKit_InsertBreakAction.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// public void javax.swing.text.DefaultEditorKit$InsertBreakAction.actionPerformed(java.awt.event.ActionEvent)
