...
open class BasicScrollBarUI_PropertyChangeHandler: java_lang.JavaObject, /* java.beans.PropertyChangeListener */ UnclassedProtocol {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.plaf.basic.BasicScrollBarUI$PropertyChangeHandler", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: BasicScrollBarUI? ) {
    ...
    public convenience init( _ _arg0: BasicScrollBarUI? ) {
