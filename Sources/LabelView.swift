...
open class LabelView: GlyphView {
    ...
    private static var setStrikeThrough_MethodID_2: jmethodID?

    open func setStrikeThrough( s: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setStrikeThrough", methodSig: "(Z)V", methodCache: &LabelView.setStrikeThrough_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var setSubscript_MethodID_3: jmethodID?

    open func setSubscript( s: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSubscript", methodSig: "(Z)V", methodCache: &LabelView.setSubscript_MethodID_3, args: &__args, locals: &__locals )
    }
