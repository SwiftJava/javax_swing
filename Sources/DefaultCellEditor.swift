...
open class DefaultCellEditor: AbstractCellEditor, TableCellEditor, TreeCellEditor {
    ...
    private static var setClickCountToStart_MethodID_4: jmethodID?

    open func setClickCountToStart( count: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: count, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setClickCountToStart", methodSig: "(I)V", methodCache: &DefaultCellEditor.setClickCountToStart_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var getClickCountToStart_MethodID_5: jmethodID?

    open func getClickCountToStart() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getClickCountToStart", methodSig: "()I", methodCache: &DefaultCellEditor.getClickCountToStart_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var getTreeCellEditorComponent_MethodID_6: jmethodID?
    ...
    open func getTreeCellEditorComponent( tree: JTree?, value: java_swift.JavaObject?, isSelected: Bool, expanded: Bool, leaf: Bool, row: Int ) -> java_awt.Component! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTreeCellEditorComponent", methodSig: "(Ljavax/swing/JTree;Ljava/lang/Object;ZZZI)Ljava/awt/Component;", methodCache: &DefaultCellEditor.getTreeCellEditorComponent_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var getTableCellEditorComponent_MethodID_7: jmethodID?
    ...
    open func getTableCellEditorComponent( table: JTable?, value: java_swift.JavaObject?, isSelected: Bool, row: Int, column: Int ) -> java_awt.Component! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTableCellEditorComponent", methodSig: "(Ljavax/swing/JTable;Ljava/lang/Object;ZII)Ljava/awt/Component;", methodCache: &DefaultCellEditor.getTableCellEditorComponent_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Component( javaObject: __return ) : nil
    }
    ...
    open func getComponent() -> java_awt.Component! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getComponent", methodSig: "()Ljava/awt/Component;", methodCache: &DefaultCellEditor.getComponent_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Component( javaObject: __return ) : nil
    }
    ...
    override open func isCellEditable( anEvent: java_util.EventObject? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isCellEditable", methodSig: "(Ljava/util/EventObject;)Z", methodCache: &DefaultCellEditor.isCellEditable_MethodID_9, args: &__args, locals: &__locals )
