...
open class DefaultTableCellRenderer_UIResource: DefaultTableCellRenderer, UIResource {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.table.DefaultTableCellRenderer$UIResource", file, line ) {
            return nil
        }
    ...
    override open var labelFor: java_awt.Component! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "labelFor", fieldType: "Ljava/awt/Component;", fieldCache: &DefaultTableCellRenderer_UIResource.labelFor_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var ui: ComponentUI! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &DefaultTableCellRenderer_UIResource.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &DefaultTableCellRenderer_UIResource.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &DefaultTableCellRenderer_UIResource.accessibleContext_FieldID, object: javaObject, locals: &__locals )
...
private typealias DefaultTableCellRenderer_UIResource_getTableCellRendererComponent_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject?, _: jobject?, _: jboolean, _: jboolean, _: jint, _: jint ) -> jobject?

private func DefaultTableCellRenderer_UIResource_getTableCellRendererComponent_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg0: jobject?, _ arg1: jobject?, _ arg2: jboolean, _ arg3: jboolean, _ arg4: jint, _ arg5: jint ) -> jobject? {
    let __return = DefaultTableCellRenderer_UIResourceBase.swiftObject( jniEnv: __env, javaObject: __this ).getTableCellRendererComponent( arg0 != nil ? JTable( javaObject: arg0 ) : nil, arg1 != nil ? java_lang.JavaObject( javaObject: arg1 ) : nil, JNIType.decode( type: Bool(), from: arg2 ), JNIType.decode( type: Bool(), from: arg3 ), JNIType.decode( type: Int(), from: arg4 ), JNIType.decode( type: Int(), from: arg5 ) )
...
open class DefaultTableCellRenderer_UIResourceBase: DefaultTableCellRenderer_UIResource {
    ...
    private static var DefaultTableCellRenderer_UIResourceBaseJNIClass: jclass?
    ...
    private static func registerNatives() {
        if ( !nativesRegistered ) {
            ...
            natives.append( JNINativeMethod( name: strdup("__getTableCellRendererComponent"), signature: strdup("(Ljavax/swing/JTable;Ljava/lang/Object;ZZII)Ljava/awt/Component;"), fnPtr: unsafeBitCast( DefaultTableCellRenderer_UIResource_getTableCellRendererComponent_0_thunk, to: UnsafeMutableRawPointer.self ) ) )

            withUnsafePointer(to: &natives[0]) {
                nativesPtr in
                let clazz = JNI.FindClass( "org/genie/javax_swing/DefaultTableCellRenderer_UIResourceProxy" )
    ...
    override open var javaObject: jobject? {
        ...
        set(newValue) {
            ...
            DefaultTableCellRenderer_UIResourceBase.registerNatives()
            updateSwiftObject()
        }
    }
    ...
    static func swiftObject( jniEnv: UnsafeMutablePointer<JNIEnv?>?, javaObject: jobject? ) -> DefaultTableCellRenderer_UIResourceBase {
        return unsafeBitCast( swiftPointer( jniEnv: jniEnv, object: javaObject ), to: DefaultTableCellRenderer_UIResourceBase.self )
    }
