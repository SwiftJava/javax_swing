...
open class DefaultButtonModel: java_swift.JavaObject, ButtonModel, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var isArmed_MethodID_2: jmethodID?

    open func isArmed() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isArmed", methodSig: "()Z", methodCache: &DefaultButtonModel.isArmed_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var isPressed_MethodID_3: jmethodID?

    open func isPressed() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isPressed", methodSig: "()Z", methodCache: &DefaultButtonModel.isPressed_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func isSelected() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSelected", methodSig: "()Z", methodCache: &DefaultButtonModel.isSelected_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var getGroup_MethodID_5: jmethodID?

    open func getGroup() -> ButtonGroup! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGroup", methodSig: "()Ljavax/swing/ButtonGroup;", methodCache: &DefaultButtonModel.getGroup_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func setSelected( b: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelected", methodSig: "(Z)V", methodCache: &DefaultButtonModel.setSelected_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func isEnabled() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isEnabled", methodSig: "()Z", methodCache: &DefaultButtonModel.isEnabled_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var getMnemonic_MethodID_8: jmethodID?

    open func getMnemonic() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMnemonic", methodSig: "()I", methodCache: &DefaultButtonModel.getMnemonic_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func setEnabled( b: Bool ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setEnabled", methodSig: "(Z)V", methodCache: &DefaultButtonModel.setEnabled_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func getListeners( listenerType: java_swift.JavaClass? ) -> [EventListener]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getListeners", methodSig: "(Ljava/lang/Class;)[Ljava/util/EventListener;", methodCache: &DefaultButtonModel.getListeners_MethodID_10, args: &__args, locals: &__locals )
    ...
    open func setActionCommand( s: String? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setActionCommand", methodSig: "(Ljava/lang/String;)V", methodCache: &DefaultButtonModel.setActionCommand_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func addActionListener( l: java_awt.ActionListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addActionListener", methodSig: "(Ljava/awt/event/ActionListener;)V", methodCache: &DefaultButtonModel.addActionListener_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func setMnemonic( key: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setMnemonic", methodSig: "(I)V", methodCache: &DefaultButtonModel.setMnemonic_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var setGroup_MethodID_15: jmethodID?

    open func setGroup( group: ButtonGroup? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: group != nil ? group! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setGroup", methodSig: "(Ljavax/swing/ButtonGroup;)V", methodCache: &DefaultButtonModel.setGroup_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func addChangeListener( l: ChangeListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &DefaultButtonModel.addChangeListener_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    open func removeChangeListener( l: ChangeListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &DefaultButtonModel.removeChangeListener_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var getChangeListeners_MethodID_18: jmethodID?

    open func getChangeListeners() -> [ChangeListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChangeListeners", methodSig: "()[Ljavax/swing/event/ChangeListener;", methodCache: &DefaultButtonModel.getChangeListeners_MethodID_18, args: &__args, locals: &__locals )
    ...
    open func fireStateChanged() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireStateChanged", methodSig: "()V", methodCache: &DefaultButtonModel.fireStateChanged_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    open func addItemListener( l: java_awt.ItemListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addItemListener", methodSig: "(Ljava/awt/event/ItemListener;)V", methodCache: &DefaultButtonModel.addItemListener_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var removeItemListener_MethodID_21: jmethodID?

    open func removeItemListener( l: java_awt.ItemListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeItemListener", methodSig: "(Ljava/awt/event/ItemListener;)V", methodCache: &DefaultButtonModel.removeItemListener_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var getItemListeners_MethodID_22: jmethodID?

    open func getItemListeners() -> [ItemListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getItemListeners", methodSig: "()[Ljava/awt/event/ItemListener;", methodCache: &DefaultButtonModel.getItemListeners_MethodID_22, args: &__args, locals: &__locals )
    ...
    open func removeActionListener( l: java_awt.ActionListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeActionListener", methodSig: "(Ljava/awt/event/ActionListener;)V", methodCache: &DefaultButtonModel.removeActionListener_MethodID_23, args: &__args, locals: &__locals )
    }
    ...
    open func getActionListeners() -> [ActionListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getActionListeners", methodSig: "()[Ljava/awt/event/ActionListener;", methodCache: &DefaultButtonModel.getActionListeners_MethodID_24, args: &__args, locals: &__locals )
    ...
    private static var fireItemStateChanged_MethodID_25: jmethodID?

    open func fireItemStateChanged( e: java_awt.ItemEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e != nil ? e! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireItemStateChanged", methodSig: "(Ljava/awt/event/ItemEvent;)V", methodCache: &DefaultButtonModel.fireItemStateChanged_MethodID_25, args: &__args, locals: &__locals )
    }
    ...
    private static var getSelectedObjects_MethodID_26: jmethodID?

    open func getSelectedObjects() -> [JavaObject]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectedObjects", methodSig: "()[Ljava/lang/Object;", methodCache: &DefaultButtonModel.getSelectedObjects_MethodID_26, args: &__args, locals: &__locals )
    ...
    private static var setArmed_MethodID_27: jmethodID?

    open func setArmed( b: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setArmed", methodSig: "(Z)V", methodCache: &DefaultButtonModel.setArmed_MethodID_27, args: &__args, locals: &__locals )
    }
    ...
    private static var setPressed_MethodID_28: jmethodID?

    open func setPressed( b: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setPressed", methodSig: "(Z)V", methodCache: &DefaultButtonModel.setPressed_MethodID_28, args: &__args, locals: &__locals )
    }
    ...
    private static var getActionCommand_MethodID_31: jmethodID?

    open func getActionCommand() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getActionCommand", methodSig: "()Ljava/lang/String;", methodCache: &DefaultButtonModel.getActionCommand_MethodID_31, args: &__args, locals: &__locals )
