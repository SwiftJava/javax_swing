...
open class UndoableEditSupport: java_swift.JavaObject {
    ...
    private static var getUndoableEditListeners_MethodID_3: jmethodID?

    open func getUndoableEditListeners() -> [UndoableEditListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUndoableEditListeners", methodSig: "()[Ljavax/swing/event/UndoableEditListener;", methodCache: &UndoableEditSupport.getUndoableEditListeners_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var removeUndoableEditListener_MethodID_5: jmethodID?

    open func removeUndoableEditListener( l: UndoableEditListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeUndoableEditListener", methodSig: "(Ljavax/swing/event/UndoableEditListener;)V", methodCache: &UndoableEditSupport.removeUndoableEditListener_MethodID_5, args: &__args, locals: &__locals )
    }
