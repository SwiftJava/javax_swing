...
open class UndoableEditSupport: java_swift.JavaObject {
    ...
    open var compoundEdit: CompoundEdit! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "compoundEdit", fieldType: "Ljavax/swing/undo/CompoundEdit;", fieldCache: &UndoableEditSupport.compoundEdit_FieldID, object: javaObject )
    ...
    open var listeners: java_util.Vector! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listeners", fieldType: "Ljava/util/Vector;", fieldCache: &UndoableEditSupport.listeners_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var realSource: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "realSource", fieldType: "Ljava/lang/Object;", fieldCache: &UndoableEditSupport.realSource_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var updateLevel: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "updateLevel", fieldType: "I", fieldCache: &UndoableEditSupport.updateLevel_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    private static var _postEdit_MethodID_3: jmethodID?

    open func _postEdit( e: UndoableEdit? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "_postEdit", methodSig: "(Ljavax/swing/undo/UndoableEdit;)V", methodCache: &UndoableEditSupport._postEdit_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func addUndoableEditListener( l: UndoableEditListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addUndoableEditListener", methodSig: "(Ljavax/swing/event/UndoableEditListener;)V", methodCache: &UndoableEditSupport.addUndoableEditListener_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var beginUpdate_MethodID_5: jmethodID?

    open func beginUpdate() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "beginUpdate", methodSig: "()V", methodCache: &UndoableEditSupport.beginUpdate_MethodID_5, args: &__args, locals: &__locals )
    }


    /// protected javax.swing.undo.CompoundEdit javax.swing.undo.UndoableEditSupport.createCompoundEdit()

    private static var createCompoundEdit_MethodID_6: jmethodID?

    open func createCompoundEdit() -> CompoundEdit! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createCompoundEdit", methodSig: "()Ljavax/swing/undo/CompoundEdit;", methodCache: &UndoableEditSupport.createCompoundEdit_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var endUpdate_MethodID_7: jmethodID?

    open func endUpdate() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "endUpdate", methodSig: "()V", methodCache: &UndoableEditSupport.endUpdate_MethodID_7, args: &__args, locals: &__locals )
    }


    /// public synchronized javax.swing.event.UndoableEditListener[] javax.swing.undo.UndoableEditSupport.getUndoableEditListeners()

    private static var getUndoableEditListeners_MethodID_8: jmethodID?

    open func getUndoableEditListeners() -> [UndoableEditListener]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUndoableEditListeners", methodSig: "()[Ljavax/swing/event/UndoableEditListener;", methodCache: &UndoableEditSupport.getUndoableEditListeners_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var getUpdateLevel_MethodID_9: jmethodID?

    open func getUpdateLevel() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getUpdateLevel", methodSig: "()I", methodCache: &UndoableEditSupport.getUpdateLevel_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var postEdit_MethodID_10: jmethodID?

    open func postEdit( e: UndoableEdit? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "postEdit", methodSig: "(Ljavax/swing/undo/UndoableEdit;)V", methodCache: &UndoableEditSupport.postEdit_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func removeUndoableEditListener( l: UndoableEditListener? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeUndoableEditListener", methodSig: "(Ljavax/swing/event/UndoableEditListener;)V", methodCache: &UndoableEditSupport.removeUndoableEditListener_MethodID_11, args: &__args, locals: &__locals )
    }
