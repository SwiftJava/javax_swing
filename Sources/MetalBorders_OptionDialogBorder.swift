...
open class MetalBorders_OptionDialogBorder: AbstractBorder, UIResource {
    ...
    open func paintBorder( c: java_awt.Component?, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljava/awt/Component;Ljava/awt/Graphics;IIII)V", methodCache: &MetalBorders_OptionDialogBorder.paintBorder_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func getBorderInsets( c: java_awt.Component?, newInsets: java_awt.Insets? ) -> java_awt.Insets! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBorderInsets", methodSig: "(Ljava/awt/Component;Ljava/awt/Insets;)Ljava/awt/Insets;", methodCache: &MetalBorders_OptionDialogBorder.getBorderInsets_MethodID_3, args: &__args, locals: &__locals )
