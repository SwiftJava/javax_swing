...
open class StyledEditorKit_ForegroundAction: StyledEditorKit_StyledTextAction {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &StyledEditorKit_ForegroundAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &StyledEditorKit_ForegroundAction.enabled_FieldID, object: javaObject )
    ...
    public convenience init( nm: String?, fg: java_awt.Color? ) {
        var __locals = [jobject]()
    ...
    public convenience init( _ _nm: String?, _ _fg: java_awt.Color? ) {
        self.init( nm: _nm, fg: _fg )
    }
