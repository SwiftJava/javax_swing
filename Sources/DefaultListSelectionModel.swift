...
open class DefaultListSelectionModel: java_swift.JavaObject, ListSelectionModel, java_lang.Cloneable, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open func getSelectionMode() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSelectionMode", methodSig: "()I", methodCache: &DefaultListSelectionModel.getSelectionMode_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var isSelectionEmpty_MethodID_4: jmethodID?

    open func isSelectionEmpty() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSelectionEmpty", methodSig: "()Z", methodCache: &DefaultListSelectionModel.isSelectionEmpty_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var fireValueChanged_MethodID_5: jmethodID?

    open func fireValueChanged( isAdjusting: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: isAdjusting, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireValueChanged", methodSig: "(Z)V", methodCache: &DefaultListSelectionModel.fireValueChanged_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func fireValueChanged( firstIndex: Int, lastIndex: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireValueChanged", methodSig: "(II)V", methodCache: &DefaultListSelectionModel.fireValueChanged_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func fireValueChanged( firstIndex: Int, lastIndex: Int, isAdjusting: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireValueChanged", methodSig: "(IIZ)V", methodCache: &DefaultListSelectionModel.fireValueChanged_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var getListSelectionListeners_MethodID_8: jmethodID?

    open func getListSelectionListeners() -> [ListSelectionListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getListSelectionListeners", methodSig: "()[Ljavax/swing/event/ListSelectionListener;", methodCache: &DefaultListSelectionModel.getListSelectionListeners_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var setLeadAnchorNotificationEnabled_MethodID_9: jmethodID?

    open func setLeadAnchorNotificationEnabled( flag: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: flag, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLeadAnchorNotificationEnabled", methodSig: "(Z)V", methodCache: &DefaultListSelectionModel.setLeadAnchorNotificationEnabled_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var isLeadAnchorNotificationEnabled_MethodID_10: jmethodID?

    open func isLeadAnchorNotificationEnabled() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isLeadAnchorNotificationEnabled", methodSig: "()Z", methodCache: &DefaultListSelectionModel.isLeadAnchorNotificationEnabled_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var moveLeadSelectionIndex_MethodID_11: jmethodID?

    open func moveLeadSelectionIndex( leadIndex: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: leadIndex, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "moveLeadSelectionIndex", methodSig: "(I)V", methodCache: &DefaultListSelectionModel.moveLeadSelectionIndex_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func setSelectionMode( selectionMode: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectionMode", methodSig: "(I)V", methodCache: &DefaultListSelectionModel.setSelectionMode_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func clearSelection() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "clearSelection", methodSig: "()V", methodCache: &DefaultListSelectionModel.clearSelection_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var getAnchorSelectionIndex_MethodID_15: jmethodID?

    open func getAnchorSelectionIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAnchorSelectionIndex", methodSig: "()I", methodCache: &DefaultListSelectionModel.getAnchorSelectionIndex_MethodID_15, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getLeadSelectionIndex_MethodID_16: jmethodID?

    open func getLeadSelectionIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getLeadSelectionIndex", methodSig: "()I", methodCache: &DefaultListSelectionModel.getLeadSelectionIndex_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var setValueIsAdjusting_MethodID_17: jmethodID?

    open func setValueIsAdjusting( valueIsAdjusting: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: valueIsAdjusting, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setValueIsAdjusting", methodSig: "(Z)V", methodCache: &DefaultListSelectionModel.setValueIsAdjusting_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var setAnchorSelectionIndex_MethodID_18: jmethodID?

    open func setAnchorSelectionIndex( index: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: index, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setAnchorSelectionIndex", methodSig: "(I)V", methodCache: &DefaultListSelectionModel.setAnchorSelectionIndex_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var setLeadSelectionIndex_MethodID_19: jmethodID?

    open func setLeadSelectionIndex( index: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: index, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLeadSelectionIndex", methodSig: "(I)V", methodCache: &DefaultListSelectionModel.setLeadSelectionIndex_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    private static var setSelectionInterval_MethodID_20: jmethodID?
    ...
    open func setSelectionInterval( index0: Int, index1: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectionInterval", methodSig: "(II)V", methodCache: &DefaultListSelectionModel.setSelectionInterval_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var addSelectionInterval_MethodID_21: jmethodID?
    ...
    open func addSelectionInterval( index0: Int, index1: Int ) {
        ...
        __args[0] = JNIType.toJava( value: index0, locals: &__locals )
        __args[1] = JNIType.toJava( value: index1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addSelectionInterval", methodSig: "(II)V", methodCache: &DefaultListSelectionModel.addSelectionInterval_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var removeSelectionInterval_MethodID_22: jmethodID?
    ...
    open func removeSelectionInterval( index0: Int, index1: Int ) {
        ...
        __args[0] = JNIType.toJava( value: index0, locals: &__locals )
        __args[1] = JNIType.toJava( value: index1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeSelectionInterval", methodSig: "(II)V", methodCache: &DefaultListSelectionModel.removeSelectionInterval_MethodID_22, args: &__args, locals: &__locals )
    }
    ...
    private static var getMinSelectionIndex_MethodID_23: jmethodID?

    open func getMinSelectionIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMinSelectionIndex", methodSig: "()I", methodCache: &DefaultListSelectionModel.getMinSelectionIndex_MethodID_23, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func getMaxSelectionIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMaxSelectionIndex", methodSig: "()I", methodCache: &DefaultListSelectionModel.getMaxSelectionIndex_MethodID_24, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var isSelectedIndex_MethodID_25: jmethodID?

    open func isSelectedIndex( index: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: index, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSelectedIndex", methodSig: "(I)Z", methodCache: &DefaultListSelectionModel.isSelectedIndex_MethodID_25, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var removeListSelectionListener_MethodID_26: jmethodID?

    open func removeListSelectionListener( x: ListSelectionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeListSelectionListener", methodSig: "(Ljavax/swing/event/ListSelectionListener;)V", methodCache: &DefaultListSelectionModel.removeListSelectionListener_MethodID_26, args: &__args, locals: &__locals )
    }
    ...
    private static var addListSelectionListener_MethodID_27: jmethodID?

    open func addListSelectionListener( x: ListSelectionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addListSelectionListener", methodSig: "(Ljavax/swing/event/ListSelectionListener;)V", methodCache: &DefaultListSelectionModel.addListSelectionListener_MethodID_27, args: &__args, locals: &__locals )
    }
    ...
    private static var insertIndexInterval_MethodID_28: jmethodID?
    ...
    open func insertIndexInterval( index: Int, length: Int, before: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertIndexInterval", methodSig: "(IIZ)V", methodCache: &DefaultListSelectionModel.insertIndexInterval_MethodID_28, args: &__args, locals: &__locals )
    }
    ...
    private static var removeIndexInterval_MethodID_29: jmethodID?
    ...
    open func removeIndexInterval( index0: Int, index1: Int ) {
        ...
        __args[0] = JNIType.toJava( value: index0, locals: &__locals )
        __args[1] = JNIType.toJava( value: index1, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeIndexInterval", methodSig: "(II)V", methodCache: &DefaultListSelectionModel.removeIndexInterval_MethodID_29, args: &__args, locals: &__locals )
    }
