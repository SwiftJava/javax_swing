...
open class StyleConstants_FontConstants: StyleConstants, AttributeSet_FontAttribute, AttributeSet_CharacterAttribute {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.text.StyleConstants$FontConstants", file, line ) {
            return nil
        }
