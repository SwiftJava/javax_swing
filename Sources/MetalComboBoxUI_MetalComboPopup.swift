...
open class MetalComboBoxUI_MetalComboPopup: BasicComboPopup {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.plaf.metal.MetalComboBoxUI$MetalComboPopup", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: MetalComboBoxUI?, arg1: JComboBox? ) {
    ...
    public convenience init( _ _arg0: MetalComboBoxUI?, _ _arg1: JComboBox? ) {
    ...
    override open func delegateFocus( arg0: java_awt.MouseEvent? ) {
    ...
    override open func delegateFocus( _ _arg0: java_awt.MouseEvent? ) {
