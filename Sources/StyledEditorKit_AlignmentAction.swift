...
open class StyledEditorKit_AlignmentAction: StyledEditorKit_StyledTextAction {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &StyledEditorKit_AlignmentAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &StyledEditorKit_AlignmentAction.enabled_FieldID, object: javaObject )
