...
open class MetalBorders_ButtonBorder: AbstractBorder, UIResource {
    ...
    open func paintBorder( c: java_awt.Component?, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljava/awt/Component;Ljava/awt/Graphics;IIII)V", methodCache: &MetalBorders_ButtonBorder.paintBorder_MethodID_2, args: &__args, locals: &__locals )
    }
