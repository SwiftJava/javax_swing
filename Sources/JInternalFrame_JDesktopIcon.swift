...
open class JInternalFrame_JDesktopIcon: JComponent {
    ...
    override open var listenerList: EventListenerList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JInternalFrame_JDesktopIcon.listenerList_FieldID, object: javaObject )
    ...
    override open var ui: ComponentUI! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JInternalFrame_JDesktopIcon.ui_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var accessibleContext: /* class javax.accessibility.AccessibleContext */ UnavailableObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JInternalFrame_JDesktopIcon.accessibleContext_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open func getUI() -> DesktopIconUI! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUI", methodSig: "()Ljavax/swing/plaf/DesktopIconUI;", methodCache: &JInternalFrame_JDesktopIcon.getUI_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setInternalFrame_MethodID_5: jmethodID?

    open func setInternalFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setInternalFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &JInternalFrame_JDesktopIcon.setInternalFrame_MethodID_5, args: &__args, locals: &__locals )
    }

    open func setInternalFrame( _ _f: JInternalFrame? ) {
        setInternalFrame( f: _f )
    }
    ...
    open func setUI( ui: DesktopIconUI? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setUI", methodSig: "(Ljavax/swing/plaf/DesktopIconUI;)V", methodCache: &JInternalFrame_JDesktopIcon.setUI_MethodID_6, args: &__args, locals: &__locals )
    }
