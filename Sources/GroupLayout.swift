...
open class GroupLayout: java_swift.JavaObject, java_awt.LayoutManager2 {
    ...
    open func addLayoutComponent( comp: java_awt.Component?, constraints: java_swift.JavaObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addLayoutComponent", methodSig: "(Ljava/awt/Component;Ljava/lang/Object;)V", methodCache: &GroupLayout.addLayoutComponent_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func addLayoutComponent( name: String?, comp: java_awt.Component? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addLayoutComponent", methodSig: "(Ljava/lang/String;Ljava/awt/Component;)V", methodCache: &GroupLayout.addLayoutComponent_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func setHonorsVisibility( honorsVisibility: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setHonorsVisibility", methodSig: "(Z)V", methodCache: &GroupLayout.setHonorsVisibility_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func setHonorsVisibility( component: java_awt.Component?, honorsVisibility: java_lang.Boolean? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setHonorsVisibility", methodSig: "(Ljava/awt/Component;Ljava/lang/Boolean;)V", methodCache: &GroupLayout.setHonorsVisibility_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func createParallelGroup( alignment: GroupLayout_Alignment? ) -> GroupLayout_ParallelGroup! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createParallelGroup", methodSig: "(Ljavax/swing/GroupLayout$Alignment;)Ljavax/swing/GroupLayout$ParallelGroup;", methodCache: &GroupLayout.createParallelGroup_MethodID_23, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createParallelGroup( alignment: GroupLayout_Alignment?, resizable: Bool ) -> GroupLayout_ParallelGroup! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createParallelGroup", methodSig: "(Ljavax/swing/GroupLayout$Alignment;Z)Ljavax/swing/GroupLayout$ParallelGroup;", methodCache: &GroupLayout.createParallelGroup_MethodID_24, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? GroupLayout_ParallelGroup( javaObject: __return ) : nil
    }
    ...
    open func createParallelGroup() -> GroupLayout_ParallelGroup! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createParallelGroup", methodSig: "()Ljavax/swing/GroupLayout$ParallelGroup;", methodCache: &GroupLayout.createParallelGroup_MethodID_25, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? GroupLayout_ParallelGroup( javaObject: __return ) : nil
    }
