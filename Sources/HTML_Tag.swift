...
open class HTML_Tag: java_swift.JavaObject {
    ...
    public convenience init( id: String?, causesBreak: Bool, isBlock: Bool ) {
        ...
        __args[1] = JNIType.toJava( value: causesBreak, locals: &__locals )
        __args[2] = JNIType.toJava( value: isBlock, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTML$Tag", classCache: &HTML_Tag.HTML_TagJNIClass, methodSig: "(Ljava/lang/String;ZZ)V", methodCache: &HTML_Tag.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTML$Tag", classCache: &HTML_Tag.HTML_TagJNIClass, methodSig: "()V", methodCache: &HTML_Tag.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
