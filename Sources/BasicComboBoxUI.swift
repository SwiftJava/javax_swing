...
open class BasicComboBoxUI: ComboBoxUI {
    ...
    open func createEditor() -> ComboBoxEditor! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createEditor", methodSig: "()Ljavax/swing/ComboBoxEditor;", methodCache: &BasicComboBoxUI.createEditor_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func configureEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "configureEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.configureEditor_MethodID_4, args: &__args, locals: &__locals )
    }


    /// protected java.awt.event.ItemListener javax.swing.plaf.basic.BasicComboBoxUI.createItemListener()

    private static var createItemListener_MethodID_5: jmethodID?

    open func createItemListener() -> java_awt.ItemListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createItemListener", methodSig: "()Ljava/awt/event/ItemListener;", methodCache: &BasicComboBoxUI.createItemListener_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &BasicComboBoxUI.installDefaults_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func installComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installComponents", methodSig: "()V", methodCache: &BasicComboBoxUI.installComponents_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicComboBoxUI.installListeners_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func createKeyListener() -> java_awt.KeyListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createKeyListener", methodSig: "()Ljava/awt/event/KeyListener;", methodCache: &BasicComboBoxUI.createKeyListener_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var selectNextPossibleValue_MethodID_16: jmethodID?

    open func selectNextPossibleValue() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectNextPossibleValue", methodSig: "()V", methodCache: &BasicComboBoxUI.selectNextPossibleValue_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var selectPreviousPossibleValue_MethodID_17: jmethodID?

    open func selectPreviousPossibleValue() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectPreviousPossibleValue", methodSig: "()V", methodCache: &BasicComboBoxUI.selectPreviousPossibleValue_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var createPopup_MethodID_18: jmethodID?

    open func createPopup() -> ComboPopup! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPopup", methodSig: "()Ljavax/swing/plaf/basic/ComboPopup;", methodCache: &BasicComboBoxUI.createPopup_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var unconfigureEditor_MethodID_24: jmethodID?

    open func unconfigureEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "unconfigureEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.unconfigureEditor_MethodID_24, args: &__args, locals: &__locals )
    }


    /// public void javax.swing.plaf.basic.BasicComboBoxUI.configureArrowButton()

    private static var configureArrowButton_MethodID_25: jmethodID?

    open func configureArrowButton() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "configureArrowButton", methodSig: "()V", methodCache: &BasicComboBoxUI.configureArrowButton_MethodID_25, args: &__args, locals: &__locals )
    }


    /// public void javax.swing.plaf.basic.BasicComboBoxUI.unconfigureArrowButton()

    private static var unconfigureArrowButton_MethodID_26: jmethodID?

    open func unconfigureArrowButton() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "unconfigureArrowButton", methodSig: "()V", methodCache: &BasicComboBoxUI.unconfigureArrowButton_MethodID_26, args: &__args, locals: &__locals )
    }


    /// protected javax.swing.JButton javax.swing.plaf.basic.BasicComboBoxUI.createArrowButton()

    private static var createArrowButton_MethodID_27: jmethodID?

    open func createArrowButton() -> JButton! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createArrowButton", methodSig: "()Ljavax/swing/JButton;", methodCache: &BasicComboBoxUI.createArrowButton_MethodID_27, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isNavigationKey_MethodID_28: jmethodID?

    open func isNavigationKey( keyCode: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: keyCode, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isNavigationKey", methodSig: "(I)Z", methodCache: &BasicComboBoxUI.isNavigationKey_MethodID_28, args: &__args, locals: &__locals )
    ...
    private static var toggleOpenClose_MethodID_29: jmethodID?

    open func toggleOpenClose() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "toggleOpenClose", methodSig: "()V", methodCache: &BasicComboBoxUI.toggleOpenClose_MethodID_29, args: &__args, locals: &__locals )
    }


    /// protected java.awt.Rectangle javax.swing.plaf.basic.BasicComboBoxUI.rectangleForCurrentValue()

    private static var rectangleForCurrentValue_MethodID_30: jmethodID?

    open func rectangleForCurrentValue() -> java_awt.Rectangle! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "rectangleForCurrentValue", methodSig: "()Ljava/awt/Rectangle;", methodCache: &BasicComboBoxUI.rectangleForCurrentValue_MethodID_30, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var paintCurrentValue_MethodID_31: jmethodID?
    ...
    open func paintCurrentValue( g: java_awt.Graphics?, bounds: java_awt.Rectangle?, hasFocus: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintCurrentValue", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Z)V", methodCache: &BasicComboBoxUI.paintCurrentValue_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    private static var paintCurrentValueBackground_MethodID_32: jmethodID?
    ...
    open func paintCurrentValueBackground( g: java_awt.Graphics?, bounds: java_awt.Rectangle?, hasFocus: Bool ) {
        ...
        __args[1] = JNIType.toJava( value: bounds, locals: &__locals )
        __args[2] = JNIType.toJava( value: hasFocus, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintCurrentValueBackground", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Z)V", methodCache: &BasicComboBoxUI.paintCurrentValueBackground_MethodID_32, args: &__args, locals: &__locals )
    }
    ...
    private static var getDefaultSize_MethodID_33: jmethodID?

    open func getDefaultSize() -> java_awt.Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDefaultSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getDefaultSize_MethodID_33, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getDisplaySize_MethodID_34: jmethodID?

    open func getDisplaySize() -> java_awt.Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisplaySize", methodSig: "()Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getDisplaySize_MethodID_34, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    private static var getSizeForComponent_MethodID_35: jmethodID?
    ...
    open func getSizeForComponent( comp: java_awt.Component? ) -> java_awt.Dimension! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSizeForComponent", methodSig: "(Ljava/awt/Component;)Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getSizeForComponent_MethodID_35, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    private static var getInsets_MethodID_36: jmethodID?

    open func getInsets() -> java_awt.Insets! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInsets", methodSig: "()Ljava/awt/Insets;", methodCache: &BasicComboBoxUI.getInsets_MethodID_36, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var removeEditor_MethodID_37: jmethodID?

    open func removeEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.removeEditor_MethodID_37, args: &__args, locals: &__locals )
    }
