...
open class BasicComboBoxUI: ComboBoxUI {
    ...
    open var squareButton: Bool {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetBooleanField( fieldName: "squareButton", fieldType: "Z", fieldCache: &BasicComboBoxUI.squareButton_FieldID, object: javaObject, locals: &__locals )
            return JNIType.toSwift( type: Bool(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var padding: java_awt.Insets! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "padding", fieldType: "Ljava/awt/Insets;", fieldCache: &BasicComboBoxUI.padding_FieldID, object: javaObject, locals: &__locals )
    ...
    private static var removeEditor_MethodID_2: jmethodID?

    open func removeEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.removeEditor_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func getInsets() -> java_awt.Insets! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInsets", methodSig: "()Ljava/awt/Insets;", methodCache: &BasicComboBoxUI.getInsets_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &BasicComboBoxUI.installDefaults_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func installComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installComponents", methodSig: "()V", methodCache: &BasicComboBoxUI.installComponents_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicComboBoxUI.installListeners_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func installKeyboardActions() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installKeyboardActions", methodSig: "()V", methodCache: &BasicComboBoxUI.installKeyboardActions_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "()V", methodCache: &BasicComboBoxUI.uninstallDefaults_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallComponents", methodSig: "()V", methodCache: &BasicComboBoxUI.uninstallComponents_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &BasicComboBoxUI.uninstallListeners_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallKeyboardActions() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallKeyboardActions", methodSig: "()V", methodCache: &BasicComboBoxUI.uninstallKeyboardActions_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func createPropertyChangeListener() -> /* java.beans.PropertyChangeListener */ UnclassedProtocol! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPropertyChangeListener", methodSig: "()Ljava/beans/PropertyChangeListener;", methodCache: &BasicComboBoxUI.createPropertyChangeListener_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createKeyListener_MethodID_14: jmethodID?

    open func createKeyListener() -> java_awt.KeyListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createKeyListener", methodSig: "()Ljava/awt/event/KeyListener;", methodCache: &BasicComboBoxUI.createKeyListener_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createFocusListener() -> java_awt.FocusListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFocusListener", methodSig: "()Ljava/awt/event/FocusListener;", methodCache: &BasicComboBoxUI.createFocusListener_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createListDataListener_MethodID_19: jmethodID?

    open func createListDataListener() -> ListDataListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createListDataListener", methodSig: "()Ljavax/swing/event/ListDataListener;", methodCache: &BasicComboBoxUI.createListDataListener_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createLayoutManager() -> java_awt.LayoutManager! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createLayoutManager", methodSig: "()Ljava/awt/LayoutManager;", methodCache: &BasicComboBoxUI.createLayoutManager_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createRenderer_MethodID_21: jmethodID?

    open func createRenderer() -> ListCellRenderer! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createRenderer", methodSig: "()Ljavax/swing/ListCellRenderer;", methodCache: &BasicComboBoxUI.createRenderer_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var addEditor_MethodID_22: jmethodID?

    open func addEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.addEditor_MethodID_22, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicComboBoxUI.unconfigureEditor()

    private static var unconfigureEditor_MethodID_23: jmethodID?

    open func unconfigureEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "unconfigureEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.unconfigureEditor_MethodID_23, args: &__args, locals: &__locals )
    }


    /// public void javax.swing.plaf.basic.BasicComboBoxUI.configureArrowButton()

    private static var configureArrowButton_MethodID_24: jmethodID?

    open func configureArrowButton() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "configureArrowButton", methodSig: "()V", methodCache: &BasicComboBoxUI.configureArrowButton_MethodID_24, args: &__args, locals: &__locals )
    }


    /// public void javax.swing.plaf.basic.BasicComboBoxUI.unconfigureArrowButton()

    private static var unconfigureArrowButton_MethodID_25: jmethodID?

    open func unconfigureArrowButton() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "unconfigureArrowButton", methodSig: "()V", methodCache: &BasicComboBoxUI.unconfigureArrowButton_MethodID_25, args: &__args, locals: &__locals )
    }


    /// protected javax.swing.JButton javax.swing.plaf.basic.BasicComboBoxUI.createArrowButton()

    private static var createArrowButton_MethodID_26: jmethodID?

    open func createArrowButton() -> JButton! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createArrowButton", methodSig: "()Ljavax/swing/JButton;", methodCache: &BasicComboBoxUI.createArrowButton_MethodID_26, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isNavigationKey_MethodID_27: jmethodID?

    open func isNavigationKey( keyCode: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: keyCode, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isNavigationKey", methodSig: "(I)Z", methodCache: &BasicComboBoxUI.isNavigationKey_MethodID_27, args: &__args, locals: &__locals )
    ...
    private static var toggleOpenClose_MethodID_28: jmethodID?

    open func toggleOpenClose() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "toggleOpenClose", methodSig: "()V", methodCache: &BasicComboBoxUI.toggleOpenClose_MethodID_28, args: &__args, locals: &__locals )
    }


    /// protected java.awt.Rectangle javax.swing.plaf.basic.BasicComboBoxUI.rectangleForCurrentValue()

    private static var rectangleForCurrentValue_MethodID_29: jmethodID?

    open func rectangleForCurrentValue() -> java_awt.Rectangle! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "rectangleForCurrentValue", methodSig: "()Ljava/awt/Rectangle;", methodCache: &BasicComboBoxUI.rectangleForCurrentValue_MethodID_29, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var paintCurrentValue_MethodID_30: jmethodID?
    ...
    open func paintCurrentValue( g: java_awt.Graphics?, bounds: java_awt.Rectangle?, hasFocus: Bool ) {
        ...
        __args[2] = JNIType.toJava( value: hasFocus, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintCurrentValue", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Z)V", methodCache: &BasicComboBoxUI.paintCurrentValue_MethodID_30, args: &__args, locals: &__locals )
    }
    ...
    private static var paintCurrentValueBackground_MethodID_31: jmethodID?
    ...
    open func paintCurrentValueBackground( g: java_awt.Graphics?, bounds: java_awt.Rectangle?, hasFocus: Bool ) {
        ...
        __args[1] = JNIType.toJava( value: bounds != nil ? bounds! as JNIObject : nil, locals: &__locals )
        __args[2] = JNIType.toJava( value: hasFocus, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintCurrentValueBackground", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Z)V", methodCache: &BasicComboBoxUI.paintCurrentValueBackground_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    private static var getDefaultSize_MethodID_32: jmethodID?

    open func getDefaultSize() -> java_awt.Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDefaultSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getDefaultSize_MethodID_32, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getDisplaySize_MethodID_33: jmethodID?

    open func getDisplaySize() -> java_awt.Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDisplaySize", methodSig: "()Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getDisplaySize_MethodID_33, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    private static var getSizeForComponent_MethodID_34: jmethodID?
    ...
    open func getSizeForComponent( comp: java_awt.Component? ) -> java_awt.Dimension! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSizeForComponent", methodSig: "(Ljava/awt/Component;)Ljava/awt/Dimension;", methodCache: &BasicComboBoxUI.getSizeForComponent_MethodID_34, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    private static var createEditor_MethodID_35: jmethodID?

    open func createEditor() -> ComboBoxEditor! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createEditor", methodSig: "()Ljavax/swing/ComboBoxEditor;", methodCache: &BasicComboBoxUI.createEditor_MethodID_35, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var configureEditor_MethodID_36: jmethodID?

    open func configureEditor() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "configureEditor", methodSig: "()V", methodCache: &BasicComboBoxUI.configureEditor_MethodID_36, args: &__args, locals: &__locals )
    }


    /// protected java.awt.event.ItemListener javax.swing.plaf.basic.BasicComboBoxUI.createItemListener()

    private static var createItemListener_MethodID_37: jmethodID?

    open func createItemListener() -> java_awt.ItemListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createItemListener", methodSig: "()Ljava/awt/event/ItemListener;", methodCache: &BasicComboBoxUI.createItemListener_MethodID_37, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
