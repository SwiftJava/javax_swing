...
open class JToolBar_Separator: JSeparator {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.JToolBar$Separator", file, line ) {
            return nil
        }
    ...
    private static var JToolBar_SeparatorJNIClass: jclass?

    /// private java.awt.Dimension javax.swing.JToolBar$Separator.separatorSize
    ...
    override open var ui: ComponentUI! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JToolBar_Separator.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JToolBar_Separator.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JToolBar_Separator.accessibleContext_FieldID, object: javaObject, locals: &__locals )
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/JToolBar$Separator", classCache: &JToolBar_Separator.JToolBar_SeparatorJNIClass, methodSig: "()V", methodCache: &JToolBar_Separator.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// public javax.swing.JToolBar$Separator(java.awt.Dimension)

    private static var new_MethodID_2: jmethodID?

    public convenience init( arg0: java_awt.Dimension? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    public convenience init( _ _arg0: java_awt.Dimension? ) {
    ...
    open func getSeparatorSize() -> java_awt.Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSeparatorSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &JToolBar_Separator.getSeparatorSize_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }


    /// public void javax.swing.JToolBar$Separator.setSeparatorSize(java.awt.Dimension)

    private static var setSeparatorSize_MethodID_4: jmethodID?

    open func setSeparatorSize( arg0: java_awt.Dimension? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func setSeparatorSize( _ _arg0: java_awt.Dimension? ) {
        setSeparatorSize( arg0: _arg0 )
    }
