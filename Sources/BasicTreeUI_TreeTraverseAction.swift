...
open class BasicTreeUI_TreeTraverseAction: AbstractAction {
    ...
    open var direction: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "direction", fieldType: "I", fieldCache: &BasicTreeUI_TreeTraverseAction.direction_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &BasicTreeUI_TreeTraverseAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &BasicTreeUI_TreeTraverseAction.enabled_FieldID, object: javaObject )
