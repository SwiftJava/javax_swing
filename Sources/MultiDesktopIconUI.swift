...
open class MultiDesktopIconUI: DesktopIconUI {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.plaf.multi.MultiDesktopIconUI", file, line ) {
            return nil
        }
    ...
    override open class func createUI( arg0: JComponent? ) -> ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/multi/MultiDesktopIconUI", classCache: &MultiDesktopIconUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func getUIs() -> [ComponentUI]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUIs", methodSig: "()[Ljavax/swing/plaf/ComponentUI;", methodCache: &MultiDesktopIconUI.getUIs_MethodID_3, args: &__args, locals: &__locals )
