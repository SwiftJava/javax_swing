...
open class MetalInternalFrameUI: BasicInternalFrameUI {
    ...
    override open var borderListener: MouseInputAdapter! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "borderListener", fieldType: "Ljavax/swing/event/MouseInputAdapter;", fieldCache: &MetalInternalFrameUI.borderListener_FieldID, object: javaObject )
    ...
    override open var componentListener: java_awt.ComponentListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "componentListener", fieldType: "Ljava/awt/event/ComponentListener;", fieldCache: &MetalInternalFrameUI.componentListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var eastPane: JComponent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "eastPane", fieldType: "Ljavax/swing/JComponent;", fieldCache: &MetalInternalFrameUI.eastPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var frame: JInternalFrame! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "frame", fieldType: "Ljavax/swing/JInternalFrame;", fieldCache: &MetalInternalFrameUI.frame_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var glassPaneDispatcher: MouseInputListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "glassPaneDispatcher", fieldType: "Ljavax/swing/event/MouseInputListener;", fieldCache: &MetalInternalFrameUI.glassPaneDispatcher_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var internalFrameLayout: java_awt.LayoutManager! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "internalFrameLayout", fieldType: "Ljava/awt/LayoutManager;", fieldCache: &MetalInternalFrameUI.internalFrameLayout_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var northPane: JComponent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "northPane", fieldType: "Ljavax/swing/JComponent;", fieldCache: &MetalInternalFrameUI.northPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? JComponent( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var openMenuKey: KeyStroke! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "openMenuKey", fieldType: "Ljavax/swing/KeyStroke;", fieldCache: &MetalInternalFrameUI.openMenuKey_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var propertyChangeListener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "propertyChangeListener", fieldType: "Ljava/beans/PropertyChangeListener;", fieldCache: &MetalInternalFrameUI.propertyChangeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var southPane: JComponent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "southPane", fieldType: "Ljavax/swing/JComponent;", fieldCache: &MetalInternalFrameUI.southPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? JComponent( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var titlePane: BasicInternalFrameTitlePane! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "titlePane", fieldType: "Ljavax/swing/plaf/basic/BasicInternalFrameTitlePane;", fieldCache: &MetalInternalFrameUI.titlePane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var westPane: JComponent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "westPane", fieldType: "Ljavax/swing/JComponent;", fieldCache: &MetalInternalFrameUI.westPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? JComponent( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    private static var createBorderListener_MethodID_3: jmethodID?
    ...
    override open func createBorderListener( w: JInternalFrame? ) -> MouseInputAdapter! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createBorderListener", methodSig: "(Ljavax/swing/JInternalFrame;)Ljavax/swing/event/MouseInputAdapter;", methodCache: &MetalInternalFrameUI.createBorderListener_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setPalette_MethodID_7: jmethodID?

    open func setPalette( isPalette: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( z: jboolean(isPalette ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setPalette", methodSig: "(Z)V", methodCache: &MetalInternalFrameUI.setPalette_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallKeyboardActions() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallKeyboardActions", methodSig: "()V", methodCache: &MetalInternalFrameUI.uninstallKeyboardActions_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &MetalInternalFrameUI.uninstallListeners_MethodID_10, args: &__args, locals: &__locals )
    }
