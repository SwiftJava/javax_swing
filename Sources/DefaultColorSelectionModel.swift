...
open class DefaultColorSelectionModel: java_swift.JavaObject, ColorSelectionModel, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var getSelectedColor_MethodID_3: jmethodID?

    open func getSelectedColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectedColor", methodSig: "()Ljava/awt/Color;", methodCache: &DefaultColorSelectionModel.getSelectedColor_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var setSelectedColor_MethodID_4: jmethodID?

    open func setSelectedColor( color: java_awt.Color? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: color != nil ? color! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectedColor", methodSig: "(Ljava/awt/Color;)V", methodCache: &DefaultColorSelectionModel.setSelectedColor_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func addChangeListener( listener: ChangeListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &DefaultColorSelectionModel.addChangeListener_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func removeChangeListener( listener: ChangeListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &DefaultColorSelectionModel.removeChangeListener_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func getChangeListeners() -> [ChangeListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChangeListeners", methodSig: "()[Ljavax/swing/event/ChangeListener;", methodCache: &DefaultColorSelectionModel.getChangeListeners_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func fireStateChanged() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireStateChanged", methodSig: "()V", methodCache: &DefaultColorSelectionModel.fireStateChanged_MethodID_8, args: &__args, locals: &__locals )
    }
