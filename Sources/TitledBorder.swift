...
open class TitledBorder: AbstractBorder {
    ...
    open var border: Border! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "border", fieldType: "Ljavax/swing/border/Border;", fieldCache: &TitledBorder.border_FieldID, object: javaObject )
    ...
    open var title: String! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "title", fieldType: "Ljava/lang/String;", fieldCache: &TitledBorder.title_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var titleColor: java_awt.Color! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "titleColor", fieldType: "Ljava/awt/Color;", fieldCache: &TitledBorder.titleColor_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var titleFont: java_awt.Font! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "titleFont", fieldType: "Ljava/awt/Font;", fieldCache: &TitledBorder.titleFont_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var titleJustification: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "titleJustification", fieldType: "I", fieldCache: &TitledBorder.titleJustification_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var titlePosition: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "titlePosition", fieldType: "I", fieldCache: &TitledBorder.titlePosition_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    public convenience init( border: Border? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/border/TitledBorder", classCache: &TitledBorder.TitledBorderJNIClass, methodSig: "(Ljavax/swing/border/Border;)V", methodCache: &TitledBorder.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( border: Border?, title: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/border/TitledBorder", classCache: &TitledBorder.TitledBorderJNIClass, methodSig: "(Ljavax/swing/border/Border;Ljava/lang/String;)V", methodCache: &TitledBorder.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( border: Border?, title: String?, titleJustification: Int, titlePosition: Int, titleFont: java_awt.Font? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/border/TitledBorder", classCache: &TitledBorder.TitledBorderJNIClass, methodSig: "(Ljavax/swing/border/Border;Ljava/lang/String;IILjava/awt/Font;)V", methodCache: &TitledBorder.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( border: Border?, title: String?, titleJustification: Int, titlePosition: Int, titleFont: java_awt.Font?, titleColor: java_awt.Color? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/border/TitledBorder", classCache: &TitledBorder.TitledBorderJNIClass, methodSig: "(Ljavax/swing/border/Border;Ljava/lang/String;IILjava/awt/Font;Ljava/awt/Color;)V", methodCache: &TitledBorder.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( title: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/border/TitledBorder", classCache: &TitledBorder.TitledBorderJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &TitledBorder.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    open func getBorder() -> Border! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBorder", methodSig: "()Ljavax/swing/border/Border;", methodCache: &TitledBorder.getBorder_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func getFont( c: java_awt.Component? ) -> java_awt.Font! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFont", methodSig: "(Ljava/awt/Component;)Ljava/awt/Font;", methodCache: &TitledBorder.getFont_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getMinimumSize( c: java_awt.Component? ) -> java_awt.Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "(Ljava/awt/Component;)Ljava/awt/Dimension;", methodCache: &TitledBorder.getMinimumSize_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getTitle_MethodID_10: jmethodID?

    open func getTitle() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTitle", methodSig: "()Ljava/lang/String;", methodCache: &TitledBorder.getTitle_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getTitleFont_MethodID_12: jmethodID?

    open func getTitleFont() -> java_awt.Font! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTitleFont", methodSig: "()Ljava/awt/Font;", methodCache: &TitledBorder.getTitleFont_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Font( javaObject: __return ) : nil
    }
    ...
    private static var getTitlePosition_MethodID_14: jmethodID?

    open func getTitlePosition() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getTitlePosition", methodSig: "()I", methodCache: &TitledBorder.getTitlePosition_MethodID_14, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func setBorder( border: Border? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: border, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBorder", methodSig: "(Ljavax/swing/border/Border;)V", methodCache: &TitledBorder.setBorder_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func setTitle( title: String? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: title, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setTitle", methodSig: "(Ljava/lang/String;)V", methodCache: &TitledBorder.setTitle_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var setTitleColor_MethodID_17: jmethodID?

    open func setTitleColor( titleColor: java_awt.Color? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: titleColor, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setTitleColor", methodSig: "(Ljava/awt/Color;)V", methodCache: &TitledBorder.setTitleColor_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var setTitleJustification_MethodID_19: jmethodID?

    open func setTitleJustification( titleJustification: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(titleJustification) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setTitleJustification", methodSig: "(I)V", methodCache: &TitledBorder.setTitleJustification_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    private static var setTitlePosition_MethodID_20: jmethodID?

    open func setTitlePosition( titlePosition: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(titlePosition) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setTitlePosition", methodSig: "(I)V", methodCache: &TitledBorder.setTitlePosition_MethodID_20, args: &__args, locals: &__locals )
    }
