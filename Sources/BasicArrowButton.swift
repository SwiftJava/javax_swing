...
open class BasicArrowButton: JButton {
    ...
    open var direction: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "direction", fieldType: "I", fieldCache: &BasicArrowButton.direction_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    override open var actionListener: java_awt.ActionListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &BasicArrowButton.actionListener_FieldID, object: javaObject )
    ...
    override open var changeEvent: ChangeEvent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeEvent", fieldType: "Ljavax/swing/event/ChangeEvent;", fieldCache: &BasicArrowButton.changeEvent_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var changeListener: ChangeListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &BasicArrowButton.changeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var itemListener: java_awt.ItemListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &BasicArrowButton.itemListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var model: ButtonModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &BasicArrowButton.model_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var listenerList: EventListenerList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &BasicArrowButton.listenerList_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var ui: ComponentUI! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &BasicArrowButton.ui_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var accessibleContext: /* class javax.accessibility.AccessibleContext */ UnavailableObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &BasicArrowButton.accessibleContext_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    public convenience init( direction: Int ) {
        var __locals = [jobject]()
    ...
    public convenience init( direction: Int, background: java_awt.Color?, shadow: java_awt.Color?, darkShadow: java_awt.Color?, highlight: java_awt.Color? ) {
        var __locals = [jobject]()
    ...
    public convenience init( _ _direction: Int, _ _background: java_awt.Color?, _ _shadow: java_awt.Color?, _ _darkShadow: java_awt.Color?, _ _highlight: java_awt.Color? ) {
        self.init( direction: _direction, background: _background, shadow: _shadow, darkShadow: _darkShadow, highlight: _highlight )
    }
    ...
    private static var paintTriangle_MethodID_4: jmethodID?
    ...
    open func paintTriangle( g: java_awt.Graphics?, x: Int, y: Int, size: Int, direction: Int, isEnabled: Bool ) {
        ...
        __args[3] = jvalue( i: jint(size) )
        __args[4] = jvalue( i: jint(direction) )
        __args[5] = jvalue( z: jboolean(isEnabled ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTriangle", methodSig: "(Ljava/awt/Graphics;IIIIZ)V", methodCache: &BasicArrowButton.paintTriangle_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func setDirection( direction: Int ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(direction) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDirection", methodSig: "(I)V", methodCache: &BasicArrowButton.setDirection_MethodID_5, args: &__args, locals: &__locals )
    }
