...
open class BasicArrowButton: JButton {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.plaf.basic.BasicArrowButton", file, line ) {
            return nil
        }
    ...
    private static var BasicArrowButtonJNIClass: jclass?
    ...
    open var direction: Int {
        get {
            ...
            let __value = JNIField.GetIntField( fieldName: "direction", fieldType: "I", fieldCache: &BasicArrowButton.direction_FieldID, object: javaObject, locals: &__locals )
            return JNIType.decode( type: Int(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetIntField( fieldName: "direction", fieldType: "I", fieldCache: &BasicArrowButton.direction_FieldID, object: javaObject, value: __value.i, locals: &__locals )
        }
    }

    /// private java.awt.Color javax.swing.plaf.basic.BasicArrowButton.shadow

    /// private java.awt.Color javax.swing.plaf.basic.BasicArrowButton.darkShadow

    /// private java.awt.Color javax.swing.plaf.basic.BasicArrowButton.highlight
    ...
    override open var model: ButtonModel! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &BasicArrowButton.model_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ButtonModelForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &BasicArrowButton.model_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeListener: ChangeListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &BasicArrowButton.changeListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ChangeListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &BasicArrowButton.changeListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var actionListener: java_awt.ActionListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &BasicArrowButton.actionListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ActionListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &BasicArrowButton.actionListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var itemListener: java_awt.ItemListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &BasicArrowButton.itemListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ItemListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &BasicArrowButton.itemListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeEvent: ChangeEvent! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeEvent", fieldType: "Ljavax/swing/event/ChangeEvent;", fieldCache: &BasicArrowButton.changeEvent_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var ui: ComponentUI! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &BasicArrowButton.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &BasicArrowButton.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &BasicArrowButton.accessibleContext_FieldID, object: javaObject, locals: &__locals )
    ...
    /// public javax.swing.plaf.basic.BasicArrowButton(int)
    ...
    public convenience init( arg0: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/plaf/basic/BasicArrowButton", classCache: &BasicArrowButton.BasicArrowButtonJNIClass, methodSig: "(I)V", methodCache: &BasicArrowButton.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: Int, arg1: java_awt.Color?, arg2: java_awt.Color?, arg3: java_awt.Color?, arg4: java_awt.Color? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/plaf/basic/BasicArrowButton", classCache: &BasicArrowButton.BasicArrowButtonJNIClass, methodSig: "(ILjava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;)V", methodCache: &BasicArrowButton.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    open func getDirection() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDirection", methodSig: "()I", methodCache: &BasicArrowButton.getDirection_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }


    /// public void javax.swing.plaf.basic.BasicArrowButton.setDirection(int)
    ...
    open func setDirection( arg0: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDirection", methodSig: "(I)V", methodCache: &BasicArrowButton.setDirection_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var paintTriangle_MethodID_5: jmethodID?

    open func paintTriangle( arg0: java_awt.Graphics?, arg1: Int, arg2: Int, arg3: Int, arg4: Int, arg5: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTriangle", methodSig: "(Ljava/awt/Graphics;IIIIZ)V", methodCache: &BasicArrowButton.paintTriangle_MethodID_5, args: &__args, locals: &__locals )
    }

    open func paintTriangle( _ _arg0: java_awt.Graphics?, _ _arg1: Int, _ _arg2: Int, _ _arg3: Int, _ _arg4: Int, _ _arg5: Bool ) {
        paintTriangle( arg0: _arg0, arg1: _arg1, arg2: _arg2, arg3: _arg3, arg4: _arg4, arg5: _arg5 )
    }
