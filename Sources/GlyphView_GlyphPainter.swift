...
open class GlyphView_GlyphPainter: java_swift.JavaObject {
    ...
    open func getPainter( v: GlyphView?, p0: Int, p1: Int ) -> GlyphView_GlyphPainter! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPainter", methodSig: "(Ljavax/swing/text/GlyphView;II)Ljavax/swing/text/GlyphView$GlyphPainter;", methodCache: &GlyphView_GlyphPainter.getPainter_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func paint( v: GlyphView?, g: java_awt.Graphics?, a: java_awt.Shape?, p0: Int, p1: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljavax/swing/text/GlyphView;Ljava/awt/Graphics;Ljava/awt/Shape;II)V", methodCache: &GlyphView_GlyphPainter.paint_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var getBoundedPosition_MethodID_4: jmethodID?
    ...
    open func getBoundedPosition( v: GlyphView?, p0: Int, x: Float, len: Float ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getBoundedPosition", methodSig: "(Ljavax/swing/text/GlyphView;IFF)I", methodCache: &GlyphView_GlyphPainter.getBoundedPosition_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func viewToModel( v: GlyphView?, x: Float, y: Float, a: java_awt.Shape?, biasReturn: [Position_Bias]? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "viewToModel", methodSig: "(Ljavax/swing/text/GlyphView;FFLjava/awt/Shape;[Ljavax/swing/text/Position$Bias;)I", methodCache: &GlyphView_GlyphPainter.viewToModel_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func modelToView( v: GlyphView?, pos: Int, bias: Position_Bias?, a: java_awt.Shape? ) throws /* javax.swing.text.BadLocationException */ -> java_awt.Shape! {
        ...
        __args[3] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "modelToView", methodSig: "(Ljavax/swing/text/GlyphView;ILjavax/swing/text/Position$Bias;Ljava/awt/Shape;)Ljava/awt/Shape;", methodCache: &GlyphView_GlyphPainter.modelToView_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getHeight( v: GlyphView? ) -> Float {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getHeight", methodSig: "(Ljavax/swing/text/GlyphView;)F", methodCache: &GlyphView_GlyphPainter.getHeight_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func getAscent( v: GlyphView? ) -> Float {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getAscent", methodSig: "(Ljavax/swing/text/GlyphView;)F", methodCache: &GlyphView_GlyphPainter.getAscent_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    private static var getDescent_MethodID_10: jmethodID?

    open func getDescent( v: GlyphView? ) -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getDescent", methodSig: "(Ljavax/swing/text/GlyphView;)F", methodCache: &GlyphView_GlyphPainter.getDescent_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    open func getNextVisualPositionFrom( v: GlyphView?, pos: Int, b: Position_Bias?, a: java_awt.Shape?, direction: Int, biasRet: [Position_Bias]? ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getNextVisualPositionFrom", methodSig: "(Ljavax/swing/text/GlyphView;ILjavax/swing/text/Position$Bias;Ljava/awt/Shape;I[Ljavax/swing/text/Position$Bias;)I", methodCache: &GlyphView_GlyphPainter.getNextVisualPositionFrom_MethodID_11, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
