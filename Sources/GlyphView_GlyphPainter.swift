...
open class GlyphView_GlyphPainter: java_swift.JavaObject {
    ...
    open func getDescent( v: GlyphView? ) -> Float {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v != nil ? v! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getDescent", methodSig: "(Ljavax/swing/text/GlyphView;)F", methodCache: &GlyphView_GlyphPainter.getDescent_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    private static var getSpan_MethodID_4: jmethodID?
    ...
    open func getSpan( v: GlyphView?, p0: Int, p1: Int, e: TabExpander?, x: Float ) -> Float {
        ...
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getSpan", methodSig: "(Ljavax/swing/text/GlyphView;IILjavax/swing/text/TabExpander;F)F", methodCache: &GlyphView_GlyphPainter.getSpan_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    open func getPainter( v: GlyphView?, p0: Int, p1: Int ) -> GlyphView_GlyphPainter! {
        ...
        __args[1] = JNIType.toJava( value: p0, locals: &__locals )
        __args[2] = JNIType.toJava( value: p1, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPainter", methodSig: "(Ljavax/swing/text/GlyphView;II)Ljavax/swing/text/GlyphView$GlyphPainter;", methodCache: &GlyphView_GlyphPainter.getPainter_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func viewToModel( v: GlyphView?, x: Float, y: Float, a: java_awt.Shape?, biasReturn: [Position_Bias]? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "viewToModel", methodSig: "(Ljavax/swing/text/GlyphView;FFLjava/awt/Shape;[Ljavax/swing/text/Position$Bias;)I", methodCache: &GlyphView_GlyphPainter.viewToModel_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func modelToView( v: GlyphView?, pos: Int, bias: Position_Bias?, a: java_awt.Shape? ) throws /* javax.swing.text.BadLocationException */ -> java_awt.Shape! {
        ...
        __args[3] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "modelToView", methodSig: "(Ljavax/swing/text/GlyphView;ILjavax/swing/text/Position$Bias;Ljava/awt/Shape;)Ljava/awt/Shape;", methodCache: &GlyphView_GlyphPainter.modelToView_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
    ...
    open func getHeight( v: GlyphView? ) -> Float {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v != nil ? v! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getHeight", methodSig: "(Ljavax/swing/text/GlyphView;)F", methodCache: &GlyphView_GlyphPainter.getHeight_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
