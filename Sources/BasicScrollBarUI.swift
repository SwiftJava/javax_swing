...
open class BasicScrollBarUI: ScrollBarUI, java_awt.LayoutManager, SwingConstants {
    ...
    private static var paintTrack_MethodID_25: jmethodID?
    ...
    open func paintTrack( g: java_awt.Graphics?, c: JComponent?, trackBounds: java_awt.Rectangle? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintTrack", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;Ljava/awt/Rectangle;)V", methodCache: &BasicScrollBarUI.paintTrack_MethodID_25, args: &__args, locals: &__locals )
    }
    ...
    open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &BasicScrollBarUI.installDefaults_MethodID_26, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.installComponents()

    private static var installComponents_MethodID_27: jmethodID?

    open func installComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installComponents", methodSig: "()V", methodCache: &BasicScrollBarUI.installComponents_MethodID_27, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.installListeners()

    private static var installListeners_MethodID_28: jmethodID?

    open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicScrollBarUI.installListeners_MethodID_28, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.installKeyboardActions()

    private static var installKeyboardActions_MethodID_29: jmethodID?

    open func installKeyboardActions() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installKeyboardActions", methodSig: "()V", methodCache: &BasicScrollBarUI.installKeyboardActions_MethodID_29, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.uninstallDefaults()

    private static var uninstallDefaults_MethodID_30: jmethodID?

    open func uninstallDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "()V", methodCache: &BasicScrollBarUI.uninstallDefaults_MethodID_30, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.uninstallComponents()

    private static var uninstallComponents_MethodID_31: jmethodID?

    open func uninstallComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallComponents", methodSig: "()V", methodCache: &BasicScrollBarUI.uninstallComponents_MethodID_31, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.uninstallListeners()

    private static var uninstallListeners_MethodID_32: jmethodID?

    open func uninstallListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &BasicScrollBarUI.uninstallListeners_MethodID_32, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicScrollBarUI.uninstallKeyboardActions()

    private static var uninstallKeyboardActions_MethodID_33: jmethodID?

    open func uninstallKeyboardActions() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallKeyboardActions", methodSig: "()V", methodCache: &BasicScrollBarUI.uninstallKeyboardActions_MethodID_33, args: &__args, locals: &__locals )
    }


    /// protected java.beans.PropertyChangeListener javax.swing.plaf.basic.BasicScrollBarUI.createPropertyChangeListener()

    private static var createPropertyChangeListener_MethodID_34: jmethodID?

    open func createPropertyChangeListener() -> /* java.beans.PropertyChangeListener */ UnclassedProtocol! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPropertyChangeListener", methodSig: "()Ljava/beans/PropertyChangeListener;", methodCache: &BasicScrollBarUI.createPropertyChangeListener_MethodID_34, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
