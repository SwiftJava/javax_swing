...
open class ColorSelectionModelForward: JNIObjectForward, ColorSelectionModel {
    ...
    open func getSelectedColor() -> java_awt.Color! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectedColor", methodSig: "()Ljava/awt/Color;", methodCache: &ColorSelectionModelForward.getSelectedColor_MethodID_6, args: &__args, locals: &__locals )
    ...
    open func removeChangeListener( listener: ChangeListener? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &ColorSelectionModelForward.removeChangeListener_MethodID_7, args: &__args, locals: &__locals )
    }
