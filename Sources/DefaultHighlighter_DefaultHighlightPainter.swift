...
open class DefaultHighlighter_DefaultHighlightPainter: LayeredHighlighter_LayerPainter {
    ...
    open func paint( g: java_awt.Graphics?, offs0: Int, offs1: Int, bounds: java_awt.Shape?, c: JTextComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;IILjava/awt/Shape;Ljavax/swing/text/JTextComponent;)V", methodCache: &DefaultHighlighter_DefaultHighlightPainter.paint_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func getColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColor", methodSig: "()Ljava/awt/Color;", methodCache: &DefaultHighlighter_DefaultHighlightPainter.getColor_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
