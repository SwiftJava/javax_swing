...
open class DefaultHighlighter_DefaultHighlightPainter: LayeredHighlighter_LayerPainter {
    ...
    private static var getColor_MethodID_3: jmethodID?

    open func getColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColor", methodSig: "()Ljava/awt/Color;", methodCache: &DefaultHighlighter_DefaultHighlightPainter.getColor_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func paint( g: java_awt.Graphics?, offs0: Int, offs1: Int, bounds: java_awt.Shape?, c: JTextComponent? ) {
        ...
        __args[3] = JNIType.toJava( value: bounds, locals: &__locals )
        __args[4] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;IILjava/awt/Shape;Ljavax/swing/text/JTextComponent;)V", methodCache: &DefaultHighlighter_DefaultHighlightPainter.paint_MethodID_4, args: &__args, locals: &__locals )
    }
