...
open class BasicSplitPaneUI_BasicHorizontalLayoutManager: java_swift.JavaObject, java_awt.LayoutManager2 {
    ...
    open func addLayoutComponent( name: String?, comp: java_awt.Component? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addLayoutComponent", methodSig: "(Ljava/lang/String;Ljava/awt/Component;)V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.addLayoutComponent_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var resetToPreferredSizes_MethodID_11: jmethodID?

    open func resetToPreferredSizes() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "resetToPreferredSizes", methodSig: "()V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.resetToPreferredSizes_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var setSizes_MethodID_13: jmethodID?

    open func setSizes( newSizes: [Int32]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: newSizes, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSizes", methodSig: "([I)V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.setSizes_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var updateComponents_MethodID_14: jmethodID?

    open func updateComponents() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateComponents", methodSig: "()V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.updateComponents_MethodID_14, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicSplitPaneUI$BasicHorizontalLayoutManager.resetSizeAt(int)

    private static var resetSizeAt_MethodID_15: jmethodID?

    open func resetSizeAt( index: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: index, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "resetSizeAt", methodSig: "(I)V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.resetSizeAt_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var getPreferredSizeOfComponent_MethodID_16: jmethodID?

    open func getPreferredSizeOfComponent( c: java_awt.Component? ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getPreferredSizeOfComponent", methodSig: "(Ljava/awt/Component;)I", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.getPreferredSizeOfComponent_MethodID_16, args: &__args, locals: &__locals )
    ...
    private static var getSizeOfComponent_MethodID_17: jmethodID?

    open func getSizeOfComponent( c: java_awt.Component? ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSizeOfComponent", methodSig: "(Ljava/awt/Component;)I", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.getSizeOfComponent_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getAvailableSize_MethodID_18: jmethodID?
    ...
    open func getAvailableSize( containerSize: java_awt.Dimension?, insets: java_awt.Insets? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAvailableSize", methodSig: "(Ljava/awt/Dimension;Ljava/awt/Insets;)I", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.getAvailableSize_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getInitialLocation_MethodID_19: jmethodID?
    ...
    open func getInitialLocation( insets: java_awt.Insets? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getInitialLocation", methodSig: "(Ljava/awt/Insets;)I", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.getInitialLocation_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var setComponentToSize_MethodID_20: jmethodID?
    ...
    open func setComponentToSize( c: java_awt.Component?, size: Int, location: Int, insets: java_awt.Insets?, containerSize: java_awt.Dimension? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setComponentToSize", methodSig: "(Ljava/awt/Component;IILjava/awt/Insets;Ljava/awt/Dimension;)V", methodCache: &BasicSplitPaneUI_BasicHorizontalLayoutManager.setComponentToSize_MethodID_20, args: &__args, locals: &__locals )
    }
