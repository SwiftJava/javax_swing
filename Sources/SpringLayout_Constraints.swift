...
open class SpringLayout_Constraints: java_swift.JavaObject {
    ...
    open func getHeight() -> Spring! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getHeight", methodSig: "()Ljavax/swing/Spring;", methodCache: &SpringLayout_Constraints.getHeight_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Spring( javaObject: __return ) : nil
    }
    ...
    open func getX() -> Spring! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getX", methodSig: "()Ljavax/swing/Spring;", methodCache: &SpringLayout_Constraints.getX_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Spring( javaObject: __return ) : nil
    }
    ...
    open func getY() -> Spring! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getY", methodSig: "()Ljavax/swing/Spring;", methodCache: &SpringLayout_Constraints.getY_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Spring( javaObject: __return ) : nil
    }
    ...
    private static var setHeight_MethodID_11: jmethodID?

    open func setHeight( height: Spring? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: height, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setHeight", methodSig: "(Ljavax/swing/Spring;)V", methodCache: &SpringLayout_Constraints.setHeight_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var setX_MethodID_13: jmethodID?

    open func setX( x: Spring? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setX", methodSig: "(Ljavax/swing/Spring;)V", methodCache: &SpringLayout_Constraints.setX_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var setY_MethodID_14: jmethodID?

    open func setY( y: Spring? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: y, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setY", methodSig: "(Ljavax/swing/Spring;)V", methodCache: &SpringLayout_Constraints.setY_MethodID_14, args: &__args, locals: &__locals )
    }
