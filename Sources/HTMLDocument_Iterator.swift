...
open class HTMLDocument_Iterator: java_swift.JavaObject {
    ...
    private static var getAttributes_MethodID_2: jmethodID?

    open func getAttributes() -> AttributeSet! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAttributes", methodSig: "()Ljavax/swing/text/AttributeSet;", methodCache: &HTMLDocument_Iterator.getAttributes_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getEndOffset_MethodID_3: jmethodID?

    open func getEndOffset() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getEndOffset", methodSig: "()I", methodCache: &HTMLDocument_Iterator.getEndOffset_MethodID_3, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getStartOffset_MethodID_4: jmethodID?

    open func getStartOffset() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getStartOffset", methodSig: "()I", methodCache: &HTMLDocument_Iterator.getStartOffset_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func isValid() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isValid", methodSig: "()Z", methodCache: &HTMLDocument_Iterator.isValid_MethodID_6, args: &__args, locals: &__locals )
    ...
    open func next() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "next", methodSig: "()V", methodCache: &HTMLDocument_Iterator.next_MethodID_7, args: &__args, locals: &__locals )
    }
