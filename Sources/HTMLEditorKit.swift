...
open class HTMLEditorKit: StyledEditorKit {
    ...
    private static var getParser_MethodID_2: jmethodID?

    open func getParser() -> HTMLEditorKit_Parser! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParser", methodSig: "()Ljavax/swing/text/html/HTMLEditorKit$Parser;", methodCache: &HTMLEditorKit.getParser_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func insertHTML( doc: HTMLDocument?, offset: Int, html: String?, popDepth: Int, pushDepth: Int, insertTag: HTML_Tag? ) throws /* javax.swing.text.BadLocationException, java.io.IOException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertHTML", methodSig: "(Ljavax/swing/text/html/HTMLDocument;ILjava/lang/String;IILjavax/swing/text/html/HTML$Tag;)V", methodCache: &HTMLEditorKit.insertHTML_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var isAutoFormSubmission_MethodID_4: jmethodID?

    open func isAutoFormSubmission() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAutoFormSubmission", methodSig: "()Z", methodCache: &HTMLEditorKit.isAutoFormSubmission_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var setStyleSheet_MethodID_5: jmethodID?

    open func setStyleSheet( s: StyleSheet? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: s, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setStyleSheet", methodSig: "(Ljavax/swing/text/html/StyleSheet;)V", methodCache: &HTMLEditorKit.setStyleSheet_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var setDefaultCursor_MethodID_6: jmethodID?

    open func setDefaultCursor( cursor: java_awt.Cursor? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: cursor, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDefaultCursor", methodSig: "(Ljava/awt/Cursor;)V", methodCache: &HTMLEditorKit.setDefaultCursor_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var setLinkCursor_MethodID_7: jmethodID?

    open func setLinkCursor( cursor: java_awt.Cursor? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: cursor, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLinkCursor", methodSig: "(Ljava/awt/Cursor;)V", methodCache: &HTMLEditorKit.setLinkCursor_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var getLinkCursor_MethodID_8: jmethodID?

    open func getLinkCursor() -> java_awt.Cursor! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLinkCursor", methodSig: "()Ljava/awt/Cursor;", methodCache: &HTMLEditorKit.getLinkCursor_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createInputAttributes_MethodID_10: jmethodID?
    ...
    override open func createInputAttributes( element: Element?, set: MutableAttributeSet? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "createInputAttributes", methodSig: "(Ljavax/swing/text/Element;Ljavax/swing/text/MutableAttributeSet;)V", methodCache: &HTMLEditorKit.createInputAttributes_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func getAccessibleContext() -> /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAccessibleContext", methodSig: "()Ljavax/accessibility/AccessibleContext;", methodCache: &HTMLEditorKit.getAccessibleContext_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getStyleSheet_MethodID_12: jmethodID?

    open func getStyleSheet() -> StyleSheet! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getStyleSheet", methodSig: "()Ljavax/swing/text/html/StyleSheet;", methodCache: &HTMLEditorKit.getStyleSheet_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
