...
open class StyledEditorKit_FontFamilyAction: StyledEditorKit_StyledTextAction {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.text.StyledEditorKit$FontFamilyAction", file, line ) {
            return nil
        }
    ...
    private static var StyledEditorKit_FontFamilyActionJNIClass: jclass?

    /// private java.lang.String javax.swing.text.StyledEditorKit$FontFamilyAction.family
    ...
    override open var enabled: Bool {
        get {
            ...
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &StyledEditorKit_FontFamilyAction.enabled_FieldID, object: javaObject, locals: &__locals )
            return JNIType.decode( type: Bool(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &StyledEditorKit_FontFamilyAction.enabled_FieldID, object: javaObject, value: __value.z, locals: &__locals )
        }
    }
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &StyledEditorKit_FontFamilyAction.changeSupport_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? SwingPropertyChangeSupport( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &StyledEditorKit_FontFamilyAction.changeSupport_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    public convenience init( arg0: String?, arg1: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/text/StyledEditorKit$FontFamilyAction", classCache: &StyledEditorKit_FontFamilyAction.StyledEditorKit_FontFamilyActionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;)V", methodCache: &StyledEditorKit_FontFamilyAction.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    /// public void javax.swing.text.StyledEditorKit$FontFamilyAction.actionPerformed(java.awt.event.ActionEvent)
