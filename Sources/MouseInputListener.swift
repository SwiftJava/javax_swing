...
private typealias MouseInputListener_mousePressed_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mousePressed_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias MouseInputListener_mouseReleased_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mouseReleased_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias MouseInputListener_mouseClicked_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mouseClicked_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias MouseInputListener_mouseEntered_4_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mouseEntered_4( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias MouseInputListener_mouseMoved_5_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mouseMoved_5( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias MouseInputListener_mouseDragged_6_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func MouseInputListener_mouseDragged_6( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ e: jobject? ) -> () {
    JNI.inNative = true;
...
fileprivate class MouseInputListenerLocal_: JNILocalProxy<MouseInputListener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        natives.append( JNINativeMethod( name: strdup("__mousePressed"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mousePressed_0_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let MouseInputListener_mouseReleased_1_thunk: MouseInputListener_mouseReleased_1_type = MouseInputListener_mouseReleased_1
        natives.append( JNINativeMethod( name: strdup("__mouseReleased"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mouseReleased_1_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let MouseInputListener_mouseClicked_2_thunk: MouseInputListener_mouseClicked_2_type = MouseInputListener_mouseClicked_2
        natives.append( JNINativeMethod( name: strdup("__mouseClicked"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mouseClicked_2_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__mouseEntered"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mouseEntered_4_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let MouseInputListener_mouseMoved_5_thunk: MouseInputListener_mouseMoved_5_type = MouseInputListener_mouseMoved_5
        natives.append( JNINativeMethod( name: strdup("__mouseMoved"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mouseMoved_5_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let MouseInputListener_mouseDragged_6_thunk: MouseInputListener_mouseDragged_6_type = MouseInputListener_mouseDragged_6
        natives.append( JNINativeMethod( name: strdup("__mouseDragged"), signature: strdup("(JLjava/awt/event/MouseEvent;)V"), fnPtr: unsafeBitCast( MouseInputListener_mouseDragged_6_thunk, to: UnsafeMutableRawPointer.self ) ) )
