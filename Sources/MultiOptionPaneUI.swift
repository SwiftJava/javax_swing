...
open class MultiOptionPaneUI: OptionPaneUI {
    ...
    open func update( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiOptionPaneUI.update_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func getPreferredSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiOptionPaneUI.getPreferredSize_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getMinimumSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiOptionPaneUI.getMinimumSize_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    open func getMaximumSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMaximumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiOptionPaneUI.getMaximumSize_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    open class func createUI( a: JComponent? ) -> ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/multi/MultiOptionPaneUI", classCache: &MultiOptionPaneUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getAccessibleChildrenCount( a: JComponent? ) -> Int {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAccessibleChildrenCount", methodSig: "(Ljavax/swing/JComponent;)I", methodCache: &MultiOptionPaneUI.getAccessibleChildrenCount_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func getAccessibleChild( a: JComponent?, b: Int ) -> /* javax.accessibility.Accessible */ UnclassedProtocol! {
        ...
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAccessibleChild", methodSig: "(Ljavax/swing/JComponent;I)Ljavax/accessibility/Accessible;", methodCache: &MultiOptionPaneUI.getAccessibleChild_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var selectInitialValue_MethodID_10: jmethodID?

    open func selectInitialValue( a: JOptionPane? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectInitialValue", methodSig: "(Ljavax/swing/JOptionPane;)V", methodCache: &MultiOptionPaneUI.selectInitialValue_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var containsCustomComponents_MethodID_11: jmethodID?

    open func containsCustomComponents( a: JOptionPane? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "containsCustomComponents", methodSig: "(Ljavax/swing/JOptionPane;)Z", methodCache: &MultiOptionPaneUI.containsCustomComponents_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func installUI( a: JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &MultiOptionPaneUI.installUI_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallUI( a: JComponent? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &MultiOptionPaneUI.uninstallUI_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func getUIs() -> [ComponentUI]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUIs", methodSig: "()[Ljavax/swing/plaf/ComponentUI;", methodCache: &MultiOptionPaneUI.getUIs_MethodID_14, args: &__args, locals: &__locals )
    ...
    open func paint( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: a != nil ? a! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: b != nil ? b! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiOptionPaneUI.paint_MethodID_15, args: &__args, locals: &__locals )
    }
