...
open class BasicComboBoxEditor: java_swift.JavaObject, ComboBoxEditor, java_awt.FocusListener {
    ...
    open var editor: JTextField! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "editor", fieldType: "Ljavax/swing/JTextField;", fieldCache: &BasicComboBoxEditor.editor_FieldID, object: javaObject )
    ...
    private static var createEditorComponent_MethodID_3: jmethodID?

    open func createEditorComponent() -> JTextField! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createEditorComponent", methodSig: "()Ljavax/swing/JTextField;", methodCache: &BasicComboBoxEditor.createEditorComponent_MethodID_3, args: &__args, locals: &__locals )
    ...
    open func focusGained( e: java_awt.FocusEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "focusGained", methodSig: "(Ljava/awt/event/FocusEvent;)V", methodCache: &BasicComboBoxEditor.focusGained_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func focusLost( e: java_awt.FocusEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "focusLost", methodSig: "(Ljava/awt/event/FocusEvent;)V", methodCache: &BasicComboBoxEditor.focusLost_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func selectAll() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectAll", methodSig: "()V", methodCache: &BasicComboBoxEditor.selectAll_MethodID_9, args: &__args, locals: &__locals )
    }
