...
open class FocusManager: java_awt.DefaultKeyboardFocusManager {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.FocusManager", file, line ) {
            return nil
        }
    ...
    open class func setCurrentManager( arg0: FocusManager? ) throws /* java.lang.SecurityException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    open class func setCurrentManager( _ _arg0: FocusManager? ) throws /* java.lang.SecurityException */ {
        try setCurrentManager( arg0: _arg0 )
    }
