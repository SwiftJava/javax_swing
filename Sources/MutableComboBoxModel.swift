...
open class MutableComboBoxModelForward: ComboBoxModelForward, MutableComboBoxModel {
    ...
    override open func addListDataListener( l: ListDataListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addListDataListener", methodSig: "(Ljavax/swing/event/ListDataListener;)V", methodCache: &MutableComboBoxModelForward.addListDataListener_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var getElementAt_MethodID_7: jmethodID?

    override open func getElementAt( index: Int ) -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(index) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getElementAt", methodSig: "(I)Ljava/lang/Object;", methodCache: &MutableComboBoxModelForward.getElementAt_MethodID_7, args: &__args, locals: &__locals )
    ...
    override open func getSelectedItem() -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectedItem", methodSig: "()Ljava/lang/Object;", methodCache: &MutableComboBoxModelForward.getSelectedItem_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    private static var getSize_MethodID_9: jmethodID?

    override open func getSize() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSize", methodSig: "()I", methodCache: &MutableComboBoxModelForward.getSize_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var insertElementAt_MethodID_10: jmethodID?
    ...
    open func insertElementAt( item: java_swift.JavaObject?, index: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertElementAt", methodSig: "(Ljava/lang/Object;I)V", methodCache: &MutableComboBoxModelForward.insertElementAt_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var removeElement_MethodID_11: jmethodID?

    open func removeElement( obj: java_swift.JavaObject? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: obj, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeElement", methodSig: "(Ljava/lang/Object;)V", methodCache: &MutableComboBoxModelForward.removeElement_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var removeElementAt_MethodID_12: jmethodID?

    open func removeElementAt( index: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(index) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeElementAt", methodSig: "(I)V", methodCache: &MutableComboBoxModelForward.removeElementAt_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var removeListDataListener_MethodID_13: jmethodID?

    override open func removeListDataListener( l: ListDataListener? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeListDataListener", methodSig: "(Ljavax/swing/event/ListDataListener;)V", methodCache: &MutableComboBoxModelForward.removeListDataListener_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var setSelectedItem_MethodID_14: jmethodID?

    override open func setSelectedItem( anItem: java_swift.JavaObject? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: anItem, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectedItem", methodSig: "(Ljava/lang/Object;)V", methodCache: &MutableComboBoxModelForward.setSelectedItem_MethodID_14, args: &__args, locals: &__locals )
    }
