...
open class DTD: java_swift.JavaObject, DTDConstants {
    ...
    public static var FILE_VERSION: Int {
        get {
    ...
    open var applet: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "applet", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.applet_FieldID, object: javaObject )
    ...
    open var base: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "base", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.base_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var body: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "body", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.body_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var elementHash: java_util.Hashtable! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "elementHash", fieldType: "Ljava/util/Hashtable;", fieldCache: &DTD.elementHash_FieldID, object: javaObject )
    ...
    open var elements: java_util.Vector! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "elements", fieldType: "Ljava/util/Vector;", fieldCache: &DTD.elements_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var entityHash: java_util.Hashtable! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "entityHash", fieldType: "Ljava/util/Hashtable;", fieldCache: &DTD.entityHash_FieldID, object: javaObject )
            return JNIType.toSwift( type: java_util.Hashtable.self, from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var head: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "head", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.head_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var html: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "html", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.html_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var isindex: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "isindex", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.isindex_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var meta: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "meta", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.meta_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var name: String! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "name", fieldType: "Ljava/lang/String;", fieldCache: &DTD.name_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var p: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "p", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.p_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var param: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "param", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.param_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var pcdata: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "pcdata", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.pcdata_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    open var title: text_html_parser_Element! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "title", fieldType: "Ljavax/swing/text/html/parser/Element;", fieldCache: &DTD.title_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? text_html_parser_Element( javaObject: __value ) : nil
        }
    }
    ...
    private static var getDTD_MethodID_2: jmethodID?

    open class func getDTD( name: String? ) throws /* java.io.IOException */ -> DTD! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/text/html/parser/DTD", classCache: &DTDJNIClass, methodName: "getDTD", methodSig: "(Ljava/lang/String;)Ljavax/swing/text/html/parser/DTD;", methodCache: &getDTD_MethodID_2, args: &__args, locals: &__locals )
    ...
    open class func getDTD( _ _name: String? ) throws /* java.io.IOException */ -> DTD! {
        return try getDTD( name: _name )
    }
    ...
    private static var putDTDHash_MethodID_3: jmethodID?

    open class func putDTDHash( name: String?, dtd: DTD? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        __args[1] = JNIType.toJava( value: dtd, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "javax/swing/text/html/parser/DTD", classCache: &DTDJNIClass, methodName: "putDTDHash", methodSig: "(Ljava/lang/String;Ljavax/swing/text/html/parser/DTD;)V", methodCache: &putDTDHash_MethodID_3, args: &__args, locals: &__locals )
    }

    open class func putDTDHash( _ _name: String?, _ _dtd: DTD? ) {
        putDTDHash( name: _name, dtd: _dtd )
    }
    ...
    private static var defAttributeList_MethodID_4: jmethodID?
    ...
    open func defAttributeList( name: String?, type: Int, modifier: Int, value: String?, values: String?, atts: AttributeList? ) -> AttributeList! {
        ...
        __args[5] = JNIType.toJava( value: atts, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defAttributeList", methodSig: "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljavax/swing/text/html/parser/AttributeList;)Ljavax/swing/text/html/parser/AttributeList;", methodCache: &DTD.defAttributeList_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? AttributeList( javaObject: __return ) : nil
    }

    open func defAttributeList( _ _name: String?, _ _type: Int, _ _modifier: Int, _ _value: String?, _ _values: String?, _ _atts: AttributeList? ) -> AttributeList! {
        return defAttributeList( name: _name, type: _type, modifier: _modifier, value: _value, values: _values, atts: _atts )
    }
    ...
    private static var defContentModel_MethodID_5: jmethodID?
    ...
    open func defContentModel( type: Int, obj: java_swift.JavaObject?, next: ContentModel? ) -> ContentModel! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defContentModel", methodSig: "(ILjava/lang/Object;Ljavax/swing/text/html/parser/ContentModel;)Ljavax/swing/text/html/parser/ContentModel;", methodCache: &DTD.defContentModel_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? ContentModel( javaObject: __return ) : nil
    }

    open func defContentModel( _ _type: Int, _ _obj: java_swift.JavaObject?, _ _next: ContentModel? ) -> ContentModel! {
        return defContentModel( type: _type, obj: _obj, next: _next )
    }
    ...
    private static var defElement_MethodID_6: jmethodID?
    ...
    open func defElement( name: String?, type: Int, omitStart: Bool, omitEnd: Bool, content: ContentModel?, exclusions: [String]?, inclusions: [String]?, atts: AttributeList? ) -> text_html_parser_Element! {
        ...
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        __args[1] = jvalue( i: jint(type) )
        __args[2] = jvalue( z: jboolean(omitStart ? JNI_TRUE : JNI_FALSE) )
        __args[3] = jvalue( z: jboolean(omitEnd ? JNI_TRUE : JNI_FALSE) )
        __args[4] = JNIType.toJava( value: content, locals: &__locals )
        __args[5] = JNIType.toJava( value: exclusions, locals: &__locals )
        __args[6] = JNIType.toJava( value: inclusions, locals: &__locals )
        __args[7] = JNIType.toJava( value: atts, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defElement", methodSig: "(Ljava/lang/String;IZZLjavax/swing/text/html/parser/ContentModel;[Ljava/lang/String;[Ljava/lang/String;Ljavax/swing/text/html/parser/AttributeList;)Ljavax/swing/text/html/parser/Element;", methodCache: &DTD.defElement_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? text_html_parser_Element( javaObject: __return ) : nil
    }

    open func defElement( _ _name: String?, _ _type: Int, _ _omitStart: Bool, _ _omitEnd: Bool, _ _content: ContentModel?, _ _exclusions: [String]?, _ _inclusions: [String]?, _ _atts: AttributeList? ) -> text_html_parser_Element! {
        return defElement( name: _name, type: _type, omitStart: _omitStart, omitEnd: _omitEnd, content: _content, exclusions: _exclusions, inclusions: _inclusions, atts: _atts )
    }

    /// public javax.swing.text.html.parser.Entity javax.swing.text.html.parser.DTD.defEntity(java.lang.String,int,int)

    private static var defEntity_MethodID_7: jmethodID?
    ...
    open func defEntity( name: String?, type: Int, ch: Int ) -> Entity! {
        ...
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        __args[1] = jvalue( i: jint(type) )
        __args[2] = jvalue( i: jint(ch) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defEntity", methodSig: "(Ljava/lang/String;II)Ljavax/swing/text/html/parser/Entity;", methodCache: &DTD.defEntity_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Entity( javaObject: __return ) : nil
    }

    open func defEntity( _ _name: String?, _ _type: Int, _ _ch: Int ) -> Entity! {
    ...
    private static var defEntity_MethodID_8: jmethodID?
    ...
    open func defEntity( name: String?, type: Int, str: String? ) -> Entity! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defEntity", methodSig: "(Ljava/lang/String;ILjava/lang/String;)Ljavax/swing/text/html/parser/Entity;", methodCache: &DTD.defEntity_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Entity( javaObject: __return ) : nil
    }
    ...
    private static var defineAttributes_MethodID_9: jmethodID?

    open func defineAttributes( name: String?, atts: AttributeList? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        __args[1] = JNIType.toJava( value: atts, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "defineAttributes", methodSig: "(Ljava/lang/String;Ljavax/swing/text/html/parser/AttributeList;)V", methodCache: &DTD.defineAttributes_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var defineElement_MethodID_10: jmethodID?
    ...
    open func defineElement( name: String?, type: Int, omitStart: Bool, omitEnd: Bool, content: ContentModel?, exclusions: java_util.BitSet?, inclusions: java_util.BitSet?, atts: AttributeList? ) -> text_html_parser_Element! {
        ...
        __args[6] = JNIType.toJava( value: inclusions, locals: &__locals )
        __args[7] = JNIType.toJava( value: atts, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defineElement", methodSig: "(Ljava/lang/String;IZZLjavax/swing/text/html/parser/ContentModel;Ljava/util/BitSet;Ljava/util/BitSet;Ljavax/swing/text/html/parser/AttributeList;)Ljavax/swing/text/html/parser/Element;", methodCache: &DTD.defineElement_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? text_html_parser_Element( javaObject: __return ) : nil
    }

    open func defineElement( _ _name: String?, _ _type: Int, _ _omitStart: Bool, _ _omitEnd: Bool, _ _content: ContentModel?, _ _exclusions: java_util.BitSet?, _ _inclusions: java_util.BitSet?, _ _atts: AttributeList? ) -> text_html_parser_Element! {
        return defineElement( name: _name, type: _type, omitStart: _omitStart, omitEnd: _omitEnd, content: _content, exclusions: _exclusions, inclusions: _inclusions, atts: _atts )
    }

    /// public javax.swing.text.html.parser.Entity javax.swing.text.html.parser.DTD.defineEntity(java.lang.String,int,char[])

    private static var defineEntity_MethodID_11: jmethodID?
    ...
    open func defineEntity( name: String?, type: Int, data: [UInt16]? ) -> Entity! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "defineEntity", methodSig: "(Ljava/lang/String;I[C)Ljavax/swing/text/html/parser/Entity;", methodCache: &DTD.defineEntity_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Entity( javaObject: __return ) : nil
    }

    open func defineEntity( _ _name: String?, _ _type: Int, _ _data: [UInt16]? ) -> Entity! {
        return defineEntity( name: _name, type: _type, data: _data )
    }
    ...
    open func getElement( index: Int ) -> text_html_parser_Element! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getElement", methodSig: "(I)Ljavax/swing/text/html/parser/Element;", methodCache: &DTD.getElement_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? text_html_parser_Element( javaObject: __return ) : nil
    }
    ...
    private static var getElement_MethodID_13: jmethodID?

    open func getElement( name: String? ) -> text_html_parser_Element! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getElement", methodSig: "(Ljava/lang/String;)Ljavax/swing/text/html/parser/Element;", methodCache: &DTD.getElement_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? text_html_parser_Element( javaObject: __return ) : nil
    }
    ...
    private static var getEntity_MethodID_14: jmethodID?

    open func getEntity( ch: Int ) -> Entity! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(ch) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getEntity", methodSig: "(I)Ljavax/swing/text/html/parser/Entity;", methodCache: &DTD.getEntity_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Entity( javaObject: __return ) : nil
    }

    open func getEntity( _ _ch: Int ) -> Entity! {
        return getEntity( ch: _ch )
    }

    /// public javax.swing.text.html.parser.Entity javax.swing.text.html.parser.DTD.getEntity(java.lang.String)

    private static var getEntity_MethodID_15: jmethodID?

    open func getEntity( name: String? ) -> Entity! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getEntity", methodSig: "(Ljava/lang/String;)Ljavax/swing/text/html/parser/Entity;", methodCache: &DTD.getEntity_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Entity( javaObject: __return ) : nil
    }

    open func getEntity( _ _name: String? ) -> Entity! {
        return getEntity( name: _name )
    }
    ...
    open func getName() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getName", methodSig: "()Ljava/lang/String;", methodCache: &DTD.getName_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var read_MethodID_17: jmethodID?

    open func read( _in: /* class java.io.DataInputStream */ UnavailableObject? ) throws /* java.io.IOException */ {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: _in, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "read", methodSig: "(Ljava/io/DataInputStream;)V", methodCache: &DTD.read_MethodID_17, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw /* class java.io.IOException */ UnavailableObject( javaObject: throwable )
        }
    ...
    open func read( _ __in: /* class java.io.DataInputStream */ UnavailableObject? ) throws /* java.io.IOException */ {
        try read( _in: __in )
    }
