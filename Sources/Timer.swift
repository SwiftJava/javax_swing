...
open class Timer: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var setRepeats_MethodID_4: jmethodID?

    open func setRepeats( flag: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: flag, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setRepeats", methodSig: "(Z)V", methodCache: &Timer.setRepeats_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var setLogTimers_MethodID_5: jmethodID?

    open class func setLogTimers( flag: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: flag, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "javax/swing/Timer", classCache: &TimerJNIClass, methodName: "setLogTimers", methodSig: "(Z)V", methodCache: &setLogTimers_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var getLogTimers_MethodID_6: jmethodID?

    open class func getLogTimers() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticBooleanMethod( className: "javax/swing/Timer", classCache: &TimerJNIClass, methodName: "getLogTimers", methodSig: "()Z", methodCache: &getLogTimers_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var setInitialDelay_MethodID_7: jmethodID?

    open func setInitialDelay( initialDelay: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: initialDelay, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setInitialDelay", methodSig: "(I)V", methodCache: &Timer.setInitialDelay_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var getInitialDelay_MethodID_8: jmethodID?

    open func getInitialDelay() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getInitialDelay", methodSig: "()I", methodCache: &Timer.getInitialDelay_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var isRepeats_MethodID_9: jmethodID?

    open func isRepeats() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isRepeats", methodSig: "()Z", methodCache: &Timer.isRepeats_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var setCoalesce_MethodID_10: jmethodID?

    open func setCoalesce( flag: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: flag, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCoalesce", methodSig: "(Z)V", methodCache: &Timer.setCoalesce_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func fireActionPerformed( e: java_awt.ActionEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireActionPerformed", methodSig: "(Ljava/awt/event/ActionEvent;)V", methodCache: &Timer.fireActionPerformed_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func setActionCommand( command: String? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setActionCommand", methodSig: "(Ljava/lang/String;)V", methodCache: &Timer.setActionCommand_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func addActionListener( listener: java_awt.ActionListener? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addActionListener", methodSig: "(Ljava/awt/event/ActionListener;)V", methodCache: &Timer.addActionListener_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var setDelay_MethodID_15: jmethodID?

    open func setDelay( delay: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: delay, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDelay", methodSig: "(I)V", methodCache: &Timer.setDelay_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var getDelay_MethodID_16: jmethodID?

    open func getDelay() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDelay", methodSig: "()I", methodCache: &Timer.getDelay_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var restart_MethodID_17: jmethodID?

    open func restart() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "restart", methodSig: "()V", methodCache: &Timer.restart_MethodID_17, args: &__args, locals: &__locals )
    }


    /// public java.lang.String javax.swing.Timer.getActionCommand()

    private static var getActionCommand_MethodID_18: jmethodID?

    open func getActionCommand() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getActionCommand", methodSig: "()Ljava/lang/String;", methodCache: &Timer.getActionCommand_MethodID_18, args: &__args, locals: &__locals )
    ...
    open func getListeners( listenerType: java_swift.JavaClass? ) -> [EventListener]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getListeners", methodSig: "(Ljava/lang/Class;)[Ljava/util/EventListener;", methodCache: &Timer.getListeners_MethodID_19, args: &__args, locals: &__locals )
    ...
    private static var isRunning_MethodID_20: jmethodID?

    open func isRunning() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isRunning", methodSig: "()Z", methodCache: &Timer.isRunning_MethodID_20, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func removeActionListener( listener: java_awt.ActionListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeActionListener", methodSig: "(Ljava/awt/event/ActionListener;)V", methodCache: &Timer.removeActionListener_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    open func getActionListeners() -> [ActionListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getActionListeners", methodSig: "()[Ljava/awt/event/ActionListener;", methodCache: &Timer.getActionListeners_MethodID_22, args: &__args, locals: &__locals )
