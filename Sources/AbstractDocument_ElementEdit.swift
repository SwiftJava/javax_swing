...
open class AbstractDocument_ElementEdit: AbstractUndoableEdit, DocumentEvent_ElementChange {
    ...
    private static var getChildrenAdded_MethodID_2: jmethodID?

    open func getChildrenAdded() -> [Element]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChildrenAdded", methodSig: "()[Ljavax/swing/text/Element;", methodCache: &AbstractDocument_ElementEdit.getChildrenAdded_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getChildrenRemoved_MethodID_3: jmethodID?

    open func getChildrenRemoved() -> [Element]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChildrenRemoved", methodSig: "()[Ljavax/swing/text/Element;", methodCache: &AbstractDocument_ElementEdit.getChildrenRemoved_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [ElementForward].self, from: __return )
    }
