...
open class AsyncBoxView_ChildState: java_swift.JavaObject, java_swift.Runnable {
    ...
    private static var getChildView_MethodID_2: jmethodID?

    open func getChildView() -> View! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChildView", methodSig: "()Ljavax/swing/text/View;", methodCache: &AsyncBoxView_ChildState.getChildView_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getMajorOffset_MethodID_3: jmethodID?

    open func getMajorOffset() -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMajorOffset", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMajorOffset_MethodID_3, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getMajorSpan_MethodID_4: jmethodID?

    open func getMajorSpan() -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMajorSpan", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMajorSpan_MethodID_4, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getMinorOffset_MethodID_5: jmethodID?

    open func getMinorOffset() -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMinorOffset", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMinorOffset_MethodID_5, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getMinorSpan_MethodID_6: jmethodID?

    open func getMinorSpan() -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMinorSpan", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMinorSpan_MethodID_6, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var isLayoutValid_MethodID_7: jmethodID?

    open func isLayoutValid() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isLayoutValid", methodSig: "()Z", methodCache: &AsyncBoxView_ChildState.isLayoutValid_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var preferenceChanged_MethodID_8: jmethodID?

    open func preferenceChanged( width: Bool, height: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = jvalue( z: jboolean(width ? JNI_TRUE : JNI_FALSE) )
        __args[1] = jvalue( z: jboolean(height ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "preferenceChanged", methodSig: "(ZZ)V", methodCache: &AsyncBoxView_ChildState.preferenceChanged_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func run() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "run", methodSig: "()V", methodCache: &AsyncBoxView_ChildState.run_MethodID_9, args: &__args, locals: &__locals )
    }


    /// public void javax.swing.text.AsyncBoxView$ChildState.setMajorOffset(float)

    private static var setMajorOffset_MethodID_10: jmethodID?

    open func setMajorOffset( offs: Float ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( f: offs )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setMajorOffset", methodSig: "(F)V", methodCache: &AsyncBoxView_ChildState.setMajorOffset_MethodID_10, args: &__args, locals: &__locals )
    }
