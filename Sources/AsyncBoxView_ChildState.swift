...
open class AsyncBoxView_ChildState: java_swift.JavaObject, java_swift.Runnable {
    ...
    private static var getChildView_MethodID_3: jmethodID?

    open func getChildView() -> View! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChildView", methodSig: "()Ljavax/swing/text/View;", methodCache: &AsyncBoxView_ChildState.getChildView_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var getMajorOffset_MethodID_4: jmethodID?

    open func getMajorOffset() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMajorOffset", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMajorOffset_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var setMajorOffset_MethodID_5: jmethodID?

    open func setMajorOffset( offs: Float ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: offs, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setMajorOffset", methodSig: "(F)V", methodCache: &AsyncBoxView_ChildState.setMajorOffset_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var getMajorSpan_MethodID_6: jmethodID?

    open func getMajorSpan() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMajorSpan", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMajorSpan_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    private static var getMinorOffset_MethodID_7: jmethodID?

    open func getMinorOffset() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMinorOffset", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMinorOffset_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    private static var getMinorSpan_MethodID_8: jmethodID?

    open func getMinorSpan() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMinorSpan", methodSig: "()F", methodCache: &AsyncBoxView_ChildState.getMinorSpan_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Float(), from: __return )
    }
    ...
    private static var preferenceChanged_MethodID_9: jmethodID?
    ...
    open func preferenceChanged( width: Bool, height: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "preferenceChanged", methodSig: "(ZZ)V", methodCache: &AsyncBoxView_ChildState.preferenceChanged_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var isLayoutValid_MethodID_10: jmethodID?

    open func isLayoutValid() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isLayoutValid", methodSig: "()Z", methodCache: &AsyncBoxView_ChildState.isLayoutValid_MethodID_10, args: &__args, locals: &__locals )
