...
open class AbstractBorder: java_swift.JavaObject, Border, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open func getInteriorRectangle( c: java_awt.Component?, x: Int, y: Int, width: Int, height: Int ) -> java_awt.Rectangle! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInteriorRectangle", methodSig: "(Ljava/awt/Component;IIII)Ljava/awt/Rectangle;", methodCache: &AbstractBorder.getInteriorRectangle_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
