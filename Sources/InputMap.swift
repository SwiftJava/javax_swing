...
open class InputMap: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    private static var allKeys_MethodID_2: jmethodID?

    open func allKeys() -> [KeyStroke]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "allKeys", methodSig: "()[Ljavax/swing/KeyStroke;", methodCache: &InputMap.allKeys_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func clear() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "clear", methodSig: "()V", methodCache: &InputMap.clear_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func get( keyStroke: KeyStroke? ) -> java_swift.JavaObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "get", methodSig: "(Ljavax/swing/KeyStroke;)Ljava/lang/Object;", methodCache: &InputMap.get_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getParent() -> InputMap! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParent", methodSig: "()Ljavax/swing/InputMap;", methodCache: &InputMap.getParent_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var keys_MethodID_6: jmethodID?

    open func keys() -> [KeyStroke]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "keys", methodSig: "()[Ljavax/swing/KeyStroke;", methodCache: &InputMap.keys_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [KeyStroke].self, from: __return )
    }
    ...
    open func put( keyStroke: KeyStroke?, actionMapKey: java_swift.JavaObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "put", methodSig: "(Ljavax/swing/KeyStroke;Ljava/lang/Object;)V", methodCache: &InputMap.put_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func remove( key: KeyStroke? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "remove", methodSig: "(Ljavax/swing/KeyStroke;)V", methodCache: &InputMap.remove_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func size() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "size", methodSig: "()I", methodCache: &InputMap.size_MethodID_10, args: &__args, locals: &__locals )
        return Int(__return)
    }
