...
open class JToggleButton: AbstractButton {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.JToggleButton", file, line ) {
            return nil
        }
    ...
    private static var JToggleButtonJNIClass: jclass?
    ...
    override open var model: ButtonModel! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &JToggleButton.model_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ButtonModelForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &JToggleButton.model_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeListener: ChangeListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &JToggleButton.changeListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? ChangeListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &JToggleButton.changeListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var actionListener: java_awt.ActionListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &JToggleButton.actionListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ActionListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &JToggleButton.actionListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var itemListener: java_awt.ItemListener! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &JToggleButton.itemListener_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? java_awt.ItemListenerForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = jvalue( l: newValue?.localJavaObject( &__locals ) )
            JNIField.SetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &JToggleButton.itemListener_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    override open var changeEvent: ChangeEvent! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeEvent", fieldType: "Ljavax/swing/event/ChangeEvent;", fieldCache: &JToggleButton.changeEvent_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var ui: ComponentUI! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JToggleButton.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JToggleButton.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JToggleButton.accessibleContext_FieldID, object: javaObject, locals: &__locals )
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "()V", methodCache: &JToggleButton.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: Icon? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljavax/swing/Icon;)V", methodCache: &JToggleButton.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: Icon?, arg1: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljavax/swing/Icon;Z)V", methodCache: &JToggleButton.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &JToggleButton.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: Bool ) {
        ...
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljava/lang/String;Z)V", methodCache: &JToggleButton.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: Action? ) {
        ...
        var __locals = [jobject]()
        __args[0] = jvalue( l: arg0?.localJavaObject( &__locals ) )
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljavax/swing/Action;)V", methodCache: &JToggleButton.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: Icon? ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljava/lang/String;Ljavax/swing/Icon;)V", methodCache: &JToggleButton.new_MethodID_7, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: Icon?, arg2: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JToggleButton", classCache: &JToggleButton.JToggleButtonJNIClass, methodSig: "(Ljava/lang/String;Ljavax/swing/Icon;Z)V", methodCache: &JToggleButton.new_MethodID_8, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    /// private void javax.swing.JToggleButton.writeObject(java.io.ObjectOutputStream) throws java.io.IOException
    ...
    override open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JToggleButton.paramString_MethodID_9, args: &__args, locals: &__locals )
