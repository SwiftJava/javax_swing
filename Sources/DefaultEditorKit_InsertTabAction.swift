...
open class DefaultEditorKit_InsertTabAction: TextAction {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.text.DefaultEditorKit$InsertTabAction", file, line ) {
            return nil
        }
    ...
    private static var DefaultEditorKit_InsertTabActionJNIClass: jclass?
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        ...
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &DefaultEditorKit_InsertTabAction.changeSupport_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
