...
open class JToolTip: JComponent {
    ...
    override open var listenerList: EventListenerList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JToolTip.listenerList_FieldID, object: javaObject )
    ...
    override open var ui: ComponentUI! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JToolTip.ui_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var accessibleContext: /* class javax.accessibility.AccessibleContext */ UnavailableObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JToolTip.accessibleContext_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    private static var getTipText_MethodID_3: jmethodID?

    open func getTipText() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTipText", methodSig: "()Ljava/lang/String;", methodCache: &JToolTip.getTipText_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getUI() -> ToolTipUI! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUI", methodSig: "()Ljavax/swing/plaf/ToolTipUI;", methodCache: &JToolTip.getUI_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func paramString() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JToolTip.paramString_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? String( javaObject: __return ) : nil
    }
    ...
    open func setComponent( c: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setComponent", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &JToolTip.setComponent_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var setTipText_MethodID_7: jmethodID?

    open func setTipText( tipText: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: tipText, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setTipText", methodSig: "(Ljava/lang/String;)V", methodCache: &JToolTip.setTipText_MethodID_7, args: &__args, locals: &__locals )
    }

    open func setTipText( _ _tipText: String? ) {
        setTipText( tipText: _tipText )
    }
