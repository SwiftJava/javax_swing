...
open class AttributeList: java_swift.JavaObject, DTDConstants, /* java.io.Serializable */ UnclassedProtocol {
    ...
    public convenience init( name: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: name, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/parser/AttributeList", classCache: &AttributeList.AttributeListJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &AttributeList.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
