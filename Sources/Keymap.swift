...
open class KeymapForward: JNIObjectForward, Keymap {
    ...
    private static var addActionForKeyStroke_MethodID_14: jmethodID?
    ...
    open func addActionForKeyStroke( key: KeyStroke?, a: Action? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addActionForKeyStroke", methodSig: "(Ljavax/swing/KeyStroke;Ljavax/swing/Action;)V", methodCache: &KeymapForward.addActionForKeyStroke_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var getBoundKeyStrokes_MethodID_17: jmethodID?

    open func getBoundKeyStrokes() -> [KeyStroke]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBoundKeyStrokes", methodSig: "()[Ljavax/swing/KeyStroke;", methodCache: &KeymapForward.getBoundKeyStrokes_MethodID_17, args: &__args, locals: &__locals )
    ...
    private static var getKeyStrokesForAction_MethodID_19: jmethodID?

    open func getKeyStrokesForAction( a: Action? ) -> [KeyStroke]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getKeyStrokesForAction", methodSig: "(Ljavax/swing/Action;)[Ljavax/swing/KeyStroke;", methodCache: &KeymapForward.getKeyStrokesForAction_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [KeyStroke].self, from: __return )
    }
    ...
    open func getName() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getName", methodSig: "()Ljava/lang/String;", methodCache: &KeymapForward.getName_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var removeBindings_MethodID_23: jmethodID?

    open func removeBindings() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeBindings", methodSig: "()V", methodCache: &KeymapForward.removeBindings_MethodID_23, args: &__args, locals: &__locals )
    }


    /// public abstract void javax.swing.text.Keymap.removeKeyStrokeBinding(javax.swing.KeyStroke)

    private static var removeKeyStrokeBinding_MethodID_24: jmethodID?

    open func removeKeyStrokeBinding( keys: KeyStroke? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: keys, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeKeyStrokeBinding", methodSig: "(Ljavax/swing/KeyStroke;)V", methodCache: &KeymapForward.removeKeyStrokeBinding_MethodID_24, args: &__args, locals: &__locals )
    }
    ...
    private static var setDefaultAction_MethodID_25: jmethodID?

    open func setDefaultAction( a: Action? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDefaultAction", methodSig: "(Ljavax/swing/Action;)V", methodCache: &KeymapForward.setDefaultAction_MethodID_25, args: &__args, locals: &__locals )
    }
