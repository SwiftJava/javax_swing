...
open class ActionMap: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open func allKeys() -> [JavaObject]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "allKeys", methodSig: "()[Ljava/lang/Object;", methodCache: &ActionMap.allKeys_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func clear() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "clear", methodSig: "()V", methodCache: &ActionMap.clear_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func get( key: java_swift.JavaObject? ) -> Action! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "get", methodSig: "(Ljava/lang/Object;)Ljavax/swing/Action;", methodCache: &ActionMap.get_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getParent() -> ActionMap! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParent", methodSig: "()Ljavax/swing/ActionMap;", methodCache: &ActionMap.getParent_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func keys() -> [JavaObject]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "keys", methodSig: "()[Ljava/lang/Object;", methodCache: &ActionMap.keys_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [JavaObject].self, from: __return )
    }
    ...
    open func put( key: java_swift.JavaObject?, action: Action? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "put", methodSig: "(Ljava/lang/Object;Ljavax/swing/Action;)V", methodCache: &ActionMap.put_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func remove( key: java_swift.JavaObject? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: key, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "remove", methodSig: "(Ljava/lang/Object;)V", methodCache: &ActionMap.remove_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func size() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "size", methodSig: "()I", methodCache: &ActionMap.size_MethodID_10, args: &__args, locals: &__locals )
        return Int(__return)
    }
