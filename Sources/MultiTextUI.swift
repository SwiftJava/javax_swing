...
open class MultiTextUI: TextUI {
    ...
    open var uis: java_util.Vector! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "uis", fieldType: "Ljava/util/Vector;", fieldCache: &MultiTextUI.uis_FieldID, object: javaObject )
    ...
    private static var damageRange_MethodID_4: jmethodID?
    ...
    open func damageRange( a: JTextComponent?, b: Int, c: Int ) {
        ...
        __args[1] = jvalue( i: jint(b) )
        __args[2] = jvalue( i: jint(c) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "damageRange", methodSig: "(Ljavax/swing/text/JTextComponent;II)V", methodCache: &MultiTextUI.damageRange_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func getAccessibleChild( a: JComponent?, b: Int ) -> /* interface javax.accessibility.Accessible */ UnavailableProtocol! {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = jvalue( i: jint(b) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAccessibleChild", methodSig: "(Ljavax/swing/JComponent;I)Ljavax/accessibility/Accessible;", methodCache: &MultiTextUI.getAccessibleChild_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getAccessibleChildrenCount( a: JComponent? ) -> Int {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAccessibleChildrenCount", methodSig: "(Ljavax/swing/JComponent;)I", methodCache: &MultiTextUI.getAccessibleChildrenCount_MethodID_7, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getMaximumSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMaximumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiTextUI.getMaximumSize_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getMinimumSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiTextUI.getMinimumSize_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    open func getNextVisualPositionFrom( a: JTextComponent?, b: Int, c: Position_Bias?, d: Int, e: [Position_Bias]? ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        __args[3] = jvalue( i: jint(d) )
        __args[4] = JNIType.toJava( value: e, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getNextVisualPositionFrom", methodSig: "(Ljavax/swing/text/JTextComponent;ILjavax/swing/text/Position$Bias;I[Ljavax/swing/text/Position$Bias;)I", methodCache: &MultiTextUI.getNextVisualPositionFrom_MethodID_11, args: &__args, locals: &__locals )
    ...
    open func getPreferredSize( a: JComponent? ) -> java_awt.Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "(Ljavax/swing/JComponent;)Ljava/awt/Dimension;", methodCache: &MultiTextUI.getPreferredSize_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Dimension( javaObject: __return ) : nil
    }
    ...
    open func getRootView( a: JTextComponent? ) -> View! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getRootView", methodSig: "(Ljavax/swing/text/JTextComponent;)Ljavax/swing/text/View;", methodCache: &MultiTextUI.getRootView_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getToolTipText( a: JTextComponent?, b: java_awt.Point? ) -> String! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getToolTipText", methodSig: "(Ljavax/swing/text/JTextComponent;Ljava/awt/Point;)Ljava/lang/String;", methodCache: &MultiTextUI.getToolTipText_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func modelToView( a: JTextComponent?, b: Int ) throws /* javax.swing.text.BadLocationException */ -> java_awt.Rectangle! {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = jvalue( i: jint(b) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "modelToView", methodSig: "(Ljavax/swing/text/JTextComponent;I)Ljava/awt/Rectangle;", methodCache: &MultiTextUI.modelToView_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw BadLocationException( javaObject: throwable )
    ...
    open func modelToView( a: JTextComponent?, b: Int, c: Position_Bias? ) throws /* javax.swing.text.BadLocationException */ -> java_awt.Rectangle! {
        ...
        __args[1] = jvalue( i: jint(b) )
        __args[2] = JNIType.toJava( value: c, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "modelToView", methodSig: "(Ljavax/swing/text/JTextComponent;ILjavax/swing/text/Position$Bias;)Ljava/awt/Rectangle;", methodCache: &MultiTextUI.modelToView_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw BadLocationException( javaObject: throwable )
    ...
    open func paint( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiTextUI.paint_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    private static var uninstallUI_MethodID_20: jmethodID?

    open func uninstallUI( a: JComponent? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallUI", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &MultiTextUI.uninstallUI_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var update_MethodID_21: jmethodID?
    ...
    open func update( a: java_awt.Graphics?, b: JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MultiTextUI.update_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var viewToModel_MethodID_22: jmethodID?
    ...
    open func viewToModel( a: JTextComponent?, b: java_awt.Point? ) -> Int {
        ...
        __args[0] = JNIType.toJava( value: a, locals: &__locals )
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "viewToModel", methodSig: "(Ljavax/swing/text/JTextComponent;Ljava/awt/Point;)I", methodCache: &MultiTextUI.viewToModel_MethodID_22, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var viewToModel_MethodID_23: jmethodID?
    ...
    open func viewToModel( a: JTextComponent?, b: java_awt.Point?, c: [Position_Bias]? ) -> Int {
        ...
        __args[1] = JNIType.toJava( value: b, locals: &__locals )
        __args[2] = JNIType.toJava( value: c, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "viewToModel", methodSig: "(Ljavax/swing/text/JTextComponent;Ljava/awt/Point;[Ljavax/swing/text/Position$Bias;)I", methodCache: &MultiTextUI.viewToModel_MethodID_23, args: &__args, locals: &__locals )
        return Int(__return)
    }
