...
open class MetalTreeUI: BasicTreeUI {
    ...
    override open var cellEditor: TreeCellEditor! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "cellEditor", fieldType: "Ljavax/swing/tree/TreeCellEditor;", fieldCache: &MetalTreeUI.cellEditor_FieldID, object: javaObject )
    ...
    override open var collapsedIcon: Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "collapsedIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &MetalTreeUI.collapsedIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var createdCellEditor: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "createdCellEditor", fieldType: "Z", fieldCache: &MetalTreeUI.createdCellEditor_FieldID, object: javaObject )
    ...
    override open var createdRenderer: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "createdRenderer", fieldType: "Z", fieldCache: &MetalTreeUI.createdRenderer_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var currentCellRenderer: TreeCellRenderer! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "currentCellRenderer", fieldType: "Ljavax/swing/tree/TreeCellRenderer;", fieldCache: &MetalTreeUI.currentCellRenderer_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var depthOffset: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "depthOffset", fieldType: "I", fieldCache: &MetalTreeUI.depthOffset_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var drawingCache: java_util.Hashtable! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "drawingCache", fieldType: "Ljava/util/Hashtable;", fieldCache: &MetalTreeUI.drawingCache_FieldID, object: javaObject )
    ...
    override open var editingComponent: java_awt.Component! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "editingComponent", fieldType: "Ljava/awt/Component;", fieldCache: &MetalTreeUI.editingComponent_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var editingPath: TreePath! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "editingPath", fieldType: "Ljavax/swing/tree/TreePath;", fieldCache: &MetalTreeUI.editingPath_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var editingRow: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "editingRow", fieldType: "I", fieldCache: &MetalTreeUI.editingRow_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var editorHasDifferentSize: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "editorHasDifferentSize", fieldType: "Z", fieldCache: &MetalTreeUI.editorHasDifferentSize_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var expandedIcon: Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "expandedIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &MetalTreeUI.expandedIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? IconForward( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var largeModel: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "largeModel", fieldType: "Z", fieldCache: &MetalTreeUI.largeModel_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var lastSelectedRow: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "lastSelectedRow", fieldType: "I", fieldCache: &MetalTreeUI.lastSelectedRow_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var leftChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "leftChildIndent", fieldType: "I", fieldCache: &MetalTreeUI.leftChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var nodeDimensions: AbstractLayoutCache_NodeDimensions! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "nodeDimensions", fieldType: "Ljavax/swing/tree/AbstractLayoutCache$NodeDimensions;", fieldCache: &MetalTreeUI.nodeDimensions_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var preferredMinSize: java_awt.Dimension! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "preferredMinSize", fieldType: "Ljava/awt/Dimension;", fieldCache: &MetalTreeUI.preferredMinSize_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var preferredSize: java_awt.Dimension! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "preferredSize", fieldType: "Ljava/awt/Dimension;", fieldCache: &MetalTreeUI.preferredSize_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Dimension( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var rendererPane: CellRendererPane! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "rendererPane", fieldType: "Ljavax/swing/CellRendererPane;", fieldCache: &MetalTreeUI.rendererPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var rightChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "rightChildIndent", fieldType: "I", fieldCache: &MetalTreeUI.rightChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var stopEditingInCompleteEditing: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "stopEditingInCompleteEditing", fieldType: "Z", fieldCache: &MetalTreeUI.stopEditingInCompleteEditing_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var totalChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "totalChildIndent", fieldType: "I", fieldCache: &MetalTreeUI.totalChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var tree: JTree! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "tree", fieldType: "Ljavax/swing/JTree;", fieldCache: &MetalTreeUI.tree_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeModel: TreeModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeModel", fieldType: "Ljavax/swing/tree/TreeModel;", fieldCache: &MetalTreeUI.treeModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeSelectionModel: TreeSelectionModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeSelectionModel", fieldType: "Ljavax/swing/tree/TreeSelectionModel;", fieldCache: &MetalTreeUI.treeSelectionModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeState: AbstractLayoutCache! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeState", fieldType: "Ljavax/swing/tree/AbstractLayoutCache;", fieldCache: &MetalTreeUI.treeState_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var validCachedPreferredSize: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "validCachedPreferredSize", fieldType: "Z", fieldCache: &MetalTreeUI.validCachedPreferredSize_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    private static var decodeLineStyle_MethodID_3: jmethodID?

    open func decodeLineStyle( lineStyleFlag: java_swift.JavaObject? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: lineStyleFlag, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "decodeLineStyle", methodSig: "(Ljava/lang/Object;)V", methodCache: &MetalTreeUI.decodeLineStyle_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var getHorizontalLegBuffer_MethodID_4: jmethodID?

    override open func getHorizontalLegBuffer() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getHorizontalLegBuffer", methodSig: "()I", methodCache: &MetalTreeUI.getHorizontalLegBuffer_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var isLocationInExpandControl_MethodID_5: jmethodID?

    open func isLocationInExpandControl( row: Int, rowLevel: Int, mouseX: Int, mouseY: Int ) -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 4 )
        __args[0] = jvalue( i: jint(row) )
        __args[1] = jvalue( i: jint(rowLevel) )
        __args[2] = jvalue( i: jint(mouseX) )
        __args[3] = jvalue( i: jint(mouseY) )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isLocationInExpandControl", methodSig: "(IIII)Z", methodCache: &MetalTreeUI.isLocationInExpandControl_MethodID_5, args: &__args, locals: &__locals )
    ...
    override open func paintHorizontalPartOfLeg( g: java_awt.Graphics?, clipBounds: java_awt.Rectangle?, insets: java_awt.Insets?, bounds: java_awt.Rectangle?, path: TreePath?, row: Int, isExpanded: Bool, hasBeenExpanded: Bool, isLeaf: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintHorizontalPartOfLeg", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Insets;Ljava/awt/Rectangle;Ljavax/swing/tree/TreePath;IZZZ)V", methodCache: &MetalTreeUI.paintHorizontalPartOfLeg_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var paintHorizontalSeparators_MethodID_7: jmethodID?
    ...
    open func paintHorizontalSeparators( g: java_awt.Graphics?, c: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintHorizontalSeparators", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &MetalTreeUI.paintHorizontalSeparators_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var paintVerticalPartOfLeg_MethodID_8: jmethodID?
    ...
    override open func paintVerticalPartOfLeg( g: java_awt.Graphics?, clipBounds: java_awt.Rectangle?, insets: java_awt.Insets?, path: TreePath? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintVerticalPartOfLeg", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Insets;Ljavax/swing/tree/TreePath;)V", methodCache: &MetalTreeUI.paintVerticalPartOfLeg_MethodID_8, args: &__args, locals: &__locals )
    }
