...
open class Option: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open func getLabel() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLabel", methodSig: "()Ljava/lang/String;", methodCache: &Option.getLabel_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: String(), from: __return )
    }
    ...
    open func setLabel( label: String? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLabel", methodSig: "(Ljava/lang/String;)V", methodCache: &Option.setLabel_MethodID_7, args: &__args, locals: &__locals )
    }
