...
open class TableModelForward: JNIObjectForward, TableModel {
    ...
    private static var addTableModelListener_MethodID_10: jmethodID?

    open func addTableModelListener( l: TableModelListener? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addTableModelListener", methodSig: "(Ljavax/swing/event/TableModelListener;)V", methodCache: &TableModelForward.addTableModelListener_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func getColumnClass( columnIndex: Int ) -> java_swift.JavaClass! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColumnClass", methodSig: "(I)Ljava/lang/Class;", methodCache: &TableModelForward.getColumnClass_MethodID_11, args: &__args, locals: &__locals )
    ...
    open func getRowCount() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRowCount", methodSig: "()I", methodCache: &TableModelForward.getRowCount_MethodID_14, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func isCellEditable( rowIndex: Int, columnIndex: Int ) -> Bool {
        ...
        __args[0] = jvalue( i: jint(rowIndex) )
        __args[1] = jvalue( i: jint(columnIndex) )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isCellEditable", methodSig: "(II)Z", methodCache: &TableModelForward.isCellEditable_MethodID_16, args: &__args, locals: &__locals )
    ...
    private static var setValueAt_MethodID_18: jmethodID?
    ...
    open func setValueAt( aValue: java_swift.JavaObject?, rowIndex: Int, columnIndex: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setValueAt", methodSig: "(Ljava/lang/Object;II)V", methodCache: &TableModelForward.setValueAt_MethodID_18, args: &__args, locals: &__locals )
    }
