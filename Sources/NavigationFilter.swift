...
open class NavigationFilter: java_swift.JavaObject {
    ...
    open func setDot( fb: NavigationFilter_FilterBypass?, dot: Int, bias: Position_Bias? ) {
        ...
        __args[1] = jvalue( i: jint(dot) )
        __args[2] = JNIType.toJava( value: bias, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDot", methodSig: "(Ljavax/swing/text/NavigationFilter$FilterBypass;ILjavax/swing/text/Position$Bias;)V", methodCache: &NavigationFilter.setDot_MethodID_4, args: &__args, locals: &__locals )
    }
