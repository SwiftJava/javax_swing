...
open class BorderUIResource_CompoundBorderUIResource: CompoundBorder, UIResource {
    ...
    override open var insideBorder: Border! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "insideBorder", fieldType: "Ljavax/swing/border/Border;", fieldCache: &BorderUIResource_CompoundBorderUIResource.insideBorder_FieldID, object: javaObject )
    ...
    override open var outsideBorder: Border! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "outsideBorder", fieldType: "Ljavax/swing/border/Border;", fieldCache: &BorderUIResource_CompoundBorderUIResource.outsideBorder_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? BorderForward( javaObject: __value ) : nil
        }
        set(newValue) {
