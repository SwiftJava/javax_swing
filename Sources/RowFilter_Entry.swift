...
open class RowFilter_Entry: java_swift.JavaObject {
    ...
    private static var getIdentifier_MethodID_2: jmethodID?

    open func getIdentifier() -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getIdentifier", methodSig: "()Ljava/lang/Object;", methodCache: &RowFilter_Entry.getIdentifier_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func getValue( index: Int ) -> java_swift.JavaObject! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(index) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getValue", methodSig: "(I)Ljava/lang/Object;", methodCache: &RowFilter_Entry.getValue_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_swift.JavaObject( javaObject: __return ) : nil
    }
    ...
    private static var getValueCount_MethodID_6: jmethodID?

    open func getValueCount() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getValueCount", methodSig: "()I", methodCache: &RowFilter_Entry.getValueCount_MethodID_6, args: &__args, locals: &__locals )
        return Int(__return)
    }
