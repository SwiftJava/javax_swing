...
open class BasicListUI_MouseInputHandler: java_swift.JavaObject, MouseInputListener {
    ...
    open func mouseClicked( e: java_awt.MouseEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseClicked", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mouseClicked_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func mouseDragged( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseDragged", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mouseDragged_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func mouseEntered( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseEntered", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mouseEntered_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func mouseMoved( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseMoved", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mouseMoved_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func mousePressed( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mousePressed", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mousePressed_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func mouseReleased( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseReleased", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicListUI_MouseInputHandler.mouseReleased_MethodID_8, args: &__args, locals: &__locals )
    }
