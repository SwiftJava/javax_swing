...
open class Utilities: java_swift.JavaObject {
    ...
    private static var getTabbedTextWidth_MethodID_2: jmethodID?
    ...
    open class func getTabbedTextWidth( s: Segment?, metrics: java_awt.FontMetrics?, x: Int, e: TabExpander?, startOffset: Int ) -> Int {
        ...
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getTabbedTextWidth", methodSig: "(Ljavax/swing/text/Segment;Ljava/awt/FontMetrics;ILjavax/swing/text/TabExpander;I)I", methodCache: &getTabbedTextWidth_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var drawTabbedText_MethodID_3: jmethodID?
    ...
    open class func drawTabbedText( s: Segment?, x: Int, y: Int, g: java_awt.Graphics?, e: TabExpander?, startOffset: Int ) -> Int {
        ...
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "drawTabbedText", methodSig: "(Ljavax/swing/text/Segment;IILjava/awt/Graphics;Ljavax/swing/text/TabExpander;I)I", methodCache: &drawTabbedText_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getTabbedTextOffset_MethodID_4: jmethodID?
    ...
    open class func getTabbedTextOffset( s: Segment?, metrics: java_awt.FontMetrics?, x0: Int, x: Int, e: TabExpander?, startOffset: Int, round: Bool ) -> Int {
        ...
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getTabbedTextOffset", methodSig: "(Ljavax/swing/text/Segment;Ljava/awt/FontMetrics;IILjavax/swing/text/TabExpander;IZ)I", methodCache: &getTabbedTextOffset_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getTabbedTextOffset_MethodID_5: jmethodID?
    ...
    open class func getTabbedTextOffset( s: Segment?, metrics: java_awt.FontMetrics?, x0: Int, x: Int, e: TabExpander?, startOffset: Int ) -> Int {
        ...
        __args[4] = JNIType.toJava( value: e, locals: &__locals )
        __args[5] = JNIType.toJava( value: startOffset, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getTabbedTextOffset", methodSig: "(Ljavax/swing/text/Segment;Ljava/awt/FontMetrics;IILjavax/swing/text/TabExpander;I)I", methodCache: &getTabbedTextOffset_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getBreakLocation_MethodID_6: jmethodID?
    ...
    open class func getBreakLocation( s: Segment?, metrics: java_awt.FontMetrics?, x0: Int, x: Int, e: TabExpander?, startOffset: Int ) -> Int {
        ...
        __args[4] = JNIType.toJava( value: e, locals: &__locals )
        __args[5] = JNIType.toJava( value: startOffset, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getBreakLocation", methodSig: "(Ljavax/swing/text/Segment;Ljava/awt/FontMetrics;IILjavax/swing/text/TabExpander;I)I", methodCache: &getBreakLocation_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getPositionAbove_MethodID_7: jmethodID?
    ...
    open class func getPositionAbove( c: JTextComponent?, offs: Int, x: Int ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        __args[2] = JNIType.toJava( value: x, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getPositionAbove", methodSig: "(Ljavax/swing/text/JTextComponent;II)I", methodCache: &getPositionAbove_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var getPositionBelow_MethodID_8: jmethodID?
    ...
    open class func getPositionBelow( c: JTextComponent?, offs: Int, x: Int ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        __args[1] = JNIType.toJava( value: offs, locals: &__locals )
        __args[2] = JNIType.toJava( value: x, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getPositionBelow", methodSig: "(Ljavax/swing/text/JTextComponent;II)I", methodCache: &getPositionBelow_MethodID_8, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var getPreviousWord_MethodID_11: jmethodID?
    ...
    open class func getPreviousWord( c: JTextComponent?, offs: Int ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        __args[1] = JNIType.toJava( value: offs, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getPreviousWord", methodSig: "(Ljavax/swing/text/JTextComponent;I)I", methodCache: &getPreviousWord_MethodID_11, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var getNextWord_MethodID_12: jmethodID?
    ...
    open class func getNextWord( c: JTextComponent?, offs: Int ) throws /* javax.swing.text.BadLocationException */ -> Int {
        ...
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        __args[1] = JNIType.toJava( value: offs, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "javax/swing/text/Utilities", classCache: &UtilitiesJNIClass, methodName: "getNextWord", methodSig: "(Ljavax/swing/text/JTextComponent;I)I", methodCache: &getNextWord_MethodID_12, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
