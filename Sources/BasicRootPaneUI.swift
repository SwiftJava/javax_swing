...
open class BasicRootPaneUI: RootPaneUI, /* java.beans.PropertyChangeListener */ UnclassedProtocol {
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &BasicRootPaneUI.propertyChange_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func installComponents( root: JRootPane? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installComponents", methodSig: "(Ljavax/swing/JRootPane;)V", methodCache: &BasicRootPaneUI.installComponents_MethodID_5, args: &__args, locals: &__locals )
    }
