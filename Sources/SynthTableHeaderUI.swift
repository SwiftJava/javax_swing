...
open class SynthTableHeaderUI: BasicTableHeaderUI, /* java.beans.PropertyChangeListener */ UnclassedProtocol, SynthUI {
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &SynthTableHeaderUI.propertyChange_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func paintBorder( context: SynthContext?, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Graphics;IIII)V", methodCache: &SynthTableHeaderUI.paintBorder_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var rolloverColumnUpdated_MethodID_7: jmethodID?
    ...
    open func rolloverColumnUpdated( arg0: Int, arg1: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "rolloverColumnUpdated", methodSig: "(II)V", methodCache: &SynthTableHeaderUI.rolloverColumnUpdated_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func paint( arg0: java_awt.Graphics?, arg1: JComponent? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1 != nil ? arg1! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &SynthTableHeaderUI.paint_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func paint( arg0: SynthContext?, arg1: java_awt.Graphics? ) {
        ...
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: arg1 != nil ? arg1! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Graphics;)V", methodCache: &SynthTableHeaderUI.paint_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    override open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &SynthTableHeaderUI.installDefaults_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    override open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &SynthTableHeaderUI.installListeners_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "()V", methodCache: &SynthTableHeaderUI.uninstallDefaults_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    override open func uninstallListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &SynthTableHeaderUI.uninstallListeners_MethodID_13, args: &__args, locals: &__locals )
    }
