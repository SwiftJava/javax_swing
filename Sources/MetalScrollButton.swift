...
open class MetalScrollButton: BasicArrowButton {
    ...
    public convenience init( direction: Int, width: Int, freeStanding: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 3 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: direction, locals: &__locals )
        __args[1] = JNIType.toJava( value: width, locals: &__locals )
        __args[2] = JNIType.toJava( value: freeStanding, locals: &__locals )
    ...
    public convenience init( _ _direction: Int, _ _width: Int, _ _freeStanding: Bool ) {
    ...
    open func setFreeStanding( freeStanding: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: freeStanding, locals: &__locals )
    ...
    open func setFreeStanding( _ _freeStanding: Bool ) {
        setFreeStanding( freeStanding: _freeStanding )
    }
