...
open class MetalScrollButton: BasicArrowButton {
    ...
    override open var direction: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "direction", fieldType: "I", fieldCache: &MetalScrollButton.direction_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    override open var actionListener: java_awt.ActionListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "actionListener", fieldType: "Ljava/awt/event/ActionListener;", fieldCache: &MetalScrollButton.actionListener_FieldID, object: javaObject )
    ...
    override open var changeEvent: ChangeEvent! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeEvent", fieldType: "Ljavax/swing/event/ChangeEvent;", fieldCache: &MetalScrollButton.changeEvent_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var changeListener: ChangeListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &MetalScrollButton.changeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var itemListener: java_awt.ItemListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "itemListener", fieldType: "Ljava/awt/event/ItemListener;", fieldCache: &MetalScrollButton.itemListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var model: ButtonModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "model", fieldType: "Ljavax/swing/ButtonModel;", fieldCache: &MetalScrollButton.model_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var listenerList: EventListenerList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &MetalScrollButton.listenerList_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var ui: ComponentUI! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &MetalScrollButton.ui_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var accessibleContext: /* class javax.accessibility.AccessibleContext */ UnavailableObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &MetalScrollButton.accessibleContext_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    public convenience init( direction: Int, width: Int, freeStanding: Bool ) {
        ...
        __args[2] = jvalue( z: jboolean(freeStanding ? JNI_TRUE : JNI_FALSE) )
    ...
    private static var getButtonWidth_MethodID_2: jmethodID?

    open func getButtonWidth() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getButtonWidth", methodSig: "()I", methodCache: &MetalScrollButton.getButtonWidth_MethodID_2, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var setFreeStanding_MethodID_3: jmethodID?

    open func setFreeStanding( freeStanding: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( z: jboolean(freeStanding ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setFreeStanding", methodSig: "(Z)V", methodCache: &MetalScrollButton.setFreeStanding_MethodID_3, args: &__args, locals: &__locals )
    }
