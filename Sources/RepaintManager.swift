...
open class RepaintManager: java_swift.JavaObject {
    ...
    open class func setCurrentManager( aRepaintManager: RepaintManager? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: aRepaintManager != nil ? aRepaintManager! as JNIObject : nil, locals: &__locals )
    ...
    open func addInvalidComponent( invalidComponent: JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: invalidComponent != nil ? invalidComponent! as JNIObject : nil, locals: &__locals )
    ...
    open func addDirtyRegion( c: JComponent?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addDirtyRegion", methodSig: "(Ljavax/swing/JComponent;IIII)V", methodCache: &RepaintManager.addDirtyRegion_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func addDirtyRegion( applet: /* java.applet.Applet */ UnclassedObject?, x: Int, y: Int, w: Int, h: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 5 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: applet != nil ? applet! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: x, locals: &__locals )
        __args[2] = JNIType.toJava( value: y, locals: &__locals )
        __args[3] = JNIType.toJava( value: w, locals: &__locals )
        __args[4] = JNIType.toJava( value: h, locals: &__locals )
