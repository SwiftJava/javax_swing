...
open class DocumentForward: JNIObjectForward, Document {
    ...
    private static var putProperty_MethodID_29: jmethodID?
    ...
    open func putProperty( key: java_swift.JavaObject?, value: java_swift.JavaObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "putProperty", methodSig: "(Ljava/lang/Object;Ljava/lang/Object;)V", methodCache: &DocumentForward.putProperty_MethodID_29, args: &__args, locals: &__locals )
    }
    ...
    private static var getDefaultRootElement_MethodID_30: jmethodID?

    open func getDefaultRootElement() -> Element! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDefaultRootElement", methodSig: "()Ljavax/swing/text/Element;", methodCache: &DocumentForward.getDefaultRootElement_MethodID_30, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var removeDocumentListener_MethodID_31: jmethodID?

    open func removeDocumentListener( listener: DocumentListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeDocumentListener", methodSig: "(Ljavax/swing/event/DocumentListener;)V", methodCache: &DocumentForward.removeDocumentListener_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    private static var addDocumentListener_MethodID_32: jmethodID?

    open func addDocumentListener( listener: DocumentListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addDocumentListener", methodSig: "(Ljavax/swing/event/DocumentListener;)V", methodCache: &DocumentForward.addDocumentListener_MethodID_32, args: &__args, locals: &__locals )
    }
    ...
    private static var insertString_MethodID_33: jmethodID?
    ...
    open func insertString( offset: Int, str: String?, a: AttributeSet? ) throws /* javax.swing.text.BadLocationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertString", methodSig: "(ILjava/lang/String;Ljavax/swing/text/AttributeSet;)V", methodCache: &DocumentForward.insertString_MethodID_33, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
    }
    ...
    private static var createPosition_MethodID_34: jmethodID?

    open func createPosition( offs: Int ) throws /* javax.swing.text.BadLocationException */ -> Position! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: offs, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPosition", methodSig: "(I)Ljavax/swing/text/Position;", methodCache: &DocumentForward.createPosition_MethodID_34, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw BadLocationException( javaObject: throwable )
        }
