...
open class SynthSeparatorUI: SeparatorUI, /* java.beans.PropertyChangeListener */ UnclassedProtocol, SynthUI {
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &SynthSeparatorUI.propertyChange_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func paintBorder( context: SynthContext?, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Graphics;IIII)V", methodCache: &SynthSeparatorUI.paintBorder_MethodID_10, args: &__args, locals: &__locals )
    }
