...
open class Entity: java_swift.JavaObject, DTDConstants {
    ...
    private static var isParameter_MethodID_4: jmethodID?

    open func isParameter() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isParameter", methodSig: "()Z", methodCache: &Entity.isParameter_MethodID_4, args: &__args, locals: &__locals )
