...
open class JLabel: JComponent, SwingConstants {
    ...
    public convenience init( image: Icon?, horizontalAlignment: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: image, locals: &__locals )
        __args[1] = JNIType.toJava( value: horizontalAlignment, locals: &__locals )
    ...
    public convenience init( text: String?, icon: Icon?, horizontalAlignment: Int ) {
        ...
        __args[2] = JNIType.toJava( value: horizontalAlignment, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JLabel", classCache: &JLabel.JLabelJNIClass, methodSig: "(Ljava/lang/String;Ljavax/swing/Icon;I)V", methodCache: &JLabel.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( text: String?, horizontalAlignment: Int ) {
        ...
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        __args[1] = JNIType.toJava( value: horizontalAlignment, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JLabel", classCache: &JLabel.JLabelJNIClass, methodSig: "(Ljava/lang/String;I)V", methodCache: &JLabel.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( text: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JLabel", classCache: &JLabel.JLabelJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &JLabel.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    override open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JLabel.paramString_MethodID_7, args: &__args, locals: &__locals )
