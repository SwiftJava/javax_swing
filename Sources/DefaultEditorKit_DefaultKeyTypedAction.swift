...
open class DefaultEditorKit_DefaultKeyTypedAction: TextAction {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.text.DefaultEditorKit$DefaultKeyTypedAction", file, line ) {
            return nil
        }
    ...
    private static var DefaultEditorKit_DefaultKeyTypedActionJNIClass: jclass?
    ...
    override open var enabled: Bool {
        get {
            ...
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.enabled_FieldID, object: javaObject, locals: &__locals )
            return JNIType.decode( type: Bool(), from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.enabled_FieldID, object: javaObject, value: __value.z, locals: &__locals )
        }
    }
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.changeSupport_FieldID, object: javaObject, locals: &__locals )
            return __value != nil ? SwingPropertyChangeSupport( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
            let __value = JNIType.encode( value: newValue, locals: &__locals )
            JNIField.SetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.changeSupport_FieldID, object: javaObject, value: __value.l, locals: &__locals )
        }
    }
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/text/DefaultEditorKit$DefaultKeyTypedAction", classCache: &DefaultEditorKit_DefaultKeyTypedAction.DefaultEditorKit_DefaultKeyTypedActionJNIClass, methodSig: "()V", methodCache: &DefaultEditorKit_DefaultKeyTypedAction.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// public void javax.swing.text.DefaultEditorKit$DefaultKeyTypedAction.actionPerformed(java.awt.event.ActionEvent)
