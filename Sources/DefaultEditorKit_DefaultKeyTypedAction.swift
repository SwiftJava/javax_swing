...
open class DefaultEditorKit_DefaultKeyTypedAction: TextAction {
    ...
    override open var changeSupport: SwingPropertyChangeSupport! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeSupport", fieldType: "Ljavax/swing/event/SwingPropertyChangeSupport;", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.changeSupport_FieldID, object: javaObject )
    ...
    override open var enabled: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "enabled", fieldType: "Z", fieldCache: &DefaultEditorKit_DefaultKeyTypedAction.enabled_FieldID, object: javaObject )
