...
open class DefaultCaret: java_awt.Rectangle, Caret, java_awt.FocusListener, java_awt.MouseListener, java_awt.MouseMotionListener {
    ...
    private static var getMagicCaretPosition_MethodID_21: jmethodID?

    open func getMagicCaretPosition() -> java_awt.Point! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMagicCaretPosition", methodSig: "()Ljava/awt/Point;", methodCache: &DefaultCaret.getMagicCaretPosition_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setMagicCaretPosition_MethodID_22: jmethodID?

    open func setMagicCaretPosition( p: java_awt.Point? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: p != nil ? p! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setMagicCaretPosition", methodSig: "(Ljava/awt/Point;)V", methodCache: &DefaultCaret.setMagicCaretPosition_MethodID_22, args: &__args, locals: &__locals )
    }
