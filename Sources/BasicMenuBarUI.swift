...
open class BasicMenuBarUI: MenuBarUI {
    ...
    open var changeListener: ChangeListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &BasicMenuBarUI.changeListener_FieldID, object: javaObject )
    ...
    open var containerListener: java_awt.ContainerListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "containerListener", fieldType: "Ljava/awt/event/ContainerListener;", fieldCache: &BasicMenuBarUI.containerListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var menuBar: JMenuBar! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "menuBar", fieldType: "Ljavax/swing/JMenuBar;", fieldCache: &BasicMenuBarUI.menuBar_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    private static var createContainerListener_MethodID_4: jmethodID?

    open func createContainerListener() -> java_awt.ContainerListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createContainerListener", methodSig: "()Ljava/awt/event/ContainerListener;", methodCache: &BasicMenuBarUI.createContainerListener_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func installListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicMenuBarUI.installListeners_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &BasicMenuBarUI.uninstallListeners_MethodID_10, args: &__args, locals: &__locals )
    }
