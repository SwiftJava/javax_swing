...
open class BasicProgressBarUI: ProgressBarUI {
    ...
    open var boxRect: java_awt.Rectangle! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "boxRect", fieldType: "Ljava/awt/Rectangle;", fieldCache: &BasicProgressBarUI.boxRect_FieldID, object: javaObject )
    ...
    open var changeListener: ChangeListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "changeListener", fieldType: "Ljavax/swing/event/ChangeListener;", fieldCache: &BasicProgressBarUI.changeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var progressBar: JProgressBar! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "progressBar", fieldType: "Ljavax/swing/JProgressBar;", fieldCache: &BasicProgressBarUI.progressBar_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    private static var getAmountFull_MethodID_3: jmethodID?
    ...
    open func getAmountFull( b: java_awt.Insets?, width: Int, height: Int ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAmountFull", methodSig: "(Ljava/awt/Insets;II)I", methodCache: &BasicProgressBarUI.getAmountFull_MethodID_3, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getAnimationIndex_MethodID_4: jmethodID?

    open func getAnimationIndex() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getAnimationIndex", methodSig: "()I", methodCache: &BasicProgressBarUI.getAnimationIndex_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getBox_MethodID_5: jmethodID?

    open func getBox( r: java_awt.Rectangle? ) -> java_awt.Rectangle! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: r, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBox", methodSig: "(Ljava/awt/Rectangle;)Ljava/awt/Rectangle;", methodCache: &BasicProgressBarUI.getBox_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getBoxLength_MethodID_6: jmethodID?

    open func getBoxLength( availableLength: Int, otherDimension: Int ) -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = jvalue( i: jint(availableLength) )
        __args[1] = jvalue( i: jint(otherDimension) )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getBoxLength", methodSig: "(II)I", methodCache: &BasicProgressBarUI.getBoxLength_MethodID_6, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getCellLength_MethodID_7: jmethodID?

    open func getCellLength() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getCellLength", methodSig: "()I", methodCache: &BasicProgressBarUI.getCellLength_MethodID_7, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getCellSpacing_MethodID_8: jmethodID?

    open func getCellSpacing() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getCellSpacing", methodSig: "()I", methodCache: &BasicProgressBarUI.getCellSpacing_MethodID_8, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getFrameCount_MethodID_9: jmethodID?

    open func getFrameCount() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getFrameCount", methodSig: "()I", methodCache: &BasicProgressBarUI.getFrameCount_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getSelectionBackground_MethodID_12: jmethodID?

    open func getSelectionBackground() -> java_awt.Color! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionBackground", methodSig: "()Ljava/awt/Color;", methodCache: &BasicProgressBarUI.getSelectionBackground_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getSelectionForeground_MethodID_13: jmethodID?

    open func getSelectionForeground() -> java_awt.Color! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionForeground", methodSig: "()Ljava/awt/Color;", methodCache: &BasicProgressBarUI.getSelectionForeground_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Color( javaObject: __return ) : nil
    }
    ...
    open func getStringPlacement( g: java_awt.Graphics?, progressString: String?, x: Int, y: Int, width: Int, height: Int ) -> java_awt.Point! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getStringPlacement", methodSig: "(Ljava/awt/Graphics;Ljava/lang/String;IIII)Ljava/awt/Point;", methodCache: &BasicProgressBarUI.getStringPlacement_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var incrementAnimationIndex_MethodID_15: jmethodID?

    open func incrementAnimationIndex() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "incrementAnimationIndex", methodSig: "()V", methodCache: &BasicProgressBarUI.incrementAnimationIndex_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func installDefaults() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &BasicProgressBarUI.installDefaults_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicProgressBarUI.installListeners_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var paintDeterminate_MethodID_18: jmethodID?
    ...
    open func paintDeterminate( g: java_awt.Graphics?, c: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintDeterminate", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;)V", methodCache: &BasicProgressBarUI.paintDeterminate_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var paintString_MethodID_20: jmethodID?
    ...
    open func paintString( g: java_awt.Graphics?, x: Int, y: Int, width: Int, height: Int, amountFull: Int, b: java_awt.Insets? ) {
        ...
        __args[5] = jvalue( i: jint(amountFull) )
        __args[6] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintString", methodSig: "(Ljava/awt/Graphics;IIIIILjava/awt/Insets;)V", methodCache: &BasicProgressBarUI.paintString_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var setAnimationIndex_MethodID_21: jmethodID?

    open func setAnimationIndex( newValue: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(newValue) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setAnimationIndex", methodSig: "(I)V", methodCache: &BasicProgressBarUI.setAnimationIndex_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var setCellLength_MethodID_22: jmethodID?

    open func setCellLength( cellLen: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(cellLen) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCellLength", methodSig: "(I)V", methodCache: &BasicProgressBarUI.setCellLength_MethodID_22, args: &__args, locals: &__locals )
    }
    ...
    private static var setCellSpacing_MethodID_23: jmethodID?

    open func setCellSpacing( cellSpace: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(cellSpace) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCellSpacing", methodSig: "(I)V", methodCache: &BasicProgressBarUI.setCellSpacing_MethodID_23, args: &__args, locals: &__locals )
    }
    ...
    private static var startAnimationTimer_MethodID_24: jmethodID?

    open func startAnimationTimer() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startAnimationTimer", methodSig: "()V", methodCache: &BasicProgressBarUI.startAnimationTimer_MethodID_24, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicProgressBarUI.stopAnimationTimer()

    private static var stopAnimationTimer_MethodID_25: jmethodID?

    open func stopAnimationTimer() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "stopAnimationTimer", methodSig: "()V", methodCache: &BasicProgressBarUI.stopAnimationTimer_MethodID_25, args: &__args, locals: &__locals )
    }
