...
open class BasicProgressBarUI: ProgressBarUI {
    ...
    open func installDefaults() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &BasicProgressBarUI.installDefaults_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicProgressBarUI.installListeners_MethodID_7, args: &__args, locals: &__locals )
    }
