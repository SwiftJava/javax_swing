...
open class BasicToolBarUI_DockingListener: java_swift.JavaObject, MouseInputListener {
    ...
    open var isDragging: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "isDragging", fieldType: "Z", fieldCache: &BasicToolBarUI_DockingListener.isDragging_FieldID, object: javaObject )
    ...
    open var origin: java_awt.Point! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "origin", fieldType: "Ljava/awt/Point;", fieldCache: &BasicToolBarUI_DockingListener.origin_FieldID, object: javaObject )
    ...
    open var toolBar: JToolBar! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "toolBar", fieldType: "Ljavax/swing/JToolBar;", fieldCache: &BasicToolBarUI_DockingListener.toolBar_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open func mouseClicked( e: java_awt.MouseEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseClicked", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mouseClicked_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func mouseDragged( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseDragged", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mouseDragged_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    open func mouseEntered( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseEntered", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mouseEntered_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    open func mouseMoved( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseMoved", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mouseMoved_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func mousePressed( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mousePressed", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mousePressed_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func mouseReleased( e: java_awt.MouseEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "mouseReleased", methodSig: "(Ljava/awt/event/MouseEvent;)V", methodCache: &BasicToolBarUI_DockingListener.mouseReleased_MethodID_8, args: &__args, locals: &__locals )
    }
