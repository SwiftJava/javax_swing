...
open class GroupLayout_ParallelGroup: GroupLayout_Group {
    ...
    open func addGap( pref: Int ) -> GroupLayout_Group! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "addGap", methodSig: "(I)Ljavax/swing/GroupLayout$Group;", methodCache: &GroupLayout_ParallelGroup.addGap_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
