...
open class TableModelEvent: java_util.EventObject {
    ...
    public convenience init( source: TableModel?, firstRow: Int, lastRow: Int, column: Int, type: Int ) {
        ...
        __args[1] = JNIType.toJava( value: firstRow, locals: &__locals )
        __args[2] = JNIType.toJava( value: lastRow, locals: &__locals )
        __args[3] = JNIType.toJava( value: column, locals: &__locals )
        __args[4] = JNIType.toJava( value: type, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/event/TableModelEvent", classCache: &TableModelEvent.TableModelEventJNIClass, methodSig: "(Ljavax/swing/table/TableModel;IIII)V", methodCache: &TableModelEvent.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( source: TableModel?, firstRow: Int, lastRow: Int, column: Int ) {
        ...
        __args[2] = JNIType.toJava( value: lastRow, locals: &__locals )
        __args[3] = JNIType.toJava( value: column, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/event/TableModelEvent", classCache: &TableModelEvent.TableModelEventJNIClass, methodSig: "(Ljavax/swing/table/TableModel;III)V", methodCache: &TableModelEvent.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( source: TableModel?, row: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/event/TableModelEvent", classCache: &TableModelEvent.TableModelEventJNIClass, methodSig: "(Ljavax/swing/table/TableModel;I)V", methodCache: &TableModelEvent.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( source: TableModel? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: source, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/event/TableModelEvent", classCache: &TableModelEvent.TableModelEventJNIClass, methodSig: "(Ljavax/swing/table/TableModel;)V", methodCache: &TableModelEvent.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    private static var getFirstRow_MethodID_9: jmethodID?

    open func getFirstRow() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getFirstRow", methodSig: "()I", methodCache: &TableModelEvent.getFirstRow_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
