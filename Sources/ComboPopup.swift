...
open class ComboPopupForward: JNIObjectForward, ComboPopup {
    ...
    private static var hide_MethodID_9: jmethodID?

    open func hide() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "hide", methodSig: "()V", methodCache: &ComboPopupForward.hide_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var show_MethodID_11: jmethodID?

    open func show() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "show", methodSig: "()V", methodCache: &ComboPopupForward.show_MethodID_11, args: &__args, locals: &__locals )
    }


    /// public abstract boolean javax.swing.plaf.basic.ComboPopup.isVisible()

    private static var isVisible_MethodID_12: jmethodID?

    open func isVisible() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isVisible", methodSig: "()Z", methodCache: &ComboPopupForward.isVisible_MethodID_12, args: &__args, locals: &__locals )
