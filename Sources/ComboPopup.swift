...
open class ComboPopupForward: JNIObjectForward, ComboPopup {
    ...
    open func isVisible() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isVisible", methodSig: "()Z", methodCache: &ComboPopupForward.isVisible_MethodID_10, args: &__args, locals: &__locals )
    ...
    private static var show_MethodID_12: jmethodID?

    open func show() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "show", methodSig: "()V", methodCache: &ComboPopupForward.show_MethodID_12, args: &__args, locals: &__locals )
    }
