...
open class LayerUI: ComponentUI, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open func addPropertyChangeListener( propertyName: String?, listener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addPropertyChangeListener", methodSig: "(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V", methodCache: &LayerUI.addPropertyChangeListener_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    open func addPropertyChangeListener( listener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addPropertyChangeListener", methodSig: "(Ljava/beans/PropertyChangeListener;)V", methodCache: &LayerUI.addPropertyChangeListener_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var applyPropertyChange_MethodID_4: jmethodID?

    open func applyPropertyChange( evt: /* class java.beans.PropertyChangeEvent */ UnavailableObject?, l: JLayer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = JNIType.toJava( value: evt, locals: &__locals )
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "applyPropertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.applyPropertyChange_MethodID_4, args: &__args, locals: &__locals )
    }

    open func applyPropertyChange( _ _evt: /* class java.beans.PropertyChangeEvent */ UnavailableObject?, _ _l: JLayer? ) {
        applyPropertyChange( evt: _evt, l: _l )
    }

    /// public void javax.swing.plaf.LayerUI.doLayout(javax.swing.JLayer)

    private static var doLayout_MethodID_5: jmethodID?

    open func doLayout( l: JLayer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "doLayout", methodSig: "(Ljavax/swing/JLayer;)V", methodCache: &LayerUI.doLayout_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var eventDispatched_MethodID_6: jmethodID?
    ...
    open func eventDispatched( e: java_awt.AWTEvent?, l: JLayer? ) {
        ...
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "eventDispatched", methodSig: "(Ljava/awt/AWTEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.eventDispatched_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func firePropertyChange( propertyName: String?, oldValue: java_swift.JavaObject?, newValue: java_swift.JavaObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "firePropertyChange", methodSig: "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", methodCache: &LayerUI.firePropertyChange_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func getPropertyChangeListeners( propertyName: String? ) -> [/* interface java.beans.PropertyChangeListener */ UnavailableProtocol]! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: propertyName, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPropertyChangeListeners", methodSig: "(Ljava/lang/String;)[Ljava/beans/PropertyChangeListener;", methodCache: &LayerUI.getPropertyChangeListeners_MethodID_8, args: &__args, locals: &__locals )
    ...
    open func getPropertyChangeListeners() -> [/* interface java.beans.PropertyChangeListener */ UnavailableProtocol]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPropertyChangeListeners", methodSig: "()[Ljava/beans/PropertyChangeListener;", methodCache: &LayerUI.getPropertyChangeListeners_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [/* interface java.beans.PropertyChangeListener */ UnavailableProtocolForward].self, from: __return )
    }
    ...
    private static var paintImmediately_MethodID_10: jmethodID?
    ...
    open func paintImmediately( x: Int, y: Int, width: Int, height: Int, l: JLayer? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintImmediately", methodSig: "(IIIILjavax/swing/JLayer;)V", methodCache: &LayerUI.paintImmediately_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var processComponentEvent_MethodID_11: jmethodID?
    ...
    open func processComponentEvent( e: java_awt.ComponentEvent?, l: JLayer? ) {
        ...
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processComponentEvent", methodSig: "(Ljava/awt/event/ComponentEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.processComponentEvent_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func processFocusEvent( e: java_awt.FocusEvent?, l: JLayer? ) {
        ...
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processFocusEvent", methodSig: "(Ljava/awt/event/FocusEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.processFocusEvent_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var processHierarchyEvent_MethodID_14: jmethodID?
    ...
    open func processHierarchyEvent( e: java_awt.HierarchyEvent?, l: JLayer? ) {
        ...
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processHierarchyEvent", methodSig: "(Ljava/awt/event/HierarchyEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.processHierarchyEvent_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func processInputMethodEvent( e: java_awt.InputMethodEvent?, l: JLayer? ) {
        ...
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        __args[1] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processInputMethodEvent", methodSig: "(Ljava/awt/event/InputMethodEvent;Ljavax/swing/JLayer;)V", methodCache: &LayerUI.processInputMethodEvent_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func removePropertyChangeListener( propertyName: String?, listener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol? ) {
        ...
        __args[0] = JNIType.toJava( value: propertyName, locals: &__locals )
        __args[1] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removePropertyChangeListener", methodSig: "(Ljava/lang/String;Ljava/beans/PropertyChangeListener;)V", methodCache: &LayerUI.removePropertyChangeListener_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    open func removePropertyChangeListener( listener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removePropertyChangeListener", methodSig: "(Ljava/beans/PropertyChangeListener;)V", methodCache: &LayerUI.removePropertyChangeListener_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var updateUI_MethodID_22: jmethodID?

    open func updateUI( l: JLayer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateUI", methodSig: "(Ljavax/swing/JLayer;)V", methodCache: &LayerUI.updateUI_MethodID_22, args: &__args, locals: &__locals )
    }
