...
open class SizeSequence: java_swift.JavaObject {
    ...
    private static var insertEntries_MethodID_7: jmethodID?
    ...
    open func insertEntries( start: Int, length: Int, value: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertEntries", methodSig: "(III)V", methodCache: &SizeSequence.insertEntries_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var removeEntries_MethodID_8: jmethodID?
    ...
    open func removeEntries( start: Int, length: Int ) {
        ...
        __args[0] = JNIType.toJava( value: start, locals: &__locals )
        __args[1] = JNIType.toJava( value: length, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeEntries", methodSig: "(II)V", methodCache: &SizeSequence.removeEntries_MethodID_8, args: &__args, locals: &__locals )
    }
