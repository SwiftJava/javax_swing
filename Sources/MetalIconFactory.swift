...
open class MetalIconFactory: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open class func getTreeFolderIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getTreeFolderIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getTreeFolderIcon_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
    ...
    private static var getMenuItemArrowIcon_MethodID_22: jmethodID?

    open class func getMenuItemArrowIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getMenuItemArrowIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getMenuItemArrowIcon_MethodID_22, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
    ...
    private static var getCheckBoxIcon_MethodID_23: jmethodID?

    open class func getCheckBoxIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getCheckBoxIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getCheckBoxIcon_MethodID_23, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
    ...
    private static var getRadioButtonIcon_MethodID_24: jmethodID?

    open class func getRadioButtonIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getRadioButtonIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getRadioButtonIcon_MethodID_24, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
    ...
    private static var getCheckBoxMenuItemIcon_MethodID_25: jmethodID?

    open class func getCheckBoxMenuItemIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getCheckBoxMenuItemIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getCheckBoxMenuItemIcon_MethodID_25, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
    ...
    private static var getRadioButtonMenuItemIcon_MethodID_26: jmethodID?

    open class func getRadioButtonMenuItemIcon() -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalIconFactory", classCache: &MetalIconFactoryJNIClass, methodName: "getRadioButtonMenuItemIcon", methodSig: "()Ljavax/swing/Icon;", methodCache: &getRadioButtonMenuItemIcon_MethodID_26, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? IconForward( javaObject: __return ) : nil
    }
