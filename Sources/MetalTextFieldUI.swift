...
open class MetalTextFieldUI: BasicTextFieldUI {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.plaf.metal.MetalTextFieldUI", file, line ) {
            return nil
        }
    ...
    override open func propertyChange( arg0: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &MetalTextFieldUI.propertyChange_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    override open class func createUI( arg0: JComponent? ) -> ComponentUI! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/metal/MetalTextFieldUI", classCache: &MetalTextFieldUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_3, args: &__args, locals: &__locals )
