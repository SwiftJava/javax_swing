...
open class ElementForward: JNIObjectForward, Element {
    ...
    open func isLeaf() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isLeaf", methodSig: "()Z", methodCache: &ElementForward.isLeaf_MethodID_13, args: &__args, locals: &__locals )
    ...
    private static var getElementCount_MethodID_15: jmethodID?

    open func getElementCount() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getElementCount", methodSig: "()I", methodCache: &ElementForward.getElementCount_MethodID_15, args: &__args, locals: &__locals )
