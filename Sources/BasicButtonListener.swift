...
open class BasicButtonListener: java_swift.JavaObject, java_awt.MouseListener, java_awt.MouseMotionListener, java_awt.FocusListener, ChangeListener, /* java.beans.PropertyChangeListener */ UnclassedProtocol {
    ...
    open func stateChanged( e: ChangeEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "stateChanged", methodSig: "(Ljavax/swing/event/ChangeEvent;)V", methodCache: &BasicButtonListener.stateChanged_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var uninstallKeyboardActions_MethodID_6: jmethodID?

    open func uninstallKeyboardActions( c: JComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallKeyboardActions", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &BasicButtonListener.uninstallKeyboardActions_MethodID_6, args: &__args, locals: &__locals )
    }
