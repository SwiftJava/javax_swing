...
open class AbstractCellEditor: java_swift.JavaObject, CellEditor, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var addCellEditorListener_MethodID_6: jmethodID?

    open func addCellEditorListener( l: CellEditorListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addCellEditorListener", methodSig: "(Ljavax/swing/event/CellEditorListener;)V", methodCache: &AbstractCellEditor.addCellEditorListener_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    open func removeCellEditorListener( l: CellEditorListener? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeCellEditorListener", methodSig: "(Ljavax/swing/event/CellEditorListener;)V", methodCache: &AbstractCellEditor.removeCellEditorListener_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var getCellEditorListeners_MethodID_8: jmethodID?

    open func getCellEditorListeners() -> [CellEditorListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getCellEditorListeners", methodSig: "()[Ljavax/swing/event/CellEditorListener;", methodCache: &AbstractCellEditor.getCellEditorListeners_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var fireEditingStopped_MethodID_9: jmethodID?

    open func fireEditingStopped() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireEditingStopped", methodSig: "()V", methodCache: &AbstractCellEditor.fireEditingStopped_MethodID_9, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.AbstractCellEditor.fireEditingCanceled()

    private static var fireEditingCanceled_MethodID_10: jmethodID?

    open func fireEditingCanceled() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireEditingCanceled", methodSig: "()V", methodCache: &AbstractCellEditor.fireEditingCanceled_MethodID_10, args: &__args, locals: &__locals )
    }
