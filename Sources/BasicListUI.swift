...
open class BasicListUI: ListUI {
    ...
    open var cellHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "cellHeight", fieldType: "I", fieldCache: &BasicListUI.cellHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    open var cellHeights: [Int32]! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "cellHeights", fieldType: "[I", fieldCache: &BasicListUI.cellHeights_FieldID, object: javaObject )
    ...
    open var cellWidth: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "cellWidth", fieldType: "I", fieldCache: &BasicListUI.cellWidth_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var focusListener: java_awt.FocusListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "focusListener", fieldType: "Ljava/awt/event/FocusListener;", fieldCache: &BasicListUI.focusListener_FieldID, object: javaObject )
    ...
    open var list: JList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "list", fieldType: "Ljavax/swing/JList;", fieldCache: &BasicListUI.list_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var listDataListener: ListDataListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listDataListener", fieldType: "Ljavax/swing/event/ListDataListener;", fieldCache: &BasicListUI.listDataListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var listSelectionListener: ListSelectionListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listSelectionListener", fieldType: "Ljavax/swing/event/ListSelectionListener;", fieldCache: &BasicListUI.listSelectionListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var mouseInputListener: MouseInputListener! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "mouseInputListener", fieldType: "Ljavax/swing/event/MouseInputListener;", fieldCache: &BasicListUI.mouseInputListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var propertyChangeListener: /* interface java.beans.PropertyChangeListener */ UnavailableProtocol! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "propertyChangeListener", fieldType: "Ljava/beans/PropertyChangeListener;", fieldCache: &BasicListUI.propertyChangeListener_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var rendererPane: CellRendererPane! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "rendererPane", fieldType: "Ljavax/swing/CellRendererPane;", fieldCache: &BasicListUI.rendererPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    open var updateLayoutStateNeeded: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "updateLayoutStateNeeded", fieldType: "I", fieldCache: &BasicListUI.updateLayoutStateNeeded_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    private static var convertRowToY_MethodID_3: jmethodID?

    open func convertRowToY( row: Int ) -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(row) )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "convertRowToY", methodSig: "(I)I", methodCache: &BasicListUI.convertRowToY_MethodID_3, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var convertYToRow_MethodID_4: jmethodID?

    open func convertYToRow( y0: Int ) -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(y0) )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "convertYToRow", methodSig: "(I)I", methodCache: &BasicListUI.convertYToRow_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func createFocusListener() -> java_awt.FocusListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFocusListener", methodSig: "()Ljava/awt/event/FocusListener;", methodCache: &BasicListUI.createFocusListener_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createListDataListener_MethodID_6: jmethodID?

    open func createListDataListener() -> ListDataListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createListDataListener", methodSig: "()Ljavax/swing/event/ListDataListener;", methodCache: &BasicListUI.createListDataListener_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createListSelectionListener_MethodID_7: jmethodID?

    open func createListSelectionListener() -> ListSelectionListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createListSelectionListener", methodSig: "()Ljavax/swing/event/ListSelectionListener;", methodCache: &BasicListUI.createListSelectionListener_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createMouseInputListener_MethodID_8: jmethodID?

    open func createMouseInputListener() -> MouseInputListener! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createMouseInputListener", methodSig: "()Ljavax/swing/event/MouseInputListener;", methodCache: &BasicListUI.createMouseInputListener_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createPropertyChangeListener() -> /* interface java.beans.PropertyChangeListener */ UnavailableProtocol! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPropertyChangeListener", methodSig: "()Ljava/beans/PropertyChangeListener;", methodCache: &BasicListUI.createPropertyChangeListener_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getRowHeight( row: Int ) -> Int {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(row) )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRowHeight", methodSig: "(I)I", methodCache: &BasicListUI.getRowHeight_MethodID_10, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func installKeyboardActions() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installKeyboardActions", methodSig: "()V", methodCache: &BasicListUI.installKeyboardActions_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func installListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &BasicListUI.installListeners_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var maybeUpdateLayoutState_MethodID_14: jmethodID?

    open func maybeUpdateLayoutState() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "maybeUpdateLayoutState", methodSig: "()V", methodCache: &BasicListUI.maybeUpdateLayoutState_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func paintCell( g: java_awt.Graphics?, row: Int, rowBounds: java_awt.Rectangle?, cellRenderer: ListCellRenderer?, dataModel: ListModel?, selModel: ListSelectionModel?, leadIndex: Int ) {
        ...
        __args[2] = JNIType.toJava( value: rowBounds, locals: &__locals )
        ...
        __args[6] = jvalue( i: jint(leadIndex) )
    ...
    private static var selectNextIndex_MethodID_16: jmethodID?

    open func selectNextIndex() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectNextIndex", methodSig: "()V", methodCache: &BasicListUI.selectNextIndex_MethodID_16, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.basic.BasicListUI.selectPreviousIndex()

    private static var selectPreviousIndex_MethodID_17: jmethodID?

    open func selectPreviousIndex() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "selectPreviousIndex", methodSig: "()V", methodCache: &BasicListUI.selectPreviousIndex_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallDefaults() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallDefaults", methodSig: "()V", methodCache: &BasicListUI.uninstallDefaults_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallKeyboardActions() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallKeyboardActions", methodSig: "()V", methodCache: &BasicListUI.uninstallKeyboardActions_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    open func uninstallListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "uninstallListeners", methodSig: "()V", methodCache: &BasicListUI.uninstallListeners_MethodID_20, args: &__args, locals: &__locals )
    }
