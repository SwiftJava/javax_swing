...
open class BasicTextUI: TextUI, ViewFactory {
    ...
    open func modelToView( tc: JTextComponent?, pos: Int ) throws /* javax.swing.text.BadLocationException */ -> java_awt.Rectangle! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "modelToView", methodSig: "(Ljavax/swing/text/JTextComponent;I)Ljava/awt/Rectangle;", methodCache: &BasicTextUI.modelToView_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func propertyChange( evt: /* java.beans.PropertyChangeEvent */ UnclassedObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &BasicTextUI.propertyChange_MethodID_17, args: &__args, locals: &__locals )
    }
