...
open class FileSystemView: java_swift.JavaObject {
    ...
    private static var isTraversable_MethodID_2: jmethodID?
    ...
    open func isTraversable( f: /* java.io.File */ UnclassedObject? ) -> java_lang.Boolean! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "isTraversable", methodSig: "(Ljava/io/File;)Ljava/lang/Boolean;", methodCache: &FileSystemView.isTraversable_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getFileSystemView_MethodID_3: jmethodID?

    open class func getFileSystemView() -> FileSystemView! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/filechooser/FileSystemView", classCache: &FileSystemViewJNIClass, methodName: "getFileSystemView", methodSig: "()Ljavax/swing/filechooser/FileSystemView;", methodCache: &getFileSystemView_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createFileObject( path: String? ) -> /* java.io.File */ UnclassedObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFileObject", methodSig: "(Ljava/lang/String;)Ljava/io/File;", methodCache: &FileSystemView.createFileObject_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isParent_MethodID_6: jmethodID?
    ...
    open func isParent( folder: /* java.io.File */ UnclassedObject?, file: /* java.io.File */ UnclassedObject? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isParent", methodSig: "(Ljava/io/File;Ljava/io/File;)Z", methodCache: &FileSystemView.isParent_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var getDefaultDirectory_MethodID_7: jmethodID?

    open func getDefaultDirectory() -> /* java.io.File */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDefaultDirectory", methodSig: "()Ljava/io/File;", methodCache: &FileSystemView.getDefaultDirectory_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* java.io.File */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    private static var getParentDirectory_MethodID_8: jmethodID?

    open func getParentDirectory( dir: /* java.io.File */ UnclassedObject? ) -> /* java.io.File */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dir != nil ? dir! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getParentDirectory", methodSig: "(Ljava/io/File;)Ljava/io/File;", methodCache: &FileSystemView.getParentDirectory_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* java.io.File */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    private static var isRoot_MethodID_9: jmethodID?

    open func isRoot( f: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isRoot", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isRoot_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var getSystemDisplayName_MethodID_10: jmethodID?

    open func getSystemDisplayName( f: /* java.io.File */ UnclassedObject? ) -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSystemDisplayName", methodSig: "(Ljava/io/File;)Ljava/lang/String;", methodCache: &FileSystemView.getSystemDisplayName_MethodID_10, args: &__args, locals: &__locals )
    ...
    private static var getSystemTypeDescription_MethodID_11: jmethodID?

    open func getSystemTypeDescription( f: /* java.io.File */ UnclassedObject? ) -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSystemTypeDescription", methodSig: "(Ljava/io/File;)Ljava/lang/String;", methodCache: &FileSystemView.getSystemTypeDescription_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: String(), from: __return )
    }
    ...
    private static var getSystemIcon_MethodID_12: jmethodID?

    open func getSystemIcon( f: /* java.io.File */ UnclassedObject? ) -> Icon! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSystemIcon", methodSig: "(Ljava/io/File;)Ljavax/swing/Icon;", methodCache: &FileSystemView.getSystemIcon_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isFileSystem_MethodID_13: jmethodID?

    open func isFileSystem( f: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFileSystem", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isFileSystem_MethodID_13, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var createNewFolder_MethodID_14: jmethodID?
    ...
    open func createNewFolder( containingDir: /* java.io.File */ UnclassedObject? ) throws /* java.io.IOException */ -> /* java.io.File */ UnclassedObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createNewFolder", methodSig: "(Ljava/io/File;)Ljava/io/File;", methodCache: &FileSystemView.createNewFolder_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isHiddenFile_MethodID_15: jmethodID?

    open func isHiddenFile( f: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isHiddenFile", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isHiddenFile_MethodID_15, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isFileSystemRoot_MethodID_16: jmethodID?

    open func isFileSystemRoot( dir: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dir != nil ? dir! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFileSystemRoot", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isFileSystemRoot_MethodID_16, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isFloppyDrive_MethodID_18: jmethodID?

    open func isFloppyDrive( dir: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dir != nil ? dir! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFloppyDrive", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isFloppyDrive_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var isComputerNode_MethodID_19: jmethodID?

    open func isComputerNode( dir: /* java.io.File */ UnclassedObject? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dir != nil ? dir! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isComputerNode", methodSig: "(Ljava/io/File;)Z", methodCache: &FileSystemView.isComputerNode_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var getRoots_MethodID_20: jmethodID?

    open func getRoots() -> [/* java.io.File */ UnclassedObject]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getRoots", methodSig: "()[Ljava/io/File;", methodCache: &FileSystemView.getRoots_MethodID_20, args: &__args, locals: &__locals )
    ...
    private static var getHomeDirectory_MethodID_21: jmethodID?

    open func getHomeDirectory() -> /* java.io.File */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getHomeDirectory", methodSig: "()Ljava/io/File;", methodCache: &FileSystemView.getHomeDirectory_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* java.io.File */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    private static var createFileSystemRoot_MethodID_22: jmethodID?

    open func createFileSystemRoot( f: /* java.io.File */ UnclassedObject? ) -> /* java.io.File */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: f != nil ? f! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFileSystemRoot", methodSig: "(Ljava/io/File;)Ljava/io/File;", methodCache: &FileSystemView.createFileSystemRoot_MethodID_22, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? /* java.io.File */ UnclassedObject( javaObject: __return ) : nil
    }
    ...
    private static var getFiles_MethodID_23: jmethodID?
    ...
    open func getFiles( dir: /* java.io.File */ UnclassedObject?, useFileHiding: Bool ) -> [/* java.io.File */ UnclassedObject]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFiles", methodSig: "(Ljava/io/File;Z)[Ljava/io/File;", methodCache: &FileSystemView.getFiles_MethodID_23, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [/* java.io.File */ UnclassedObject](), from: __return )
    }
