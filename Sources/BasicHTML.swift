...
open class BasicHTML: java_swift.JavaObject {
    ...
    private static var createHTMLView_MethodID_2: jmethodID?
    ...
    open class func createHTMLView( c: JComponent?, html: String? ) -> View! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/basic/BasicHTML", classCache: &BasicHTMLJNIClass, methodName: "createHTMLView", methodSig: "(Ljavax/swing/JComponent;Ljava/lang/String;)Ljavax/swing/text/View;", methodCache: &createHTMLView_MethodID_2, args: &__args, locals: &__locals )
