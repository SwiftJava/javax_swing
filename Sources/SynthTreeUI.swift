...
open class SynthTreeUI: BasicTreeUI, /* interface java.beans.PropertyChangeListener */ UnavailableProtocol, SynthUI {
    ...
    override open var cellEditor: TreeCellEditor! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "cellEditor", fieldType: "Ljavax/swing/tree/TreeCellEditor;", fieldCache: &SynthTreeUI.cellEditor_FieldID, object: javaObject )
    ...
    override open var collapsedIcon: Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "collapsedIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &SynthTreeUI.collapsedIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var createdCellEditor: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "createdCellEditor", fieldType: "Z", fieldCache: &SynthTreeUI.createdCellEditor_FieldID, object: javaObject )
    ...
    override open var createdRenderer: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "createdRenderer", fieldType: "Z", fieldCache: &SynthTreeUI.createdRenderer_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var currentCellRenderer: TreeCellRenderer! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "currentCellRenderer", fieldType: "Ljavax/swing/tree/TreeCellRenderer;", fieldCache: &SynthTreeUI.currentCellRenderer_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var depthOffset: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "depthOffset", fieldType: "I", fieldCache: &SynthTreeUI.depthOffset_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var drawingCache: java_util.Hashtable! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "drawingCache", fieldType: "Ljava/util/Hashtable;", fieldCache: &SynthTreeUI.drawingCache_FieldID, object: javaObject )
    ...
    override open var editingComponent: java_awt.Component! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "editingComponent", fieldType: "Ljava/awt/Component;", fieldCache: &SynthTreeUI.editingComponent_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var editingPath: TreePath! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "editingPath", fieldType: "Ljavax/swing/tree/TreePath;", fieldCache: &SynthTreeUI.editingPath_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var editingRow: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "editingRow", fieldType: "I", fieldCache: &SynthTreeUI.editingRow_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var editorHasDifferentSize: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "editorHasDifferentSize", fieldType: "Z", fieldCache: &SynthTreeUI.editorHasDifferentSize_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var expandedIcon: Icon! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "expandedIcon", fieldType: "Ljavax/swing/Icon;", fieldCache: &SynthTreeUI.expandedIcon_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? IconForward( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var largeModel: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "largeModel", fieldType: "Z", fieldCache: &SynthTreeUI.largeModel_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var lastSelectedRow: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "lastSelectedRow", fieldType: "I", fieldCache: &SynthTreeUI.lastSelectedRow_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var leftChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "leftChildIndent", fieldType: "I", fieldCache: &SynthTreeUI.leftChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var nodeDimensions: AbstractLayoutCache_NodeDimensions! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "nodeDimensions", fieldType: "Ljavax/swing/tree/AbstractLayoutCache$NodeDimensions;", fieldCache: &SynthTreeUI.nodeDimensions_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var preferredMinSize: java_awt.Dimension! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "preferredMinSize", fieldType: "Ljava/awt/Dimension;", fieldCache: &SynthTreeUI.preferredMinSize_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var preferredSize: java_awt.Dimension! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "preferredSize", fieldType: "Ljava/awt/Dimension;", fieldCache: &SynthTreeUI.preferredSize_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
            return __value != nil ? java_awt.Dimension( javaObject: __value ) : nil
        }
        set(newValue) {
    ...
    override open var rendererPane: CellRendererPane! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "rendererPane", fieldType: "Ljavax/swing/CellRendererPane;", fieldCache: &SynthTreeUI.rendererPane_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var rightChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "rightChildIndent", fieldType: "I", fieldCache: &SynthTreeUI.rightChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var stopEditingInCompleteEditing: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "stopEditingInCompleteEditing", fieldType: "Z", fieldCache: &SynthTreeUI.stopEditingInCompleteEditing_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var totalChildIndent: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "totalChildIndent", fieldType: "I", fieldCache: &SynthTreeUI.totalChildIndent_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var tree: JTree! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "tree", fieldType: "Ljavax/swing/JTree;", fieldCache: &SynthTreeUI.tree_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeModel: TreeModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeModel", fieldType: "Ljavax/swing/tree/TreeModel;", fieldCache: &SynthTreeUI.treeModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeSelectionModel: TreeSelectionModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeSelectionModel", fieldType: "Ljavax/swing/tree/TreeSelectionModel;", fieldCache: &SynthTreeUI.treeSelectionModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeState: AbstractLayoutCache! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeState", fieldType: "Ljavax/swing/tree/AbstractLayoutCache;", fieldCache: &SynthTreeUI.treeState_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var validCachedPreferredSize: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "validCachedPreferredSize", fieldType: "Z", fieldCache: &SynthTreeUI.validCachedPreferredSize_FieldID, object: javaObject )
            return __value != jboolean(JNI_FALSE)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open class func createUI( x: JComponent? ) -> ComponentUI! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/plaf/synth/SynthTreeUI", classCache: &SynthTreeUIJNIClass, methodName: "createUI", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/ComponentUI;", methodCache: &createUI_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var createDefaultCellEditor_MethodID_3: jmethodID?

    override open func createDefaultCellEditor() -> TreeCellEditor! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createDefaultCellEditor", methodSig: "()Ljavax/swing/tree/TreeCellEditor;", methodCache: &SynthTreeUI.createDefaultCellEditor_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createDefaultCellRenderer_MethodID_4: jmethodID?

    override open func createDefaultCellRenderer() -> TreeCellRenderer! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createDefaultCellRenderer", methodSig: "()Ljavax/swing/tree/TreeCellRenderer;", methodCache: &SynthTreeUI.createDefaultCellRenderer_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var drawCentered_MethodID_5: jmethodID?
    ...
    override open func drawCentered( c: java_awt.Component?, graphics: java_awt.Graphics?, icon: Icon?, x: Int, y: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "drawCentered", methodSig: "(Ljava/awt/Component;Ljava/awt/Graphics;Ljavax/swing/Icon;II)V", methodCache: &SynthTreeUI.drawCentered_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    open func getContext( c: JComponent? ) -> SynthContext! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getContext", methodSig: "(Ljavax/swing/JComponent;)Ljavax/swing/plaf/synth/SynthContext;", methodCache: &SynthTreeUI.getContext_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getRowX_MethodID_7: jmethodID?
    ...
    override open func getRowX( row: Int, depth: Int ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRowX", methodSig: "(II)I", methodCache: &SynthTreeUI.getRowX_MethodID_7, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    override open func installDefaults() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installDefaults", methodSig: "()V", methodCache: &SynthTreeUI.installDefaults_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    override open func installListeners() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installListeners", methodSig: "()V", methodCache: &SynthTreeUI.installListeners_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func paint( context: SynthContext?, g: java_awt.Graphics? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Graphics;)V", methodCache: &SynthTreeUI.paint_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    open func paintBorder( context: SynthContext?, g: java_awt.Graphics?, x: Int, y: Int, w: Int, h: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintBorder", methodSig: "(Ljavax/swing/plaf/synth/SynthContext;Ljava/awt/Graphics;IIII)V", methodCache: &SynthTreeUI.paintBorder_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var paintDropLine_MethodID_12: jmethodID?

    override open func paintDropLine( g: java_awt.Graphics? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: g, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintDropLine", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &SynthTreeUI.paintDropLine_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    override open func paintExpandControl( g: java_awt.Graphics?, clipBounds: java_awt.Rectangle?, insets: java_awt.Insets?, bounds: java_awt.Rectangle?, path: TreePath?, row: Int, isExpanded: Bool, hasBeenExpanded: Bool, isLeaf: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintExpandControl", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Insets;Ljava/awt/Rectangle;Ljavax/swing/tree/TreePath;IZZZ)V", methodCache: &SynthTreeUI.paintExpandControl_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var paintHorizontalLine_MethodID_14: jmethodID?
    ...
    override open func paintHorizontalLine( g: java_awt.Graphics?, c: JComponent?, y: Int, left: Int, right: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintHorizontalLine", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;III)V", methodCache: &SynthTreeUI.paintHorizontalLine_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var paintHorizontalPartOfLeg_MethodID_15: jmethodID?
    ...
    override open func paintHorizontalPartOfLeg( g: java_awt.Graphics?, clipBounds: java_awt.Rectangle?, insets: java_awt.Insets?, bounds: java_awt.Rectangle?, path: TreePath?, row: Int, isExpanded: Bool, hasBeenExpanded: Bool, isLeaf: Bool ) {
        ...
        __args[7] = jvalue( z: jboolean(hasBeenExpanded ? JNI_TRUE : JNI_FALSE) )
        __args[8] = jvalue( z: jboolean(isLeaf ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintHorizontalPartOfLeg", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Insets;Ljava/awt/Rectangle;Ljavax/swing/tree/TreePath;IZZZ)V", methodCache: &SynthTreeUI.paintHorizontalPartOfLeg_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var paintVerticalLine_MethodID_16: jmethodID?
    ...
    override open func paintVerticalLine( g: java_awt.Graphics?, c: JComponent?, x: Int, top: Int, bottom: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintVerticalLine", methodSig: "(Ljava/awt/Graphics;Ljavax/swing/JComponent;III)V", methodCache: &SynthTreeUI.paintVerticalLine_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var paintVerticalPartOfLeg_MethodID_17: jmethodID?
    ...
    override open func paintVerticalPartOfLeg( g: java_awt.Graphics?, clipBounds: java_awt.Rectangle?, insets: java_awt.Insets?, path: TreePath? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paintVerticalPartOfLeg", methodSig: "(Ljava/awt/Graphics;Ljava/awt/Rectangle;Ljava/awt/Insets;Ljavax/swing/tree/TreePath;)V", methodCache: &SynthTreeUI.paintVerticalPartOfLeg_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    open func propertyChange( evt: /* class java.beans.PropertyChangeEvent */ UnavailableObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "propertyChange", methodSig: "(Ljava/beans/PropertyChangeEvent;)V", methodCache: &SynthTreeUI.propertyChange_MethodID_18, args: &__args, locals: &__locals )
    }
