...
open class JColorChooser: JComponent {
    ...
    override open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JColorChooser.paramString_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var setDragEnabled_MethodID_6: jmethodID?

    open func setDragEnabled( b: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: b, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDragEnabled", methodSig: "(Z)V", methodCache: &JColorChooser.setDragEnabled_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var getDragEnabled_MethodID_7: jmethodID?

    open func getDragEnabled() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "getDragEnabled", methodSig: "()Z", methodCache: &JColorChooser.getDragEnabled_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var setSelectionModel_MethodID_8: jmethodID?

    open func setSelectionModel( newModel: ColorSelectionModel? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: newModel, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectionModel", methodSig: "(Ljavax/swing/colorchooser/ColorSelectionModel;)V", methodCache: &JColorChooser.setSelectionModel_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    private static var getSelectionModel_MethodID_9: jmethodID?

    open func getSelectionModel() -> ColorSelectionModel! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionModel", methodSig: "()Ljavax/swing/colorchooser/ColorSelectionModel;", methodCache: &JColorChooser.getSelectionModel_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getColor() -> java_awt.Color! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColor", methodSig: "()Ljava/awt/Color;", methodCache: &JColorChooser.getColor_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setColor_MethodID_11: jmethodID?

    open func setColor( c: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setColor", methodSig: "(I)V", methodCache: &JColorChooser.setColor_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var setColor_MethodID_12: jmethodID?
    ...
    open func setColor( r: Int, g: Int, b: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setColor", methodSig: "(III)V", methodCache: &JColorChooser.setColor_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    open func setColor( color: java_awt.Color? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setColor", methodSig: "(Ljava/awt/Color;)V", methodCache: &JColorChooser.setColor_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open class func createDialog( c: java_awt.Component?, title: String?, modal: Bool, chooserPane: JColorChooser?, okListener: java_awt.ActionListener?, cancelListener: java_awt.ActionListener? ) throws /* java.awt.HeadlessException */ -> JDialog! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/JColorChooser", classCache: &JColorChooserJNIClass, methodName: "createDialog", methodSig: "(Ljava/awt/Component;Ljava/lang/String;ZLjavax/swing/JColorChooser;Ljava/awt/event/ActionListener;Ljava/awt/event/ActionListener;)Ljavax/swing/JDialog;", methodCache: &createDialog_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var showDialog_MethodID_15: jmethodID?
    ...
    open class func showDialog( component: java_awt.Component?, title: String?, initialColor: java_awt.Color? ) throws /* java.awt.HeadlessException */ -> java_awt.Color! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "javax/swing/JColorChooser", classCache: &JColorChooserJNIClass, methodName: "showDialog", methodSig: "(Ljava/awt/Component;Ljava/lang/String;Ljava/awt/Color;)Ljava/awt/Color;", methodCache: &showDialog_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw java_awt.HeadlessException( javaObject: throwable )
        }
    ...
    private static var setPreviewPanel_MethodID_16: jmethodID?
    ...
    open func setPreviewPanel( preview: JComponent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setPreviewPanel", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &JColorChooser.setPreviewPanel_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var getPreviewPanel_MethodID_17: jmethodID?

    open func getPreviewPanel() -> JComponent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreviewPanel", methodSig: "()Ljavax/swing/JComponent;", methodCache: &JColorChooser.getPreviewPanel_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var addChooserPanel_MethodID_18: jmethodID?
    ...
    open func addChooserPanel( panel: AbstractColorChooserPanel? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addChooserPanel", methodSig: "(Ljavax/swing/colorchooser/AbstractColorChooserPanel;)V", methodCache: &JColorChooser.addChooserPanel_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var removeChooserPanel_MethodID_19: jmethodID?

    open func removeChooserPanel( panel: AbstractColorChooserPanel? ) -> AbstractColorChooserPanel! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: panel != nil ? panel! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "removeChooserPanel", methodSig: "(Ljavax/swing/colorchooser/AbstractColorChooserPanel;)Ljavax/swing/colorchooser/AbstractColorChooserPanel;", methodCache: &JColorChooser.removeChooserPanel_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setChooserPanels_MethodID_20: jmethodID?

    open func setChooserPanels( panels: [AbstractColorChooserPanel]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: panels, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setChooserPanels", methodSig: "([Ljavax/swing/colorchooser/AbstractColorChooserPanel;)V", methodCache: &JColorChooser.setChooserPanels_MethodID_20, args: &__args, locals: &__locals )
    }
    ...
    private static var getChooserPanels_MethodID_21: jmethodID?

    open func getChooserPanels() -> [AbstractColorChooserPanel]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getChooserPanels", methodSig: "()[Ljavax/swing/colorchooser/AbstractColorChooserPanel;", methodCache: &JColorChooser.getChooserPanels_MethodID_21, args: &__args, locals: &__locals )
