...
open class BasicMenuUI: BasicMenuItemUI {
    ...
    override open var acceleratorDelimiter: String! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "acceleratorDelimiter", fieldType: "Ljava/lang/String;", fieldCache: &BasicMenuUI.acceleratorDelimiter_FieldID, object: javaObject, locals: &__locals )
