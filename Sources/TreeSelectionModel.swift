...
open class TreeSelectionModelForward: JNIObjectForward, TreeSelectionModel {
    ...
    open func getSelectionMode() -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSelectionMode", methodSig: "()I", methodCache: &TreeSelectionModelForward.getSelectionMode_MethodID_28, args: &__args, locals: &__locals )
    ...
    private static var setSelectionPath_MethodID_29: jmethodID?

    open func setSelectionPath( path: TreePath? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: path, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectionPath", methodSig: "(Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.setSelectionPath_MethodID_29, args: &__args, locals: &__locals )
    }
    ...
    private static var setSelectionPaths_MethodID_30: jmethodID?

    open func setSelectionPaths( paths: [TreePath]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: paths, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSelectionPaths", methodSig: "([Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.setSelectionPaths_MethodID_30, args: &__args, locals: &__locals )
    }
    ...
    private static var addSelectionPath_MethodID_31: jmethodID?

    open func addSelectionPath( path: TreePath? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: path, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addSelectionPath", methodSig: "(Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.addSelectionPath_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    private static var addSelectionPaths_MethodID_32: jmethodID?

    open func addSelectionPaths( paths: [TreePath]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: paths, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addSelectionPaths", methodSig: "([Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.addSelectionPaths_MethodID_32, args: &__args, locals: &__locals )
    }
    ...
    private static var getSelectionPath_MethodID_34: jmethodID?

    open func getSelectionPath() -> TreePath! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionPath", methodSig: "()Ljavax/swing/tree/TreePath;", methodCache: &TreeSelectionModelForward.getSelectionPath_MethodID_34, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? TreePath( javaObject: __return ) : nil
    }
    ...
    private static var getSelectionPaths_MethodID_35: jmethodID?

    open func getSelectionPaths() -> [TreePath]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionPaths", methodSig: "()[Ljavax/swing/tree/TreePath;", methodCache: &TreeSelectionModelForward.getSelectionPaths_MethodID_35, args: &__args, locals: &__locals )
    ...
    private static var getSelectionRows_MethodID_36: jmethodID?

    open func getSelectionRows() -> [Int32]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSelectionRows", methodSig: "()[I", methodCache: &TreeSelectionModelForward.getSelectionRows_MethodID_36, args: &__args, locals: &__locals )
    ...
    private static var getSelectionCount_MethodID_37: jmethodID?

    open func getSelectionCount() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSelectionCount", methodSig: "()I", methodCache: &TreeSelectionModelForward.getSelectionCount_MethodID_37, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getMinSelectionRow_MethodID_38: jmethodID?

    open func getMinSelectionRow() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMinSelectionRow", methodSig: "()I", methodCache: &TreeSelectionModelForward.getMinSelectionRow_MethodID_38, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getMaxSelectionRow_MethodID_39: jmethodID?

    open func getMaxSelectionRow() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMaxSelectionRow", methodSig: "()I", methodCache: &TreeSelectionModelForward.getMaxSelectionRow_MethodID_39, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getLeadSelectionRow_MethodID_40: jmethodID?

    open func getLeadSelectionRow() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getLeadSelectionRow", methodSig: "()I", methodCache: &TreeSelectionModelForward.getLeadSelectionRow_MethodID_40, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var isPathSelected_MethodID_41: jmethodID?

    open func isPathSelected( path: TreePath? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: path, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isPathSelected", methodSig: "(Ljavax/swing/tree/TreePath;)Z", methodCache: &TreeSelectionModelForward.isPathSelected_MethodID_41, args: &__args, locals: &__locals )
    ...
    private static var removeSelectionPath_MethodID_42: jmethodID?

    open func removeSelectionPath( path: TreePath? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: path, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeSelectionPath", methodSig: "(Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.removeSelectionPath_MethodID_42, args: &__args, locals: &__locals )
    }
    ...
    private static var removeSelectionPaths_MethodID_43: jmethodID?

    open func removeSelectionPaths( paths: [TreePath]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: paths, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeSelectionPaths", methodSig: "([Ljavax/swing/tree/TreePath;)V", methodCache: &TreeSelectionModelForward.removeSelectionPaths_MethodID_43, args: &__args, locals: &__locals )
    }
    ...
    private static var isSelectionEmpty_MethodID_44: jmethodID?

    open func isSelectionEmpty() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSelectionEmpty", methodSig: "()Z", methodCache: &TreeSelectionModelForward.isSelectionEmpty_MethodID_44, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    private static var addTreeSelectionListener_MethodID_45: jmethodID?

    open func addTreeSelectionListener( x: TreeSelectionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addTreeSelectionListener", methodSig: "(Ljavax/swing/event/TreeSelectionListener;)V", methodCache: &TreeSelectionModelForward.addTreeSelectionListener_MethodID_45, args: &__args, locals: &__locals )
    }
    ...
    private static var removeTreeSelectionListener_MethodID_46: jmethodID?

    open func removeTreeSelectionListener( x: TreeSelectionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: x, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeTreeSelectionListener", methodSig: "(Ljavax/swing/event/TreeSelectionListener;)V", methodCache: &TreeSelectionModelForward.removeTreeSelectionListener_MethodID_46, args: &__args, locals: &__locals )
    }
    ...
    private static var setRowMapper_MethodID_47: jmethodID?

    open func setRowMapper( newMapper: RowMapper? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: newMapper, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setRowMapper", methodSig: "(Ljavax/swing/tree/RowMapper;)V", methodCache: &TreeSelectionModelForward.setRowMapper_MethodID_47, args: &__args, locals: &__locals )
    }
    ...
    private static var getRowMapper_MethodID_48: jmethodID?

    open func getRowMapper() -> RowMapper! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getRowMapper", methodSig: "()Ljavax/swing/tree/RowMapper;", methodCache: &TreeSelectionModelForward.getRowMapper_MethodID_48, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var resetRowSelection_MethodID_49: jmethodID?

    open func resetRowSelection() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "resetRowSelection", methodSig: "()V", methodCache: &TreeSelectionModelForward.resetRowSelection_MethodID_49, args: &__args, locals: &__locals )
    }


    /// public abstract void javax.swing.tree.TreeSelectionModel.addPropertyChangeListener(java.beans.PropertyChangeListener)

    private static var addPropertyChangeListener_MethodID_50: jmethodID?
    ...
    open func addPropertyChangeListener( listener: /* java.beans.PropertyChangeListener */ UnclassedProtocol? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addPropertyChangeListener", methodSig: "(Ljava/beans/PropertyChangeListener;)V", methodCache: &TreeSelectionModelForward.addPropertyChangeListener_MethodID_50, args: &__args, locals: &__locals )
    }
    ...
    private static var removePropertyChangeListener_MethodID_51: jmethodID?

    open func removePropertyChangeListener( listener: /* java.beans.PropertyChangeListener */ UnclassedProtocol? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removePropertyChangeListener", methodSig: "(Ljava/beans/PropertyChangeListener;)V", methodCache: &TreeSelectionModelForward.removePropertyChangeListener_MethodID_51, args: &__args, locals: &__locals )
    }
    ...
    private static var clearSelection_MethodID_53: jmethodID?

    open func clearSelection() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "clearSelection", methodSig: "()V", methodCache: &TreeSelectionModelForward.clearSelection_MethodID_53, args: &__args, locals: &__locals )
    }


    /// public abstract boolean javax.swing.tree.TreeSelectionModel.isRowSelected(int)

    private static var isRowSelected_MethodID_54: jmethodID?

    open func isRowSelected( row: Int ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: row, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isRowSelected", methodSig: "(I)Z", methodCache: &TreeSelectionModelForward.isRowSelected_MethodID_54, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
