...
open class TransferHandler_TransferSupport: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "javax.swing.TransferHandler$TransferSupport", file, line ) {
            return nil
        }
    ...
    /// static void javax.swing.TransferHandler$TransferSupport.access$400(javax.swing.TransferHandler$TransferSupport,java.awt.Component,java.awt.dnd.DropTargetEvent)

    /// static boolean javax.swing.TransferHandler$TransferSupport.access$500(javax.swing.TransferHandler$TransferSupport)
    ...
    open func getTransferable() -> java_awt.Transferable! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTransferable", methodSig: "()Ljava/awt/datatransfer/Transferable;", methodCache: &TransferHandler_TransferSupport.getTransferable_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getDataFlavors_MethodID_4: jmethodID?

    open func getDataFlavors() -> [DataFlavor]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDataFlavors", methodSig: "()[Ljava/awt/datatransfer/DataFlavor;", methodCache: &TransferHandler_TransferSupport.getDataFlavors_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func getDropAction() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDropAction", methodSig: "()I", methodCache: &TransferHandler_TransferSupport.getDropAction_MethodID_6, args: &__args, locals: &__locals )
    ...
    open func isDataFlavorSupported( arg0: java_awt.DataFlavor? ) -> Bool {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDataFlavorSupported", methodSig: "(Ljava/awt/datatransfer/DataFlavor;)Z", methodCache: &TransferHandler_TransferSupport.isDataFlavorSupported_MethodID_7, args: &__args, locals: &__locals )
