...
open class TransferHandler_TransferSupport: java_swift.JavaObject {
    ...
    private static var getDropAction_MethodID_2: jmethodID?

    open func getDropAction() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDropAction", methodSig: "()I", methodCache: &TransferHandler_TransferSupport.getDropAction_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func isDataFlavorSupported( arg0: java_awt.DataFlavor? ) -> Bool {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDataFlavorSupported", methodSig: "(Ljava/awt/datatransfer/DataFlavor;)Z", methodCache: &TransferHandler_TransferSupport.isDataFlavorSupported_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var setShowDropLocation_MethodID_4: jmethodID?

    open func setShowDropLocation( arg0: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setShowDropLocation", methodSig: "(Z)V", methodCache: &TransferHandler_TransferSupport.setShowDropLocation_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var setDropAction_MethodID_5: jmethodID?

    open func setDropAction( arg0: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDropAction", methodSig: "(I)V", methodCache: &TransferHandler_TransferSupport.setDropAction_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var getUserDropAction_MethodID_6: jmethodID?

    open func getUserDropAction() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getUserDropAction", methodSig: "()I", methodCache: &TransferHandler_TransferSupport.getUserDropAction_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getSourceDropActions_MethodID_7: jmethodID?

    open func getSourceDropActions() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSourceDropActions", methodSig: "()I", methodCache: &TransferHandler_TransferSupport.getSourceDropActions_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func getTransferable() -> java_awt.Transferable! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTransferable", methodSig: "()Ljava/awt/datatransfer/Transferable;", methodCache: &TransferHandler_TransferSupport.getTransferable_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var getDataFlavors_MethodID_9: jmethodID?

    open func getDataFlavors() -> [DataFlavor]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDataFlavors", methodSig: "()[Ljava/awt/datatransfer/DataFlavor;", methodCache: &TransferHandler_TransferSupport.getDataFlavors_MethodID_9, args: &__args, locals: &__locals )
    ...
    private static var getDropLocation_MethodID_10: jmethodID?

    open func getDropLocation() -> TransferHandler_DropLocation! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDropLocation", methodSig: "()Ljavax/swing/TransferHandler$DropLocation;", methodCache: &TransferHandler_TransferSupport.getDropLocation_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isDrop_MethodID_11: jmethodID?

    open func isDrop() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDrop", methodSig: "()Z", methodCache: &TransferHandler_TransferSupport.isDrop_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func getComponent() -> java_awt.Component! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getComponent", methodSig: "()Ljava/awt/Component;", methodCache: &TransferHandler_TransferSupport.getComponent_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
