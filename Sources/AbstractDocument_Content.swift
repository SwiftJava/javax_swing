...
open class AbstractDocument_ContentForward: JNIObjectForward, AbstractDocument_Content {
    ...
    open func createPosition( offset: Int ) throws /* javax.swing.text.BadLocationException */ -> Position! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createPosition", methodSig: "(I)Ljavax/swing/text/Position;", methodCache: &AbstractDocument_ContentForward.createPosition_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func getString( _where: Int, len: Int ) throws /* javax.swing.text.BadLocationException */ -> String! {
        ...
        __args[0] = jvalue( i: jint(_where) )
        __args[1] = jvalue( i: jint(len) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getString", methodSig: "(II)Ljava/lang/String;", methodCache: &AbstractDocument_ContentForward.getString_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw BadLocationException( javaObject: throwable )
    ...
    open func length() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "length", methodSig: "()I", methodCache: &AbstractDocument_ContentForward.length_MethodID_11, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func remove( _where: Int, nitems: Int ) throws /* javax.swing.text.BadLocationException */ -> UndoableEdit! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "remove", methodSig: "(II)Ljavax/swing/undo/UndoableEdit;", methodCache: &AbstractDocument_ContentForward.remove_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw BadLocationException( javaObject: throwable )
