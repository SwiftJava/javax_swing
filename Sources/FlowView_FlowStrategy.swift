...
open class FlowView_FlowStrategy: java_swift.JavaObject {
    ...
    open func layout( fv: FlowView? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fv != nil ? fv! as JNIObject : nil, locals: &__locals )
    ...
    private static var getLogicalView_MethodID_3: jmethodID?

    open func getLogicalView( fv: FlowView? ) -> View! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fv != nil ? fv! as JNIObject : nil, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLogicalView", methodSig: "(Ljavax/swing/text/FlowView;)Ljavax/swing/text/View;", methodCache: &FlowView_FlowStrategy.getLogicalView_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var layoutRow_MethodID_4: jmethodID?
    ...
    open func layoutRow( fv: FlowView?, rowIndex: Int, pos: Int ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "layoutRow", methodSig: "(Ljavax/swing/text/FlowView;II)I", methodCache: &FlowView_FlowStrategy.layoutRow_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var adjustRow_MethodID_5: jmethodID?
    ...
    open func adjustRow( fv: FlowView?, rowIndex: Int, desiredSpan: Int, x: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "adjustRow", methodSig: "(Ljavax/swing/text/FlowView;III)V", methodCache: &FlowView_FlowStrategy.adjustRow_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var createView_MethodID_6: jmethodID?
    ...
    open func createView( fv: FlowView?, startOffset: Int, spanLeft: Int, rowIndex: Int ) -> View! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createView", methodSig: "(Ljavax/swing/text/FlowView;III)Ljavax/swing/text/View;", methodCache: &FlowView_FlowStrategy.createView_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? View( javaObject: __return ) : nil
    }
