...
open class FixedHeightLayoutCache: AbstractLayoutCache {
    ...
    override open var nodeDimensions: AbstractLayoutCache_NodeDimensions! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "nodeDimensions", fieldType: "Ljavax/swing/tree/AbstractLayoutCache$NodeDimensions;", fieldCache: &FixedHeightLayoutCache.nodeDimensions_FieldID, object: javaObject )
    ...
    override open var rootVisible: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "rootVisible", fieldType: "Z", fieldCache: &FixedHeightLayoutCache.rootVisible_FieldID, object: javaObject )
    ...
    override open var rowHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "rowHeight", fieldType: "I", fieldCache: &FixedHeightLayoutCache.rowHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var treeModel: TreeModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeModel", fieldType: "Ljavax/swing/tree/TreeModel;", fieldCache: &FixedHeightLayoutCache.treeModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var treeSelectionModel: TreeSelectionModel! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "treeSelectionModel", fieldType: "Ljavax/swing/tree/TreeSelectionModel;", fieldCache: &FixedHeightLayoutCache.treeSelectionModel_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
