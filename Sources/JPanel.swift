...
open class JPanel: JComponent {
    ...
    override open var listenerList: EventListenerList! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JPanel.listenerList_FieldID, object: javaObject )
    ...
    override open var ui: ComponentUI! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JPanel.ui_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    override open var accessibleContext: /* class javax.accessibility.AccessibleContext */ UnavailableObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JPanel.accessibleContext_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "()V", methodCache: &JPanel.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( isDoubleBuffered: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( z: jboolean(isDoubleBuffered ? JNI_TRUE : JNI_FALSE) )
    ...
    public convenience init( _ _isDoubleBuffered: Bool ) {
        self.init( isDoubleBuffered: _isDoubleBuffered )
    }
    ...
    public convenience init( layout: java_awt.LayoutManager? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: layout, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "(Ljava/awt/LayoutManager;)V", methodCache: &JPanel.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _layout: java_awt.LayoutManager? ) {
    ...
    public convenience init( layout: java_awt.LayoutManager?, isDoubleBuffered: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        __args[0] = JNIType.toJava( value: layout, locals: &__locals )
        __args[1] = jvalue( z: jboolean(isDoubleBuffered ? JNI_TRUE : JNI_FALSE) )
    ...
    public convenience init( _ _layout: java_awt.LayoutManager?, _ _isDoubleBuffered: Bool ) {
        self.init( layout: _layout, isDoubleBuffered: _isDoubleBuffered )
    }
    ...
    open func getUI() -> PanelUI! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getUI", methodSig: "()Ljavax/swing/plaf/PanelUI;", methodCache: &JPanel.getUI_MethodID_5, args: &__args, locals: &__locals )
    ...
    override open func paramString() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JPanel.paramString_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
