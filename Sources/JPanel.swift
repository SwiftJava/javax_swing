...
open class JPanel: JComponent {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "javax.swing.JPanel", file, line ) {
            return nil
        }
    ...
    private static var JPanelJNIClass: jclass?
    ...
    override open var ui: ComponentUI! {
        get {
            ...
            let __value = JNIField.GetObjectField( fieldName: "ui", fieldType: "Ljavax/swing/plaf/ComponentUI;", fieldCache: &JPanel.ui_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var listenerList: EventListenerList! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "listenerList", fieldType: "Ljavax/swing/event/EventListenerList;", fieldCache: &JPanel.listenerList_FieldID, object: javaObject, locals: &__locals )
    ...
    override open var accessibleContext: /* javax.accessibility.AccessibleContext */ UnclassedObject! {
        get {
            var __locals = [jobject]()
            let __value = JNIField.GetObjectField( fieldName: "accessibleContext", fieldType: "Ljavax/accessibility/AccessibleContext;", fieldCache: &JPanel.accessibleContext_FieldID, object: javaObject, locals: &__locals )
    ...
    public convenience init( arg0: java_awt.LayoutManager? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = jvalue( l: arg0?.localJavaObject( &__locals ) )
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "(Ljava/awt/LayoutManager;)V", methodCache: &JPanel.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: java_awt.LayoutManager? ) {
    ...
    public convenience init( arg0: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "(Z)V", methodCache: &JPanel.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "()V", methodCache: &JPanel.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: java_awt.LayoutManager?, arg1: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        var __locals = [jobject]()
        __args[0] = jvalue( l: arg0?.localJavaObject( &__locals ) )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/JPanel", classCache: &JPanel.JPanelJNIClass, methodSig: "(Ljava/awt/LayoutManager;Z)V", methodCache: &JPanel.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: java_awt.LayoutManager?, _ _arg1: Bool ) {
        self.init( arg0: _arg0, arg1: _arg1 )
    }

    /// private void javax.swing.JPanel.writeObject(java.io.ObjectOutputStream) throws java.io.IOException
    ...
    override open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &JPanel.paramString_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func setUI( _ _arg0: PanelUI? ) {
        setUI( arg0: _arg0 )
    }
