...
open class HTMLFrameHyperlinkEvent: HyperlinkEvent {
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &HTMLFrameHyperlinkEvent.source_FieldID, object: javaObject )
    ...
    public convenience init( source: java_swift.JavaObject?, type: HyperlinkEvent_EventType?, targetURL: /* class java.net.URL */ UnavailableObject?, sourceElement: Element?, targetFrame: String? ) {
        var __locals = [jobject]()
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTMLFrameHyperlinkEvent", classCache: &HTMLFrameHyperlinkEvent.HTMLFrameHyperlinkEventJNIClass, methodSig: "(Ljava/lang/Object;Ljavax/swing/event/HyperlinkEvent$EventType;Ljava/net/URL;Ljavax/swing/text/Element;Ljava/lang/String;)V", methodCache: &HTMLFrameHyperlinkEvent.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: java_swift.JavaObject?, _ _type: HyperlinkEvent_EventType?, _ _targetURL: /* class java.net.URL */ UnavailableObject?, _ _sourceElement: Element?, _ _targetFrame: String? ) {
    ...
    public convenience init( source: java_swift.JavaObject?, type: HyperlinkEvent_EventType?, targetURL: /* class java.net.URL */ UnavailableObject?, targetFrame: String? ) {
        var __locals = [jobject]()
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTMLFrameHyperlinkEvent", classCache: &HTMLFrameHyperlinkEvent.HTMLFrameHyperlinkEventJNIClass, methodSig: "(Ljava/lang/Object;Ljavax/swing/event/HyperlinkEvent$EventType;Ljava/net/URL;Ljava/lang/String;)V", methodCache: &HTMLFrameHyperlinkEvent.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: java_swift.JavaObject?, _ _type: HyperlinkEvent_EventType?, _ _targetURL: /* class java.net.URL */ UnavailableObject?, _ _targetFrame: String? ) {
    ...
    public convenience init( source: java_swift.JavaObject?, type: HyperlinkEvent_EventType?, targetURL: /* class java.net.URL */ UnavailableObject?, desc: String?, sourceElement: Element?, targetFrame: String? ) {
        var __locals = [jobject]()
    ...
    public convenience init( _ _source: java_swift.JavaObject?, _ _type: HyperlinkEvent_EventType?, _ _targetURL: /* class java.net.URL */ UnavailableObject?, _ _desc: String?, _ _sourceElement: Element?, _ _targetFrame: String? ) {
    ...
    public convenience init( source: java_swift.JavaObject?, type: HyperlinkEvent_EventType?, targetURL: /* class java.net.URL */ UnavailableObject?, desc: String?, sourceElement: Element?, inputEvent: java_awt.InputEvent?, targetFrame: String? ) {
        var __locals = [jobject]()
        ...
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTMLFrameHyperlinkEvent", classCache: &HTMLFrameHyperlinkEvent.HTMLFrameHyperlinkEventJNIClass, methodSig: "(Ljava/lang/Object;Ljavax/swing/event/HyperlinkEvent$EventType;Ljava/net/URL;Ljava/lang/String;Ljavax/swing/text/Element;Ljava/awt/event/InputEvent;Ljava/lang/String;)V", methodCache: &HTMLFrameHyperlinkEvent.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: java_swift.JavaObject?, _ _type: HyperlinkEvent_EventType?, _ _targetURL: /* class java.net.URL */ UnavailableObject?, _ _desc: String?, _ _sourceElement: Element?, _ _inputEvent: java_awt.InputEvent?, _ _targetFrame: String? ) {
    ...
    public convenience init( source: java_swift.JavaObject?, type: HyperlinkEvent_EventType?, targetURL: /* class java.net.URL */ UnavailableObject?, desc: String?, targetFrame: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 5 )
        __args[0] = JNIType.toJava( value: source, locals: &__locals )
        __args[1] = JNIType.toJava( value: type, locals: &__locals )
        ...
        __args[3] = JNIType.toJava( value: desc, locals: &__locals )
        __args[4] = JNIType.toJava( value: targetFrame, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "javax/swing/text/html/HTMLFrameHyperlinkEvent", classCache: &HTMLFrameHyperlinkEvent.HTMLFrameHyperlinkEventJNIClass, methodSig: "(Ljava/lang/Object;Ljavax/swing/event/HyperlinkEvent$EventType;Ljava/net/URL;Ljava/lang/String;Ljava/lang/String;)V", methodCache: &HTMLFrameHyperlinkEvent.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: java_swift.JavaObject?, _ _type: HyperlinkEvent_EventType?, _ _targetURL: /* class java.net.URL */ UnavailableObject?, _ _desc: String?, _ _targetFrame: String? ) {
