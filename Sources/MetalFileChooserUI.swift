...
open class MetalFileChooserUI: BasicFileChooserUI {
    ...
    private static var getButtonPanel_MethodID_3: jmethodID?

    open func getButtonPanel() -> JPanel! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getButtonPanel", methodSig: "()Ljavax/swing/JPanel;", methodCache: &MetalFileChooserUI.getButtonPanel_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getBottomPanel_MethodID_4: jmethodID?

    open func getBottomPanel() -> JPanel! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBottomPanel", methodSig: "()Ljavax/swing/JPanel;", methodCache: &MetalFileChooserUI.getBottomPanel_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? JPanel( javaObject: __return ) : nil
    }
    ...
    private static var removeControlButtons_MethodID_6: jmethodID?

    open func removeControlButtons() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeControlButtons", methodSig: "()V", methodCache: &MetalFileChooserUI.removeControlButtons_MethodID_6, args: &__args, locals: &__locals )
    }


    /// protected void javax.swing.plaf.metal.MetalFileChooserUI.addControlButtons()

    private static var addControlButtons_MethodID_7: jmethodID?

    open func addControlButtons() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addControlButtons", methodSig: "()V", methodCache: &MetalFileChooserUI.addControlButtons_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var createDirectoryComboBoxRenderer_MethodID_8: jmethodID?
    ...
    private static var createDirectoryComboBoxModel_MethodID_9: jmethodID?
    ...
    open func createDirectoryComboBoxModel( fc: JFileChooser? ) -> /* javax.swing.plaf.metal.MetalFileChooserUI$DirectoryComboBoxModel */ UnclassedObject! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fc, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createDirectoryComboBoxModel", methodSig: "(Ljavax/swing/JFileChooser;)Ljavax/swing/plaf/metal/MetalFileChooserUI$DirectoryComboBoxModel;", methodCache: &MetalFileChooserUI.createDirectoryComboBoxModel_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createFilterComboBoxRenderer_MethodID_10: jmethodID?

    open func createFilterComboBoxRenderer() -> MetalFileChooserUI_FilterComboBoxRenderer! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFilterComboBoxRenderer", methodSig: "()Ljavax/swing/plaf/metal/MetalFileChooserUI$FilterComboBoxRenderer;", methodCache: &MetalFileChooserUI.createFilterComboBoxRenderer_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createFilterComboBoxModel_MethodID_11: jmethodID?

    open func createFilterComboBoxModel() -> /* javax.swing.plaf.metal.MetalFileChooserUI$FilterComboBoxModel */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createFilterComboBoxModel", methodSig: "()Ljavax/swing/plaf/metal/MetalFileChooserUI$FilterComboBoxModel;", methodCache: &MetalFileChooserUI.createFilterComboBoxModel_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setDirectorySelected_MethodID_12: jmethodID?

    open func setDirectorySelected( directorySelected: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: directorySelected, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDirectorySelected", methodSig: "(Z)V", methodCache: &MetalFileChooserUI.setDirectorySelected_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var installStrings_MethodID_13: jmethodID?

    override open func installStrings( fc: JFileChooser? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fc, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "installStrings", methodSig: "(Ljavax/swing/JFileChooser;)V", methodCache: &MetalFileChooserUI.installStrings_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var getApproveButton_MethodID_14: jmethodID?

    override open func getApproveButton( fc: JFileChooser? ) -> JButton! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fc, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getApproveButton", methodSig: "(Ljavax/swing/JFileChooser;)Ljavax/swing/JButton;", methodCache: &MetalFileChooserUI.getApproveButton_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var valueChanged_MethodID_16: jmethodID?

    open func valueChanged( e: ListSelectionEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "valueChanged", methodSig: "(Ljavax/swing/event/ListSelectionEvent;)V", methodCache: &MetalFileChooserUI.valueChanged_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var createActionMap_MethodID_17: jmethodID?

    open func createActionMap() -> ActionMap! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createActionMap", methodSig: "()Ljavax/swing/ActionMap;", methodCache: &MetalFileChooserUI.createActionMap_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var createList_MethodID_18: jmethodID?

    open func createList( fc: JFileChooser? ) -> JPanel! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: fc, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createList", methodSig: "(Ljavax/swing/JFileChooser;)Ljavax/swing/JPanel;", methodCache: &MetalFileChooserUI.createList_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? JPanel( javaObject: __return ) : nil
    }
    ...
    private static var getActionMap_MethodID_19: jmethodID?

    open func getActionMap() -> ActionMap! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getActionMap", methodSig: "()Ljavax/swing/ActionMap;", methodCache: &MetalFileChooserUI.getActionMap_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? ActionMap( javaObject: __return ) : nil
    }
