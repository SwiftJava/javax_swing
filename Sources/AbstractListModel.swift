...
open class AbstractListModel: java_swift.JavaObject, ListModel, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open func getSize() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSize", methodSig: "()I", methodCache: &AbstractListModel.getSize_MethodID_9, args: &__args, locals: &__locals )
    ...
    private static var getElementAt_MethodID_10: jmethodID?

    open func getElementAt( index: Int ) -> java_swift.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: index, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getElementAt", methodSig: "(I)Ljava/lang/Object;", methodCache: &AbstractListModel.getElementAt_MethodID_10, args: &__args, locals: &__locals )
