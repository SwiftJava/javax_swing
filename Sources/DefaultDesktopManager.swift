...
open class DefaultDesktopManager: java_swift.JavaObject, DesktopManager, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open func activateFrame( f: JInternalFrame? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "activateFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.activateFrame_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var beginResizingFrame_MethodID_4: jmethodID?
    ...
    open func beginResizingFrame( f: JComponent?, direction: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "beginResizingFrame", methodSig: "(Ljavax/swing/JComponent;I)V", methodCache: &DefaultDesktopManager.beginResizingFrame_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var closeFrame_MethodID_5: jmethodID?

    open func closeFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "closeFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.closeFrame_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var deactivateFrame_MethodID_6: jmethodID?

    open func deactivateFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "deactivateFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.deactivateFrame_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var dragFrame_MethodID_8: jmethodID?
    ...
    open func dragFrame( f: JComponent?, newX: Int, newY: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dragFrame", methodSig: "(Ljavax/swing/JComponent;II)V", methodCache: &DefaultDesktopManager.dragFrame_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    private static var endDraggingFrame_MethodID_9: jmethodID?

    open func endDraggingFrame( f: JComponent? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "endDraggingFrame", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &DefaultDesktopManager.endDraggingFrame_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    private static var endResizingFrame_MethodID_10: jmethodID?

    open func endResizingFrame( f: JComponent? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "endResizingFrame", methodSig: "(Ljavax/swing/JComponent;)V", methodCache: &DefaultDesktopManager.endResizingFrame_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var getBoundsForIconOf_MethodID_11: jmethodID?

    open func getBoundsForIconOf( f: JInternalFrame? ) -> java_awt.Rectangle! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBoundsForIconOf", methodSig: "(Ljavax/swing/JInternalFrame;)Ljava/awt/Rectangle;", methodCache: &DefaultDesktopManager.getBoundsForIconOf_MethodID_11, args: &__args, locals: &__locals )
    ...
    private static var getPreviousBounds_MethodID_12: jmethodID?

    open func getPreviousBounds( f: JInternalFrame? ) -> java_awt.Rectangle! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreviousBounds", methodSig: "(Ljavax/swing/JInternalFrame;)Ljava/awt/Rectangle;", methodCache: &DefaultDesktopManager.getPreviousBounds_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? java_awt.Rectangle( javaObject: __return ) : nil
    }
    ...
    private static var iconifyFrame_MethodID_13: jmethodID?

    open func iconifyFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "iconifyFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.iconifyFrame_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var maximizeFrame_MethodID_14: jmethodID?

    open func maximizeFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "maximizeFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.maximizeFrame_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var minimizeFrame_MethodID_15: jmethodID?

    open func minimizeFrame( f: JInternalFrame? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "minimizeFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.minimizeFrame_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func openFrame( f: JInternalFrame? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "openFrame", methodSig: "(Ljavax/swing/JInternalFrame;)V", methodCache: &DefaultDesktopManager.openFrame_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    private static var resizeFrame_MethodID_18: jmethodID?
    ...
    open func resizeFrame( f: JComponent?, newX: Int, newY: Int, newWidth: Int, newHeight: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "resizeFrame", methodSig: "(Ljavax/swing/JComponent;IIII)V", methodCache: &DefaultDesktopManager.resizeFrame_MethodID_18, args: &__args, locals: &__locals )
    }
    ...
    private static var setBoundsForFrame_MethodID_19: jmethodID?
    ...
    open func setBoundsForFrame( f: JComponent?, newX: Int, newY: Int, newWidth: Int, newHeight: Int ) {
        ...
        __args[3] = jvalue( i: jint(newWidth) )
        __args[4] = jvalue( i: jint(newHeight) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBoundsForFrame", methodSig: "(Ljavax/swing/JComponent;IIII)V", methodCache: &DefaultDesktopManager.setBoundsForFrame_MethodID_19, args: &__args, locals: &__locals )
    }
    ...
    private static var setPreviousBounds_MethodID_20: jmethodID?
    ...
    open func setPreviousBounds( f: JInternalFrame?, r: java_awt.Rectangle? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setPreviousBounds", methodSig: "(Ljavax/swing/JInternalFrame;Ljava/awt/Rectangle;)V", methodCache: &DefaultDesktopManager.setPreviousBounds_MethodID_20, args: &__args, locals: &__locals )
    }
