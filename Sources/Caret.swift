...
open class CaretForward: JNIObjectForward, Caret {
    ...
    private static var getMagicCaretPosition_MethodID_20: jmethodID?

    open func getMagicCaretPosition() -> java_awt.Point! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMagicCaretPosition", methodSig: "()Ljava/awt/Point;", methodCache: &CaretForward.getMagicCaretPosition_MethodID_20, args: &__args, locals: &__locals )
    ...
    private static var setMagicCaretPosition_MethodID_21: jmethodID?

    open func setMagicCaretPosition( p: java_awt.Point? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: p != nil ? p! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setMagicCaretPosition", methodSig: "(Ljava/awt/Point;)V", methodCache: &CaretForward.setMagicCaretPosition_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    private static var deinstall_MethodID_22: jmethodID?

    open func deinstall( c: JTextComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "deinstall", methodSig: "(Ljavax/swing/text/JTextComponent;)V", methodCache: &CaretForward.deinstall_MethodID_22, args: &__args, locals: &__locals )
    }
    ...
    private static var install_MethodID_23: jmethodID?

    open func install( c: JTextComponent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c != nil ? c! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "install", methodSig: "(Ljavax/swing/text/JTextComponent;)V", methodCache: &CaretForward.install_MethodID_23, args: &__args, locals: &__locals )
    }
    ...
    open func setDot( dot: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setDot", methodSig: "(I)V", methodCache: &CaretForward.setDot_MethodID_24, args: &__args, locals: &__locals )
    }
    ...
    open func moveDot( dot: Int ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dot, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "moveDot", methodSig: "(I)V", methodCache: &CaretForward.moveDot_MethodID_25, args: &__args, locals: &__locals )
    }
    ...
    private static var getMark_MethodID_26: jmethodID?

    open func getMark() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMark", methodSig: "()I", methodCache: &CaretForward.getMark_MethodID_26, args: &__args, locals: &__locals )
    ...
    private static var getDot_MethodID_27: jmethodID?

    open func getDot() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDot", methodSig: "()I", methodCache: &CaretForward.getDot_MethodID_27, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getBlinkRate_MethodID_28: jmethodID?

    open func getBlinkRate() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getBlinkRate", methodSig: "()I", methodCache: &CaretForward.getBlinkRate_MethodID_28, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var setBlinkRate_MethodID_29: jmethodID?

    open func setBlinkRate( rate: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: rate, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBlinkRate", methodSig: "(I)V", methodCache: &CaretForward.setBlinkRate_MethodID_29, args: &__args, locals: &__locals )
    }
    ...
    private static var isVisible_MethodID_30: jmethodID?

    open func isVisible() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isVisible", methodSig: "()Z", methodCache: &CaretForward.isVisible_MethodID_30, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func setVisible( v: Bool ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: v, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVisible", methodSig: "(Z)V", methodCache: &CaretForward.setVisible_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    private static var addChangeListener_MethodID_32: jmethodID?

    open func addChangeListener( l: ChangeListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &CaretForward.addChangeListener_MethodID_32, args: &__args, locals: &__locals )
    }
    ...
    private static var removeChangeListener_MethodID_33: jmethodID?

    open func removeChangeListener( l: ChangeListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: l, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeChangeListener", methodSig: "(Ljavax/swing/event/ChangeListener;)V", methodCache: &CaretForward.removeChangeListener_MethodID_33, args: &__args, locals: &__locals )
    }
    ...
    open func paint( g: java_awt.Graphics? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &CaretForward.paint_MethodID_34, args: &__args, locals: &__locals )
    }
